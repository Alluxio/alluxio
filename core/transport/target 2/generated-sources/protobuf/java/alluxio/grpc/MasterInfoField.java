...
public enum MasterInfoField
  ...
  /**
   * <code>CLUSTER_ID = 10;</code>
   */
  CLUSTER_ID(10),
  /**
   * <code>RAFT_JOURNAL = 11;</code>
   */
  RAFT_JOURNAL(11),
  /**
   * <code>RAFT_ADDRESSES = 12;</code>
   */
  RAFT_ADDRESSES(12),
  ;
  ...
  public static MasterInfoField forNumber(int value) {
    switch (value) {
      ...
      case 10: return CLUSTER_ID;
      case 11: return RAFT_JOURNAL;
      case 12: return RAFT_ADDRESSES;
      default: return null;
    }
  }
