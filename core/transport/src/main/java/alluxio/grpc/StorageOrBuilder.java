...
public interface StorageOrBuilder extends
    // @@protoc_insertion_point(interface_extends:alluxio.grpc.Storage)
   ...
   * <code>optional .alluxio.grpc.StorageFormat storage_format = 1;</code>
   */
  alluxio.grpc.StorageFormat getStorageFormat();
  /**
   * <code>optional .alluxio.grpc.StorageFormat storage_format = 1;</code>
   */
  alluxio.grpc.StorageFormatOrBuilder getStorageFormatOrBuilder();
   ...
   * <code>optional .alluxio.grpc.HiveBucketProperty bucket_property = 3;</code>
   */
  alluxio.grpc.HiveBucketProperty getBucketProperty();
  /**
   * <code>optional .alluxio.grpc.HiveBucketProperty bucket_property = 3;</code>
   */
  alluxio.grpc.HiveBucketPropertyOrBuilder getBucketPropertyOrBuilder();
