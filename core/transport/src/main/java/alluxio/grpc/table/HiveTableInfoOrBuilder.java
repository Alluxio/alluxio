...
public interface HiveTableInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:alluxio.grpc.table.HiveTableInfo)
   ...
   * <code>repeated .alluxio.grpc.table.FieldSchema data_columns = 5;</code>
   */
  alluxio.grpc.table.FieldSchema getDataColumns(int index);
  /**
   * <code>repeated .alluxio.grpc.table.FieldSchema data_columns = 5;</code>
   */
   ...
   * <code>repeated .alluxio.grpc.table.FieldSchema data_columns = 5;</code>
   */
  alluxio.grpc.table.FieldSchemaOrBuilder getDataColumnsOrBuilder(
      int index);
   ...
   * <code>repeated .alluxio.grpc.table.FieldSchema partition_columns = 6;</code>
   */
  alluxio.grpc.table.FieldSchema getPartitionColumns(int index);
  /**
   * <code>repeated .alluxio.grpc.table.FieldSchema partition_columns = 6;</code>
   */
   ...
   * <code>repeated .alluxio.grpc.table.FieldSchema partition_columns = 6;</code>
   */
  alluxio.grpc.table.FieldSchemaOrBuilder getPartitionColumnsOrBuilder(
      int index);
