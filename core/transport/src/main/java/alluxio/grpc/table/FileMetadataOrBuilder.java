...
public interface FileMetadataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:alluxio.grpc.table.FileMetadata)
   ...
   * <code>optional .alluxio.grpc.table.MessageType schema = 1;</code>
   */
  alluxio.grpc.table.MessageType getSchema();
  /**
   * <code>optional .alluxio.grpc.table.MessageType schema = 1;</code>
   */
  alluxio.grpc.table.MessageTypeOrBuilder getSchemaOrBuilder();
