...
/**
 * Protobuf type {@code alluxio.grpc.BlockMetadata}
 */
public  final class BlockMetadata extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:alluxio.grpc.BlockMetadata)
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
              colData_ = new java.util.ArrayList<alluxio.grpc.ColumnChunkMetaData>();
              mutable_bitField0_ |= 0x00000008;
            }
            colData_.add(
                input.readMessage(alluxio.grpc.ColumnChunkMetaData.PARSER, extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return alluxio.grpc.CatalogMasterProto.internal_static_alluxio_grpc_BlockMetadata_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return alluxio.grpc.CatalogMasterProto.internal_static_alluxio_grpc_BlockMetadata_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            alluxio.grpc.BlockMetadata.class, alluxio.grpc.BlockMetadata.Builder.class);
  }
  ...
  private java.util.List<alluxio.grpc.ColumnChunkMetaData> colData_;
  /**
   * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
   */
  public java.util.List<alluxio.grpc.ColumnChunkMetaData> getColDataList() {
    return colData_;
  }
  /**
   * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
   */
  public java.util.List<? extends alluxio.grpc.ColumnChunkMetaDataOrBuilder> 
   ...
   * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
   */
  public alluxio.grpc.ColumnChunkMetaData getColData(int index) {
    return colData_.get(index);
  }
  /**
   * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
   */
  public alluxio.grpc.ColumnChunkMetaDataOrBuilder getColDataOrBuilder(
      int index) {
    return colData_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof alluxio.grpc.BlockMetadata)) {
      return super.equals(obj);
    }
    alluxio.grpc.BlockMetadata other = (alluxio.grpc.BlockMetadata) obj;
  ...
  public static alluxio.grpc.BlockMetadata parseFrom(
  ...
  public static alluxio.grpc.BlockMetadata parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static alluxio.grpc.BlockMetadata parseFrom(
  ...
  public static alluxio.grpc.BlockMetadata parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static alluxio.grpc.BlockMetadata parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static alluxio.grpc.BlockMetadata parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(alluxio.grpc.BlockMetadata prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:alluxio.grpc.BlockMetadata)
      alluxio.grpc.BlockMetadataOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return alluxio.grpc.CatalogMasterProto.internal_static_alluxio_grpc_BlockMetadata_descriptor;
    }
    ...
    // Construct using alluxio.grpc.BlockMetadata.newBuilder()
    private Builder() {
    ...
    public alluxio.grpc.BlockMetadata getDefaultInstanceForType() {
      return alluxio.grpc.BlockMetadata.getDefaultInstance();
    }

    public alluxio.grpc.BlockMetadata build() {
      alluxio.grpc.BlockMetadata result = buildPartial();
    ...
    public alluxio.grpc.BlockMetadata buildPartial() {
      alluxio.grpc.BlockMetadata result = new alluxio.grpc.BlockMetadata(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof alluxio.grpc.BlockMetadata) {
        return mergeFrom((alluxio.grpc.BlockMetadata)other);
      } else {
    ...
    public Builder mergeFrom(alluxio.grpc.BlockMetadata other) {
      if (other == alluxio.grpc.BlockMetadata.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      alluxio.grpc.BlockMetadata parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (alluxio.grpc.BlockMetadata) e.getUnfinishedMessage();
  ...
  bitField0_ |= 0x00000004;
    ...
    private void ensureColDataIsMutable() {
      if (!((bitField0_ & 0x00000008) == 0x00000008)) {
        colData_ = new java.util.ArrayList<alluxio.grpc.ColumnChunkMetaData>(colData_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        alluxio.grpc.ColumnChunkMetaData, alluxio.grpc.ColumnChunkMetaData.Builder, alluxio.grpc.ColumnChunkMetaDataOrBuilder> colDataBuilder_;
    ...
    public Builder setColData(
        int index, alluxio.grpc.ColumnChunkMetaData value) {
      if (colDataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setColData(
        int index, alluxio.grpc.ColumnChunkMetaData.Builder builderForValue) {
      if (colDataBuilder_ == null) {
        ensureColDataIsMutable();
     ...
     * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
     */
    public Builder addColData(alluxio.grpc.ColumnChunkMetaData value) {
      if (colDataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addColData(
        alluxio.grpc.ColumnChunkMetaData.Builder builderForValue) {
      if (colDataBuilder_ == null) {
        ensureColDataIsMutable();
    ...
    public Builder addAllColData(
        java.lang.Iterable<? extends alluxio.grpc.ColumnChunkMetaData> values) {
      if (colDataBuilder_ == null) {
        ensureColDataIsMutable();
     ...
     * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
     */
    public alluxio.grpc.ColumnChunkMetaData.Builder getColDataBuilder(
        int index) {
     ...
     * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
     */
    public alluxio.grpc.ColumnChunkMetaData.Builder addColDataBuilder() {
      return getColDataFieldBuilder().addBuilder(
          alluxio.grpc.ColumnChunkMetaData.getDefaultInstance());
    }
    /**
     * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
     */
    public alluxio.grpc.ColumnChunkMetaData.Builder addColDataBuilder(
        int index) {
      return getColDataFieldBuilder().addBuilder(
          index, alluxio.grpc.ColumnChunkMetaData.getDefaultInstance());
    }
    /**
     * <code>repeated .alluxio.grpc.ColumnChunkMetaData col_data = 4;</code>
     */
    public java.util.List<alluxio.grpc.ColumnChunkMetaData.Builder> 
         getColDataBuilderList() {
      return getColDataFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        alluxio.grpc.ColumnChunkMetaData, alluxio.grpc.ColumnChunkMetaData.Builder, alluxio.grpc.ColumnChunkMetaDataOrBuilder> 
        getColDataFieldBuilder() {
      if (colDataBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:alluxio.grpc.BlockMetadata)
  }

  // @@protoc_insertion_point(class_scope:alluxio.grpc.BlockMetadata)
  private static final alluxio.grpc.BlockMetadata DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new alluxio.grpc.BlockMetadata();
  }

  public static alluxio.grpc.BlockMetadata getDefaultInstance() {
