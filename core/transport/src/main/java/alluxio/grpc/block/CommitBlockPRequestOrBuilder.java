...
public interface CommitBlockPRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:alluxio.grpc.CommitBlockPRequest)
   ...
   * <code>optional .alluxio.grpc.CommitBlockPOptions options = 6;</code>
   */
  alluxio.grpc.block.CommitBlockPOptions getOptions();
  /**
   * <code>optional .alluxio.grpc.CommitBlockPOptions options = 6;</code>
   */
  alluxio.grpc.block.CommitBlockPOptionsOrBuilder getOptionsOrBuilder();
}
