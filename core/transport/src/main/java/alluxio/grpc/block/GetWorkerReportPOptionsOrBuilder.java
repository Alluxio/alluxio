...
public interface GetWorkerReportPOptionsOrBuilder extends
   ...
   */
  java.util.List<alluxio.grpc.block.WorkerInfoField> getFieldRangeList();
  /**
   * <code>repeated .alluxio.grpc.WorkerInfoField fieldRange = 2;</code>
   */
   ...
   * <code>repeated .alluxio.grpc.WorkerInfoField fieldRange = 2;</code>
   */
  alluxio.grpc.block.WorkerInfoField getFieldRange(int index);
   ...
   * <code>optional .alluxio.grpc.WorkerRange workerRange = 3;</code>
   */
  alluxio.grpc.block.WorkerRange getWorkerRange();
}
