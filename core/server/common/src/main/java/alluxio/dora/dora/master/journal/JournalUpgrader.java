...
package alluxio.dora.dora.master.journal;
...
import alluxio.dora.dora.master.journalv0.JournalWriter;
import alluxio.dora.dora.master.journalv0.MutableJournal;
import alluxio.dora.dora.master.MasterFactory;
import alluxio.dora.dora.master.NoopMaster;
import alluxio.dora.dora.master.ServiceUtils;
import alluxio.dora.dora.master.journal.ufs.UfsJournal;
...
public final class JournalUpgrader {
  ...
  private static final class Upgrader {
    ...
    private Upgrader(String master, AlluxioConfiguration alluxioConf) {
      ...
      mJournalV0 = (new MutableJournal.Factory(
    ...
    private void prepare() throws IOException {
      JournalWriter journalWriterV0 = mJournalV0.getWriter();
