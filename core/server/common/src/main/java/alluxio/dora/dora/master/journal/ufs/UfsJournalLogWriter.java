...
package alluxio.dora.dora.master.journal.ufs;
...
import alluxio.dora.dora.exception.JournalClosedException;
import alluxio.dora.dora.master.journal.JournalEntryStreamReader;
import alluxio.dora.dora.master.journal.JournalWriter;
...
public final class UfsJournalLogWriter implements JournalWriter {
   ...
   *
   * Many of the methods in this class might throw {@link JournalClosedException.IOJournalClosedException} if the journal
   ...
   * {@link JournalClosedException.IOJournalClosedException} as a regular {@link JournalClosedException} so that it will be
