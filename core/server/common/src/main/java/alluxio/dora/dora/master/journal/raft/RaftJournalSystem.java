...
import alluxio.dora.dora.master.journal.AbstractJournalSystem;
import alluxio.dora.dora.master.journal.AsyncJournalWriter;
import alluxio.dora.dora.master.journal.CatchupFuture;
import alluxio.dora.dora.master.journal.Journal;
import alluxio.dora.dora.metrics.sink.RatisDropwizardExports;
...
public class RaftJournalSystem extends AbstractJournalSystem {
  ...
  public void format() throws IOException {
    if (mPath.isDirectory()) {
      if (alluxio.dora.dora.util.io.FileUtils.isStorageDirAccessible(mPath.getPath())) {
