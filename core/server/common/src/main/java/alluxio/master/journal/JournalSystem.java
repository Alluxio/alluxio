...
public interface JournalSystem {
  ...
  /**
   * Waits for the journal to be mostly caught up. This is intended to be only be called in
   * Secondary mode. This is best-effort, because even if it did not finish catching up, the rest
