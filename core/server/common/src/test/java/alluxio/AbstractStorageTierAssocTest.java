...
public final class AbstractStorageTierAssocTest {
  ...
  public void storageAliasListConstructor() {
    List<String> orderedAliases = Arrays.asList(Constants.MEDIUM_MEM, Constants.MEDIUM_HDD, "SOMETHINGELSE", Constants.MEDIUM_SSD);
    ...
    Assert.assertEquals(intersections.get(0).getFirst(), BlockStoreLocation.anyDirInTier(Constants.MEDIUM_MEM));
    Assert.assertEquals(intersections.get(0).getSecond(), BlockStoreLocation.anyDirInTier(Constants.MEDIUM_HDD));
    Assert.assertEquals(intersections.get(1).getFirst(), BlockStoreLocation.anyDirInTier(Constants.MEDIUM_HDD));
    ...
    Assert.assertEquals(intersections.get(2).getFirst(),
        BlockStoreLocation.anyDirInTier("SOMETHINGELSE"));
    Assert.assertEquals(intersections.get(2).getSecond(), BlockStoreLocation.anyDirInTier(Constants.MEDIUM_SSD));
  }
