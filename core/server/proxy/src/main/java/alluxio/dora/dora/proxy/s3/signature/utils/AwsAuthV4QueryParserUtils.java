...
package alluxio.dora.dora.proxy.s3.signature.utils;

import static alluxio.dora.dora.proxy.s3.S3Constants.AUTHORIZATION_CHARSET;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_ALGORITHM;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_CREDENTIAL;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_DATE;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_EXPIRES;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_SIGNATURE;
import static alluxio.dora.dora.proxy.s3.S3Constants.S3_SIGN_SIGNED_HEADER;
import static alluxio.dora.dora.proxy.s3.S3Constants.TIME_FORMATTER;

import alluxio.dora.dora.proxy.s3.S3Exception;
import alluxio.dora.dora.proxy.s3.signature.AwsCredential;
import alluxio.dora.dora.proxy.s3.signature.SignatureInfo;
