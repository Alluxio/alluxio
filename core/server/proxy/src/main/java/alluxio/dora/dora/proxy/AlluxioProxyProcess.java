...
package alluxio.dora.dora.proxy;
...
import alluxio.dora.dora.web.ProxyWebServer;
...
public final class AlluxioProxyProcess implements ProxyProcess {
  ...
  public void start() throws Exception {
    mWebServer = new ProxyWebServer(NetworkAddressUtils.ServiceType.PROXY_WEB.getServiceName(),
        NetworkAddressUtils.getBindAddress(NetworkAddressUtils.ServiceType.PROXY_WEB, Configuration.global()),
        this);
