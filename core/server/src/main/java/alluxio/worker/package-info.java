 ...
 *
 * Main entry point for the worker is {@link alluxio.worker.AlluxioWorkerService#main(String[])} which gets
 * started by the alluxio start scripts. The {@link alluxio.worker.AlluxioWorkerService} class spins up the
