 ...
 * The {@link MasterWorkerInfoLongHashSet} has the following groups of metadata:
 ...
 */
@NotThreadSafe
public final class MasterWorkerInfoLongHashSet {
    private static final Logger LOG = LoggerFactory.getLogger(MasterWorkerInfoLongHashSet.class);
    ...
    /**
     * Creates a new instance of {@link MasterWorkerInfoLongHashSet}.
     *
     ...
     * Write locks on {@link MasterWorkerInfoLongHashSet#mStatusLock}, {@link MasterWorkerInfoLongHashSet#mUsageLock}
     * and {@link MasterWorkerInfoLongHashSet#mBlockListLock} are required.
     *
     * You should lock externally with {@link MasterWorkerInfoLongHashSet#lockWorkerMeta(EnumSet, boolean)}
     ...
     *
     * You should lock externally with {@link MasterWorkerInfoLongHashSet#lockWorkerMetaForInfo(Set)}.
    ...
    public LockResource lockWorkerMeta(EnumSet<WorkerMetaLockSection> lockTypes, boolean isShared) {
        return new LockResource(new WorkerMetaLock(lockTypes, isShared, new MasterWorkerInfo(1, new WorkerNetAddress())));
    }
     ...
     * This is a wrapper of {@link MasterWorkerInfoLongHashSet#lockWorkerMeta(EnumSet, boolean)}
     *
