 ...
 */
@NotThreadSafe
public class LockedInodePathV2 implements LockedInodePath {

  private static final ResourceLeakDetector<LockedInodePathV2> DETECTOR =
      AlluxioResourceLeakDetectorFactory.instance().newResourceLeakDetector(LockedInodePathV2.class);
  /**
  ...
  @Nullable
  private final ResourceLeakTracker<LockedInodePathV2> mTracker;
   ...
   */
  public LockedInodePathV2(AlluxioURI uri, ReadOnlyInodeStore inodeStore,
   ...
   * @param lockPattern the pattern to lock in
   */
  private LockedInodePathV2(AlluxioURI uri, LockedInodePathV2 path, String[] pathComponents,
   ...
   */
  public LockedInodePathV2 lockDescendant(AlluxioURI descendantUri, LockPattern lockPattern)
      throws InvalidPathException {
    LockedInodePathV2 path = new LockedInodePathV2(descendantUri, this,
   ...
   * @return the new locked path
   */
  public LockedInodePathV2 lockChild(Inode child, LockPattern lockPattern)
      throws InvalidPathException {
   ...
   * @return the new locked path
   */
  public LockedInodePathV2 lockChildByName(String childName, LockPattern lockPattern,
      String[] childComponentsHint) throws InvalidPathException {
    LockedInodePathV2 path = new LockedInodePathV2(mUri.joinUnsafe(childName), this,
   ...
   * @return the new locked path
   */
  public LockedInodePathV2 lockFinalEdgeWrite() throws InvalidPathException {
    Preconditions.checkState(!fullPathExists());

    LockedInodePathV2 newPath =
        new LockedInodePathV2(mUri, this, mPathComponents, LockPattern.WRITE_EDGE, mUseTryLock);
    newPath.traverse();
    return newPath;
  }
