 ...
 */
@ThreadSafe
public final class AlluxioMasterCheckpointer {
  private static final Logger LOG = LoggerFactory.getLogger(AlluxioMasterCheckpointer.class);
  ...
  private AlluxioMasterCheckpointer() {} // prevent instantiation
}
