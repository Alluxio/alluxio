 ...
 */
@ThreadSafe
public abstract class LockedInodePath implements AutoCloseable, LockedInode {
  ...
  LockedInodePath(AlluxioURI uri, InodeLockList lockList, InodeTree.LockMode lockMode)
