 ...
 */
@NotThreadSafe
public class LockedInodePathV1 implements LockedInodePath {

  private static final ResourceLeakDetector<LockedInodePathV1> DETECTOR =
      AlluxioResourceLeakDetectorFactory.instance().newResourceLeakDetector(LockedInodePathV1.class);
  /**
  ...
  @Nullable
  private final ResourceLeakTracker<LockedInodePathV1> mTracker;
   ...
   */
  public LockedInodePathV1(AlluxioURI uri, ReadOnlyInodeStore inodeStore,
   ...
   * @param lockPattern the pattern to lock in
   */
  private LockedInodePathV1(AlluxioURI uri, LockedInodePathV1 path, String[] pathComponents,
   ...
   */
  public LockedInodePathV1 lockDescendant(AlluxioURI descendantUri, LockPattern lockPattern)
      throws InvalidPathException {
    LockedInodePathV1 path = new LockedInodePathV1(descendantUri, this,
   ...
   * @return the new locked path
   */
  public LockedInodePathV1 lockChild(Inode child, LockPattern lockPattern)
      throws InvalidPathException {
   ...
   * @return the new locked path
   */
  public LockedInodePathV1 lockChildByName(String childName, LockPattern lockPattern,
      String[] childComponentsHint) throws InvalidPathException {
    LockedInodePathV1 path = new LockedInodePathV1(mUri.joinUnsafe(childName), this,
   ...
   * @return the new locked path
   */
  public LockedInodePathV1 lockFinalEdgeWrite() throws InvalidPathException {
    Preconditions.checkState(!fullPathExists());

    LockedInodePathV1 newPath =
        new LockedInodePathV1(mUri, this, mPathComponents, LockPattern.WRITE_EDGE, mUseTryLock);
    newPath.traverse();
    return newPath;
  }
