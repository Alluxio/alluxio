...
public class InodeKVTree implements InodeTreeInterface {
  private static final Logger LOG = LoggerFactory.getLogger(InodeKVTree.class);
   ...
   * through this class by calling mINodeKVTreePersistentState.applyAndJournal(context, entry).
   */
  private final InodeKVTreePersistentState mINodeKVTreePersistentState;
   ...
   */
  public InodeKVTree(InodeStore inodeStore, ContainerIdGenerable containerIdGenerator,
    ...
    mINodeKVTreePersistentState = new InodeKVTreePersistentState(inodeStore, mInodeLockManager, mTtlBuckets);
  ...
  public boolean isOperationComplete(@Nullable OperationId opId) {
    return mINodeKVTreePersistentState.isOperationComplete(opId);
  }
  ...
  public void cacheOperation(@Nullable OperationId opId) {
    mINodeKVTreePersistentState.cacheOperation(opId);
  }
  ...
  public void initializeRoot(String owner, String group, Mode mode, JournalContext context)
    ...
    if (mINodeKVTreePersistentState.getRoot() == null) {
      // TODO(yyong) modified to generate root with (parentid, id, name) : (0, 0, "")
      ...
      root.setParentId(0);
      mINodeKVTreePersistentState.applyAndJournal(context, root, ROOT_PATH);
    }
  }
  ...
  public long getInodeCount() {
    return mINodeKVTreePersistentState.getInodeCount();
  }
  ...
  public Map<Long, Number> getFileSizeHistogram() {
    return mINodeKVTreePersistentState.getFileSizeHistogram();
  }
  ...
  @Override
  public long newBlock(Supplier<JournalContext> context, File.NewBlockEntry entry) {
    return 0;
  }
  ...
  public String getRootUserName() {
    ...
    return mINodeKVTreePersistentState.getRoot().getOwner();
  }
  ...
  public int getPinnedSize() {
    return mINodeKVTreePersistentState.getPinnedInodeFileIds().size();
  }
  ...
  public InodeDirectory getRoot() {
    return mINodeKVTreePersistentState.getRoot();
  }
  ...
  public List<Inode> createPath(RpcContext rpcContext, LockedInodePath inodePath,
    ...
    String[] pathComponents = ((LockedInodePathV2)inodePath).mPathComponents;
    ...
    for (int k = pathIndex; k < (pathComponents.length - 1); k++) {
      ...
      mINodeKVTreePersistentState.applyAndJournal(rpcContext, newDir,
          newDirPath);
    ...
    mINodeKVTreePersistentState.applyAndJournal(rpcContext, newInode,
  ...
  public void deleteInode(RpcContext rpcContext, LockedInodePath inodePath, long opTimeMs)
    ...
    mINodeKVTreePersistentState.applyAndJournal(rpcContext, DeleteFileEntry.newBuilder()
        .setId(inode.getId())
        .setRecursive(false)
  ...
  public Set<Long> getReplicationLimitedFileIds() {
    return mINodeKVTreePersistentState.getReplicationLimitedFileIds();
  }
  ...
  public Set<Long> getToBePersistedIds() {
    return mINodeKVTreePersistentState.getToBePersistedIds();
  }
  ...
  public Set<Long> getPinIdSet() {
    return mINodeKVTreePersistentState.getPinnedInodeFileIds();
  }
