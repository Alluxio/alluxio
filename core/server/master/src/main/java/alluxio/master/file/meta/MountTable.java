...
public final class MountTable implements DelegatingJournaled {
   ...
   */
  public boolean isCrossClusterMount(AlluxioURI uri) throws InvalidPathException {
    return getMountInfo(uri).getOptions().getCrossCluster();
  }
        ...
        public Journal.JournalEntry next() {
          ...
          AddMountPointEntry addMountPoint =
              AddMountPointEntry.newBuilder().setAlluxioPath(alluxioPath)
                  ...
                  .setCrossCluster(info.getOptions().getCrossCluster())
