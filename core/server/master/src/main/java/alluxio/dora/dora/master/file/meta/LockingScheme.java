...
public final class LockingScheme {
   ...
   * @param pathCache the {@link DefaultFileSystemMaster}'s path cache
   * @param descendantType the descendant type
   */
  public LockingScheme(AlluxioURI path, InodeTree.LockPattern desiredPattern,
  ...
  public InodeTree.LockPattern getPattern() {
    if (mShouldSync.isShouldSync()) {
      ...
      return InodeTree.LockPattern.WRITE_EDGE;
    }
    return mDesiredLockPattern;
  }
