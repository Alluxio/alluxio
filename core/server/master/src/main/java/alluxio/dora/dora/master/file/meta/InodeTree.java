...
import alluxio.dora.dora.master.block.ContainerIdGenerable;
import alluxio.dora.dora.master.file.RpcContext;
...
import alluxio.dora.dora.master.file.contexts.CreatePathContext;
import alluxio.dora.dora.master.journal.DelegatingJournaled;
...
import alluxio.dora.dora.master.metastore.DelegatingReadOnlyInodeStore;
...
import alluxio.dora.dora.retry.ExponentialBackoffRetry;
import alluxio.dora.dora.retry.RetryPolicy;
...
import alluxio.dora.dora.underfs.options.MkdirsOptions;
import alluxio.dora.dora.util.CommonUtils;
import alluxio.dora.dora.util.interfaces.Scoped;
import alluxio.dora.dora.wire.OperationId;
...
public class InodeTree implements DelegatingJournaled {
  ...
  public void setReplication(RpcContext rpcContext, LockedInodePath inodePath,
    ...
    if (inode.isFile()) {
      ...
      Preconditions.checkArgument(newMax == Constants.REPLICATION_MAX_INFINITY
          || newMax >= newMin,
