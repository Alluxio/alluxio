...
import alluxio.dora.dora.master.service.jvmmonitor.JvmMonitorService;
...
import alluxio.dora.dora.master.throttle.DefaultThrottleMaster;
...
public class AlluxioMasterProcess extends MasterProcess {
  ...
  AlluxioMasterProcess(JournalSystem journalSystem, PrimarySelector leaderSelector) {
    super(journalSystem, leaderSelector, NetworkAddressUtils.ServiceType.MASTER_WEB, NetworkAddressUtils.ServiceType.MASTER_RPC);
  ...
  protected CoreMasterContext.Builder createBaseMasterContext() {
    ...
    return CoreMasterContext.newBuilder()
        ...
        .setPort(NetworkAddressUtils.getPort(NetworkAddressUtils.ServiceType.MASTER_RPC, Configuration.global()))
        .setUfsManager(mUfsManager);
  }

  @Override
  public WebServer createWebServer() {
    return new MasterWebServer(NetworkAddressUtils.ServiceType.MASTER_WEB.getServiceName(), mWebBindAddress, this);
  }
