...
import alluxio.dora.dora.master.file.DefaultFileSystemMaster;
 ...
 * {@link DefaultFileSystemMaster#needsSync} to notify that a path
...
public class UfsSyncPathCache {
  ...
  public SyncCheck shouldSyncPath(AlluxioURI path, long intervalMs, DescendantType descendantType)
    ...
    int parentLevel = 0;
    String currPath = PathUtils.cleanPath(path.getPath());
