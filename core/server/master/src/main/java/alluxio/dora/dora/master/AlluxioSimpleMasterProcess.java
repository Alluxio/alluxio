...
public abstract class AlluxioSimpleMasterProcess extends MasterProcess {
  ...
  AlluxioSimpleMasterProcess(String masterName, JournalDomain journalDomain,
                             JournalSystem journalSystem, PrimarySelector leaderSelector, NetworkAddressUtils.ServiceType webService,
                             NetworkAddressUtils.ServiceType rpcService, PropertyKey hostNameKey) {
