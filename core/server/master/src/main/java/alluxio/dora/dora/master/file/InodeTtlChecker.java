...
import alluxio.dora.dora.master.file.meta.TtlBucket;
import alluxio.dora.dora.master.file.meta.TtlBucketList;
      ...
      for (Inode inode : bucket.getInodes()) {
        ...
        try (LockedInodePath inodePath =
            mInodeTree.lockFullInodePath(
                inode.getId(), InodeTree.LockPattern.READ, NoopJournalContext.INSTANCE)
        ) {
