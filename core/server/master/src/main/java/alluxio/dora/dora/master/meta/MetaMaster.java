...
import alluxio.dora.dora.master.backup.BackupOps;
...
public interface MetaMaster extends BackupOps, Master {
  ...
  /**
   * @return a array of {@link alluxio.dora.dora.wire.MasterInfo}s of masters
   */
  alluxio.dora.dora.wire.MasterInfo[] getMasterInfos();

  /**
   * @return a array of {@link alluxio.dora.dora.wire.MasterInfo}s of lost masters
   */
