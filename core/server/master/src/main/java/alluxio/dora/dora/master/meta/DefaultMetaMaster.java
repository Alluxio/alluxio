...
package alluxio.dora.dora.master.meta;

import alluxio.dora.dora.ClientContext;
import alluxio.dora.dora.Constants;
import alluxio.dora.dora.Server;
import alluxio.dora.dora.clock.SystemClock;
import alluxio.dora.dora.collections.IndexDefinition;
import alluxio.dora.dora.collections.IndexedSet;
import alluxio.dora.dora.conf.Configuration;
import alluxio.dora.dora.conf.ConfigurationValueOptions;
import alluxio.dora.dora.conf.PropertyKey;
import alluxio.dora.dora.conf.Source;
import alluxio.dora.dora.grpc.GrpcService;
import alluxio.dora.dora.master.CoreMaster;
import alluxio.dora.dora.master.CoreMasterContext;
import alluxio.dora.dora.master.StateLockOptions;
import alluxio.dora.dora.master.backup.BackupLeaderRole;
import alluxio.dora.dora.master.backup.BackupRole;
import alluxio.dora.dora.master.backup.BackupWorkerRole;
import alluxio.dora.dora.master.block.BlockMaster;
import alluxio.dora.dora.master.journal.JournalContext;
import alluxio.dora.dora.master.journal.Journaled;
import alluxio.dora.dora.master.meta.checkconf.ConfigurationChecker;
import alluxio.dora.dora.master.meta.checkconf.ConfigurationStore;
import alluxio.dora.dora.util.ConfigurationUtils;
import alluxio.dora.dora.util.IdUtils;
import alluxio.dora.dora.util.OSUtils;
...
import alluxio.dora.dora.wire.Address;
import alluxio.dora.dora.wire.BackupStatus;
import alluxio.dora.dora.wire.ConfigCheckReport;
import alluxio.dora.dora.wire.ConfigHash;
...
import alluxio.dora.dora.heartbeat.HeartbeatThread;
...
public final class DefaultMetaMaster extends CoreMaster implements MetaMaster {
  ...
  @Override
  public alluxio.dora.dora.wire.Configuration getConfiguration(GetConfigurationPOptions options) {
    ...
    // the properties.
    alluxio.dora.dora.wire.Configuration.Builder builder = alluxio.dora.dora.wire.Configuration.newBuilder();
  ...
  @Override
  public alluxio.dora.dora.wire.MasterInfo[] getMasterInfos() {
    alluxio.dora.dora.wire.MasterInfo[] masterInfos = new alluxio.dora.dora.wire.MasterInfo[mMasters.size()];
    int indexNum = 0;
    for (MasterInfo master : mMasters) {
      masterInfos[indexNum] = new alluxio.dora.dora.wire.MasterInfo(master.getId(),
  ...
  @Override
  public alluxio.dora.dora.wire.MasterInfo[] getLostMasterInfos() {
    alluxio.dora.dora.wire.MasterInfo[] masterInfos = new alluxio.dora.dora.wire.MasterInfo[mLostMasters.size()];
    int indexNum = 0;
