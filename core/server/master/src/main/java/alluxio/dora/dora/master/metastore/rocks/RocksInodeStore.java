...
import alluxio.dora.dora.rocks.RocksStore;
...
public class RocksInodeStore implements InodeStore {
  ...
  public RocksInodeStore(String baseDir) {
    ...
    RocksStore.checkSetTableConfig(PropertyKey.MASTER_METASTORE_ROCKS_INODE_CACHE_SIZE,
    ...
    RocksStore.checkSetTableConfig(PropertyKey.MASTER_METASTORE_ROCKS_EDGE_CACHE_SIZE,
