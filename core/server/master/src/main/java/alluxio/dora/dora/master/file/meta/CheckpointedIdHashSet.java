...
import alluxio.dora.dora.collections.DelegatingSet;
import alluxio.dora.dora.master.journal.checkpoint.*;
import alluxio.dora.master.journal.checkpoint.*;
...
public abstract class CheckpointedIdHashSet extends DelegatingSet<Long> implements Checkpointed {
  ...
  public void restoreFromCheckpoint(CheckpointInputStream input) throws IOException {
    clear();
    LongsCheckpointFormat.LongsCheckpointReader reader = new LongsCheckpointFormat.LongsCheckpointReader(input);
