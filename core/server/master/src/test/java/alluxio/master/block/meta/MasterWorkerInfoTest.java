...
public final class MasterWorkerInfoTest {
  private static final List<String> STORAGE_TIER_ALIASES = Lists.newArrayList(Constants.MEDIUM_MEM, Constants.MEDIUM_SSD);
  ...
  private static final Map<String, Long> TOTAL_BYTES_ON_TIERS =
      ImmutableMap.of(Constants.MEDIUM_MEM, Constants.KB * 3L, Constants.MEDIUM_SSD, Constants.KB * 3L);
  private static final Map<String, Long> USED_BYTES_ON_TIERS =
      ImmutableMap.of(Constants.MEDIUM_MEM, (long) Constants.KB, Constants.MEDIUM_SSD, (long) Constants.KB);
  ...
  public void getFreeBytesOnTiers() {
    assertEquals(ImmutableMap.of(Constants.MEDIUM_MEM, Constants.KB * 2L, Constants.MEDIUM_SSD, Constants.KB * 2L),
  ...
  public void updateUsedBytes() {
    ...
    Map<String, Long> usedBytesOnTiers =
        ImmutableMap.of(Constants.MEDIUM_MEM, Constants.KB * 2L, Constants.MEDIUM_SSD, (long) Constants.KB);
