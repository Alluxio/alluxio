...
public class MetricsStoreTest {
  ...
  public void putWorkerMetrics() {
    ...
    List<Metric> metrics1 = Lists.newArrayList(
        Metric.from(MetricKey.WORKER_BYTES_READ_REMOTE_UFS.getName() + "." + workerHost1,
    ...
    List<Metric> metrics2 = Lists.newArrayList(
        Metric.from(MetricKey.WORKER_BYTES_READ_REMOTE_UFS.getName() + "." + workerHost2,
            1, MetricType.COUNTER));
    mMetricStore.putWorkerMetrics(workerHost2, metrics2);
    assertEquals(11,
        MetricsSystem.counter(MetricKey.CLUSTER_BYTES_READ_REMOTE_UFS.getName()).getCount());
  }
