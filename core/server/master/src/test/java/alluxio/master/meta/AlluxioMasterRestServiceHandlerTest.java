...
public final class AlluxioMasterRestServiceHandlerTest {
  ...
  private static final Map<String, Long> WORKER1_TOTAL_BYTES_ON_TIERS = ImmutableMap.of(Constants.MEDIUM_MEM, 10L,
      Constants.MEDIUM_SSD, 20L);
  private static final Map<String, Long> WORKER2_TOTAL_BYTES_ON_TIERS = ImmutableMap.of(Constants.MEDIUM_MEM,
      1000L, Constants.MEDIUM_SSD, 2000L);
  private static final Map<String, Long> WORKER1_USED_BYTES_ON_TIERS = ImmutableMap.of(Constants.MEDIUM_MEM, 1L,
      Constants.MEDIUM_SSD, 2L);
  private static final Map<String, Long> WORKER2_USED_BYTES_ON_TIERS = ImmutableMap.of(Constants.MEDIUM_MEM, 100L,
