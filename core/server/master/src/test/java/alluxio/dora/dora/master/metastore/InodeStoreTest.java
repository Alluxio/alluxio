...
package alluxio.dora.dora.master.metastore;
...
import alluxio.dora.dora.master.file.meta.Edge;
import alluxio.dora.dora.master.file.meta.Inode;
import alluxio.dora.dora.master.file.meta.InodeLockManager;
import alluxio.dora.dora.master.file.meta.InodeView;
import alluxio.dora.dora.master.file.meta.MutableInode;
import alluxio.dora.dora.master.file.meta.MutableInodeDirectory;
...
public class InodeStoreTest {
  ...
  public void batchWrite() {
    ...
    InodeStore.WriteBatch batch = mStore.createWriteBatch();
    MutableInodeFile child = inodeFile(1, 0, "child");
  ...
  public void addRemoveAddList() {
    ...
    Assert.assertEquals(9, CloseableIterator.size(mStore.getChildren(mRoot)));
