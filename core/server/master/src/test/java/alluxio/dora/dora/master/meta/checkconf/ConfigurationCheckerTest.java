...
public class ConfigurationCheckerTest
{
  ...
  public void checkConf() {
    // Prepare data
    PropertyKey keyMasterEnforce = PropertyKey.Builder.stringBuilder("TestKey1")
    ...
    PropertyKey keyWorkerWarn = PropertyKey.Builder.stringBuilder("TestKey2")
    ...
    PropertyKey keyServerEnforce = PropertyKey.Builder.stringBuilder("TestKey3")
        .setConsistencyCheckLevel(PropertyKey.ConsistencyCheckLevel.ENFORCE)
