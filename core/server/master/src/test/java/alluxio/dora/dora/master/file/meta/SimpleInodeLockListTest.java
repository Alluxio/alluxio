...
public class SimpleInodeLockListTest extends BaseInodeLockingTest {
  ...
  public void lockSimple() {
    ...
    Assert.assertEquals(mLockList.getLockMode(), LockMode.READ);
    ...
    Assert.assertEquals(mLockList.getLockMode(), LockMode.WRITE);
  ...
  public void pushWriteLockedEdge() {
    ...
    Assert.assertEquals(LockMode.WRITE, mLockList.getLockMode());
  ...
  public void lockAndUnlockLast() {
    ...
    assertEquals(Arrays.asList(mRootDir), mLockList.getLockedInodes());
    Assert.assertEquals(LockMode.READ, mLockList.getLockMode());
