...
public class LockedInodePathTest extends BaseInodeLockingTest {
  ...
  public void pathExistsReadLock() throws Exception {
    ...
    Assert.assertEquals(InodeTree.LockPattern.READ, mPath.getLockPattern());
  ...
  public void pathExistsWriteLock() throws Exception {
    mPath = create("/a/b/c", InodeTree.LockPattern.WRITE_INODE);

    assertTrue(mPath.fullPathExists());
    assertEquals(Arrays.asList(mRootDir, mDirA, mDirB, mFileC), mPath.getInodeList());
    Assert.assertEquals(InodeTree.LockPattern.WRITE_INODE, mPath.getLockPattern());
  ...
  public void pathExistsWriteEdgeLock() throws Exception {
    mPath = create("/a/b/c", InodeTree.LockPattern.WRITE_EDGE);
    ...
    assertEquals(Arrays.asList(mRootDir, mDirA, mDirB, mFileC), mPath.getInodeList());
    assertEquals(4, mPath.getExistingInodeCount());
    Assert.assertEquals(InodeTree.LockPattern.WRITE_EDGE, mPath.getLockPattern());
  ...
  public void missingLastReadLock() throws Exception {
    mPath = create("/a/b/missing", InodeTree.LockPattern.READ);
  ...
  public void missingLastWriteLock() throws Exception {
    mPath = create("/a/b/missing", InodeTree.LockPattern.WRITE_INODE);
  ...
  public void missingLastWriteEdgeLock() throws Exception {
    mPath = create("/a/b/missing", InodeTree.LockPattern.WRITE_EDGE);
  ...
  public void missingMultipleReadLock() throws Exception {
    mPath = create("/a/miss1/miss2", InodeTree.LockPattern.READ);
  ...
  public void missingMultipleWriteEdgeLock() throws Exception {
    mPath = create("/a/miss1/miss2", InodeTree.LockPattern.WRITE_EDGE);
  ...
  public void readLockRoot() throws Exception {
    mPath = create("/", InodeTree.LockPattern.READ);
  ...
  public void writeLockRoot() throws Exception {
    mPath = create("/", InodeTree.LockPattern.WRITE_INODE);
  ...
  public void writeEdgeLockRoot() throws Exception {
    mPath = create("/", InodeTree.LockPattern.WRITE_EDGE);
  ...
  public void removeLastReadLockedInode() throws Exception {
    mPath = create("/a", InodeTree.LockPattern.READ);
  ...
  public void removeLastWriteEdgeLockedInode() throws Exception {
    mPath = create("/a", InodeTree.LockPattern.WRITE_EDGE);
  ...
  public void removeLastInodeImplicitlyLocked() throws Exception {
    ...
    LockedInodePath pathC = mPath.lockDescendant(new AlluxioURI("/a/b/c"), InodeTree.LockPattern.READ);
  ...
  public void addNextFinalInode() throws Exception {
    mPath = create("/a/missing", InodeTree.LockPattern.WRITE_EDGE);
  ...
  public void lockChildReadToWriteEdge() throws Exception {
    ...
    LockedInodePath childPath = mPath.lockChild(mDirB, InodeTree.LockPattern.WRITE_EDGE);
    assertEquals(Arrays.asList(mRootDir, mDirA, mDirB), childPath.getInodeList());
    Assert.assertEquals(InodeTree.LockPattern.WRITE_EDGE, childPath.getLockPattern());
  ...
  public void lockChildReadToWriteInode() throws Exception {
    ...
    LockedInodePath childPath = mPath.lockChild(mDirB, InodeTree.LockPattern.WRITE_INODE);
    assertEquals(Arrays.asList(mRootDir, mDirA, mDirB), childPath.getInodeList());
    Assert.assertEquals(InodeTree.LockPattern.WRITE_INODE, childPath.getLockPattern());
    assertTrue(childPath.fullPathExists());
    assertEquals(mDirB, childPath.getInode());
  ...
  public void lockChildWriteInodeToWriteEdge() throws Exception {
    mPath = create("/a", InodeTree.LockPattern.WRITE_INODE);
  ...
  public void lockChildReadToRead() throws Exception {
    ...
    LockedInodePath childPath = mPath.lockChild(mDirB, InodeTree.LockPattern.READ);
    assertEquals(Arrays.asList(mRootDir, mDirA, mDirB), childPath.getInodeList());
    Assert.assertEquals(InodeTree.LockPattern.READ, childPath.getLockPattern());
    assertTrue(childPath.fullPathExists());
    assertEquals(mDirB, childPath.getInode());
  ...
  public void lockChildMultipleReadExtensions() throws Exception {
    ...
    LockedInodePath childPath1 = mPath.lockChild(mDirB, InodeTree.LockPattern.READ);
    LockedInodePath childPath2 = childPath1.lockChild(mFileC, InodeTree.LockPattern.READ);
  ...
  public void lockDescendantReadToWriteEdge() throws Exception {
    ...
    LockedInodePath childPath =
        mPath.lockDescendant(new AlluxioURI("/a/b/c"), InodeTree.LockPattern.WRITE_EDGE);
    assertTrue(childPath.fullPathExists());
  ...
  public void testFlushJournal() throws InvalidPathException, UnavailableException {
    ...
    try (LockedInodePath path =
             create("/a/missing/missing2", InodeTree.LockPattern.WRITE_EDGE, journalContext)) {
  ...
  private LockedInodePath create(String path, InodeTree.LockPattern lockPattern) throws InvalidPathException {
    return create(path, lockPattern, NoopJournalContext.INSTANCE);
  }

  private LockedInodePath create(
          String path, InodeTree.LockPattern lockPattern, JournalContext journalContext
