...
public final class BlockStoreMetaTest {
  ...
  public void getCapacityBytesOnTiers() {
    Map<String, Long> expectedCapacityBytesOnTiers = ImmutableMap.of(Constants.MEDIUM_MEM, 5000L, Constants.MEDIUM_SSD, 60000L);
  ...
  public void getUsedBytesOnTiers() {
    long usedBytes = TEST_BLOCK_SIZE * COMMITTED_BLOCKS_NUM;
    Map<String, Long> usedBytesOnTiers = ImmutableMap.of(Constants.MEDIUM_MEM, usedBytes, Constants.MEDIUM_SSD, 0L);
