...
public final class BlockMetadataManagerTest {
  ...
  public static final String[][] TIER_MEDIA_TYPE = {{Constants.MEDIUM_MEM}, {Constants.MEDIUM_HDD, Constants.MEDIUM_HDD}};
  ...
  public void getAvailableBytes() {
    ...
    assertEquals(1000, mMetaManager.getAvailableBytes(new BlockStoreLocation(Constants.MEDIUM_MEM, 0)));
    assertEquals(3000, mMetaManager.getAvailableBytes(new BlockStoreLocation(Constants.MEDIUM_HDD, 0)));
    assertEquals(5000, mMetaManager.getAvailableBytes(new BlockStoreLocation(Constants.MEDIUM_HDD, 1)));
  }
  ...
  public void getBlockStoreMeta() {
    ...
    Map<String, Long> exceptedCapacityBytesOnTiers = ImmutableMap.of(Constants.MEDIUM_MEM, 1000L, Constants.MEDIUM_HDD, 8000L);
    Map<String, Long> exceptedUsedBytesOnTiers = ImmutableMap.of(Constants.MEDIUM_MEM, 0L, Constants.MEDIUM_HDD, 0L);
