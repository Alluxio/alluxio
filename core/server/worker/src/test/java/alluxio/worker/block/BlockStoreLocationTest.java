...
public final class BlockStoreLocationTest {
  ...
  public void testBelongTo() {
    ...
    BlockStoreLocation dirWithMediumType = new BlockStoreLocation(Constants.MEDIUM_MEM, 1, Constants.MEDIUM_MEM);
    BlockStoreLocation anyTierWithMEM = BlockStoreLocation.anyDirInAnyTierWithMedium(Constants.MEDIUM_MEM);
