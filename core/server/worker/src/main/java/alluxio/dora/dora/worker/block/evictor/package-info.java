 ...
 *
 * The main entry point is {@link alluxio.dora.dora.worker.block.evictor.Evictor} which returns an evictor by
 * calling alluxio.worker.block.Evictor.Factory#create.
 *
 * <h2>Evictor</h2>
 *
 * All evictors implement {@link alluxio.dora.dora.worker.block.evictor.Evictor} interface. In order to evict
 * blocks by different policies, each evictor only need to implement
 * {@link alluxio.dora.dora.worker.block.evictor.Evictor#freeSpaceWithView(long,
 * BlockStoreLocation, BlockMetadataEvictorView)}
 ...
 * in {@link alluxio.dora.dora.worker.block.evictor.Evictor#freeSpaceWithView(long,
 * BlockStoreLocation, BlockMetadataEvictorView)}
 ...
 *
 * For example,
 * {@link alluxio.dora.dora.worker.block.evictor.LRUEvictor#cascadingEvict(long,
 * BlockStoreLocation,EvictionPlan)}
