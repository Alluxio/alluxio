...
package alluxio.dora.dora.worker.block.evictor;
...
public interface Evictor {
   ...
   * {@link StorageDir} in the location has the specific amount of free
   * space after eviction. The location can be a specific
   * {@link StorageDir}, or {@link BlockStoreLocation#anyTier()} or
