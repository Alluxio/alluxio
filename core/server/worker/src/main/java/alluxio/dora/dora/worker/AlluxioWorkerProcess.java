...
import alluxio.dora.dora.worker.netty.NettyDataServer;
...
public final class AlluxioWorkerProcess implements WorkerProcess {
  ...
  AlluxioWorkerProcess(
    ...
    try {
      ...
      // Setup web server
      mWebServer =
          new WorkerWebServer(NetworkAddressUtils.getBindAddress(NetworkAddressUtils.ServiceType.WORKER_WEB,
  ...
  public void start() throws Exception {
    ...
    LOG.info("Alluxio worker started. id={}, bindHost={}, connectHost={}, rpcPort={}, webPort={}",
        workerId,
        NetworkAddressUtils.getBindHost(NetworkAddressUtils.ServiceType.WORKER_RPC, Configuration.global()),
        NetworkAddressUtils.getConnectHost(NetworkAddressUtils.ServiceType.WORKER_RPC, Configuration.global()),
        NetworkAddressUtils.getPort(NetworkAddressUtils.ServiceType.WORKER_RPC, Configuration.global()),
        NetworkAddressUtils.getPort(NetworkAddressUtils.ServiceType.WORKER_WEB, Configuration.global()));
