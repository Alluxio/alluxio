...
public final class BlockMetricsReporter extends AbstractBlockStoreEventListener {
  ...
  public void onMoveBlockByClient(long blockId, BlockStoreLocation oldLocation,
    ...
    int oldTierOrdinal = BlockMetadataManager.WORKER_STORAGE_TIER_ASSOC.getOrdinal(oldLocation.tierAlias());
    int newTierOrdinal = BlockMetadataManager.WORKER_STORAGE_TIER_ASSOC.getOrdinal(newLocation.tierAlias());
