        ...
        if (System.currentTimeMillis() - mLastSuccessfulHeartbeatMs
          ...
          if (Configuration.getBoolean(PropertyKey.TEST_MODE)) {
            throw new RuntimeException(
                String.format("Master heartbeat timeout exceeded: %s", mHeartbeatTimeoutMs));
          }
