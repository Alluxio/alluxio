...
public class LocationInfo implements org.apache.thrift.TBase<LocationInfo, LocationInfo._Fields>, java.io.Serializable, Cloneable, Comparable<LocationInfo> {
  ...
  public LocationInfo setAddress(NetAddress address) {
    this.address = address;
    return this;
  }
  ...
  public LocationInfo setStorageDirIds(List<Long> storageDirIds) {
    this.storageDirIds = storageDirIds;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_storageDirIds = true && (isSetStorageDirIds());
    list.add(present_storageDirIds);
    if (present_storageDirIds)
      list.add(storageDirIds);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  ...
                  struct.storageDirIds.add(_elem1);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            ...
            struct.storageDirIds.add(_elem6);
          }
        }
        struct.setStorageDirIdsIsSet(true);
      }
