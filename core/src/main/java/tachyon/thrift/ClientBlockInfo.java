...
public class ClientBlockInfo implements org.apache.thrift.TBase<ClientBlockInfo, ClientBlockInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ClientBlockInfo> {
  ...
  private static final org.apache.thrift.protocol.TField STORAGE_DIR_IDS_FIELD_DESC = new org.apache.thrift.protocol.TField("storageDirIds", org.apache.thrift.protocol.TType.MAP, (short)5);
  ...
  public Map<NetAddress,Long> storageDirIds; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    STORAGE_DIR_IDS((short)5, "storageDirIds");
  ...
  public ClientBlockInfo(
    ...
    Map<NetAddress,Long> storageDirIds)
  {
    this();
  ...
  public ClientBlockInfo(ClientBlockInfo other) {
    ...
    if (other.isSetStorageDirIds()) {
      Map<NetAddress,Long> __this__storageDirIds = new HashMap<NetAddress,Long>(other.storageDirIds.size());
      for (Map.Entry<NetAddress, Long> other_element : other.storageDirIds.entrySet()) {

        NetAddress other_element_key = other_element.getKey();
        Long other_element_value = other_element.getValue();

        NetAddress __this__storageDirIds_copy_key = new NetAddress(other_element_key);

        Long __this__storageDirIds_copy_value = other_element_value;

        __this__storageDirIds.put(__this__storageDirIds_copy_key, __this__storageDirIds_copy_value);
      }
  ...
  public void putToStorageDirIds(NetAddress key, long val) {
    if (this.storageDirIds == null) {
      this.storageDirIds = new HashMap<NetAddress,Long>();
    }
    this.storageDirIds.put(key, val);
  }

  public Map<NetAddress,Long> getStorageDirIds() {
    return this.storageDirIds;
  }

  public ClientBlockInfo setStorageDirIds(Map<NetAddress,Long> storageDirIds) {
    this.storageDirIds = storageDirIds;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STORAGE_DIR_IDS:
      if (value == null) {
        ...
        setStorageDirIds((Map<NetAddress,Long>)value);
      }
      break;
  ...
  private static class ClientBlockInfoStandardScheme extends StandardScheme<ClientBlockInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.storageDirIds = new HashMap<NetAddress,Long>(2*_map3.size);
                for (int _i4 = 0; _i4 < _map3.size; ++_i4)
                {
                  ...
                  _key5.read(iprot);
                  _val6 = iprot.readI64();
                  struct.storageDirIds.put(_key5, _val6);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientBlockInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.storageDirIds != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.I64, struct.storageDirIds.size()));
          for (Map.Entry<NetAddress, Long> _iter8 : struct.storageDirIds.entrySet())
          {
      ...
      if (struct.isSetStorageDirIds()) {
        {
          ...
          for (Map.Entry<NetAddress, Long> _iter10 : struct.storageDirIds.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.storageDirIds = new HashMap<NetAddress,Long>(2*_map14.size);
          for (int _i15 = 0; _i15 < _map14.size; ++_i15)
          {
            ...
            struct.storageDirIds.put(_key16, _val17);
          }
        }
        struct.setStorageDirIdsIsSet(true);
      }
