...
/**
 * Request space from current storage tier. It returns the affordable StorageDir according to
...
public interface AllocateStrategy {
   ...
   * 
   * @param storageDirs candidates of StorageDir which space will be allocated in
  ...
  /**
   * Allocate space requested on StorageDirs
   * 
   * @param storageDirs candidates of StorageDir that space will be allocated in
