...
interface TachyonFSCore extends Closeable {
   ...
   */
  int createFile(String path, String ufsPath, long blockSizeByte, boolean recursive)
      throws IOException;
   ...
   * @throws IOException
   */
  boolean delete(int fileId, String path, boolean recursive) throws IOException;
   ...
   * @throws IOException
   */
  ClientFileInfo getFileStatus(int fileId, String path) throws IOException;
   ...
   * @throws IOException
   */
  List<ClientFileInfo> listStatus(String path) throws IOException;
   ...
   * @throws IOException
   */
  boolean mkdirs(String path, boolean recursive) throws IOException;
   ...
   * @throws IOException
   */
  boolean rename(int fileId, String srcPath, String dstPath) throws IOException;
}
