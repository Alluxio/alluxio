...
public class BlockInfoTest {
  ...
  public void generateClientBlockInfoTest() {
    ...
    tInfo.addLocation(15, new NetAddress("abc", 1), storageId);
    tInfo.addLocation(22, new NetAddress("def", 2), storageId);
    tInfo.addLocation(29, new NetAddress("gh", 3), storageId);
