...
public enum PropertyKey {
  ...
  MASTER_RPC_PORT(Name.MASTER_RPC_PORT, Constants.DEFAULT_MASTER_RPC_PORT),
  ...
  MASTER_WEB_PORT(Name.MASTER_WEB_PORT, Constants.DEFAULT_MASTER_WEB_PORT),
  ...
  WORKER_DATA_PORT(Name.WORKER_DATA_PORT, Constants.DEFAULT_WORKER_DATA_PORT),
  ...
  WORKER_RPC_PORT(Name.WORKER_RPC_PORT, Constants.DEFAULT_WORKER_RPC_PORT),
  ...
  WORKER_WEB_PORT(Name.WORKER_WEB_PORT, Constants.DEFAULT_WORKER_WEB_PORT),
  ...
  PROXY_WEB_PORT(Name.PROXY_WEB_PORT, Constants.DEFAULT_PROXY_WEB_PORT),
