...
public enum PreconditionMessage {
  ...
  ERR_BUFFER_STATE("Buffer length: %d, offset: %d, len: %d"),
  ...
  ERR_SEEK_NEGATIVE("Seek position is negative: %d"),
  ERR_SEEK_PAST_END_OF_BLOCK("Seek position past end of block: %d"),
  ERR_SEEK_PAST_END_OF_FILE("Seek position past end of file: %d"),
