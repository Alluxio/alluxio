 ...
 */
// TODO(lu) change to simple interface and have default implementation in abstract class
// after block store is removed so that PagedFileReader does not need to extend abstract class
// BlockReader
public interface PositionReadable extends Closeable {
  /**
  ...
  /**
   * Closes the position reader and do cleanup job if any.
   */
