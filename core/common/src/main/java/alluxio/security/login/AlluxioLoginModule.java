...
/**
 * A login module that search the Kerberos or OS user from Subject, and then convert to a Alluxio
...
public final class AlluxioLoginModule implements LoginModule {
   ...
   * convert it to a Alluxio user and add into the Subject.
   * @return true in all cases
  ...
  public boolean commit() throws LoginException {
    ...
    // if a user is found, convert it to a Alluxio user and save it.
    if (user != null) {
