...
public final class ImpersonationAuthenticator implements Reconfigurable {
  ...
  private volatile Map<String, Set<String>> mImpersonationGroups;
  ...
  public ImpersonationAuthenticator(AlluxioConfiguration conf) {
    loadImpersonationUser(conf, conf.keySet());
  }
  ...
  public void update(Map<PropertyKey, Object> changedProperties) {
    if (changedProperties != null) {
      ...
      for (PropertyKey key : changedProperties.keySet()) {
  ...
  @Override
  public void update() {
    loadImpersonationUser(Configuration.global(), Configuration.global().keySet());
  }

  private void loadImpersonationUser(AlluxioConfiguration conf, Set<PropertyKey> keySet) {
