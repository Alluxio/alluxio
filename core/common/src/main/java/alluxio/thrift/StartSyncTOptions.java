...
public class StartSyncTOptions implements org.apache.thrift.TBase<StartSyncTOptions, StartSyncTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<StartSyncTOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StartSyncTOptions");
  ...
  static {
    schemes.put(StandardScheme.class, new StartSyncTOptionsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StartSyncTOptionsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StartSyncTOptions.class, metaDataMap);
  }

  public StartSyncTOptions() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public StartSyncTOptions(StartSyncTOptions other) {
    if (other.isSetCommonOptions()) {
      this.commonOptions = new FileSystemMasterCommonTOptions(other.commonOptions);
    }
  }

  public StartSyncTOptions deepCopy() {
    return new StartSyncTOptions(this);
  }
  ...
  public StartSyncTOptions setCommonOptions(FileSystemMasterCommonTOptions commonOptions) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StartSyncTOptions)
      return this.equals((StartSyncTOptions)that);
    return false;
  }

  public boolean equals(StartSyncTOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StartSyncTOptions other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StartSyncTOptions(");
    boolean first = true;
  ...
  private static class StartSyncTOptionsStandardSchemeFactory implements SchemeFactory {
    public StartSyncTOptionsStandardScheme getScheme() {
      return new StartSyncTOptionsStandardScheme();
    }
  }

  private static class StartSyncTOptionsStandardScheme extends StandardScheme<StartSyncTOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StartSyncTOptions struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StartSyncTOptions struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class StartSyncTOptionsTupleSchemeFactory implements SchemeFactory {
    public StartSyncTOptionsTupleScheme getScheme() {
      return new StartSyncTOptionsTupleScheme();
    }
  }

  private static class StartSyncTOptionsTupleScheme extends TupleScheme<StartSyncTOptions> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StartSyncTOptions struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StartSyncTOptions struct) throws org.apache.thrift.TException {
