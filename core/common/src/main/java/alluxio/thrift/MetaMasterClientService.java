...
public class MetaMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     */
    public GetClusterInfoTResponse getClusterInfo(GetClusterInfoTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void getClusterInfo(GetClusterInfoTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public GetClusterInfoTResponse getClusterInfo(GetClusterInfoTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_getClusterInfo(options);
      return recv_getClusterInfo();
    }

    public void send_getClusterInfo(GetClusterInfoTOptions options) throws org.apache.thrift.TException
    {
    ...
    public GetClusterInfoTResponse recv_getClusterInfo() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public static class getClusterInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public GetClusterInfoTResponse getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getClusterInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getClusterInfo_args> {
      ...
      public getClusterInfo_result getResult(I iface, getClusterInfo_args args) throws org.apache.thrift.TException {
        getClusterInfo_result result = new getClusterInfo_result();
        try {
          result.success = iface.getClusterInfo(args.options);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class getClusterInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getClusterInfo_args, GetClusterInfoTResponse> {
      public getClusterInfo() {
        super("getClusterInfo");
      }
      ...
      public AsyncMethodCallback<GetClusterInfoTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<GetClusterInfoTResponse>() { 
          public void onComplete(GetClusterInfoTResponse o) {
            getClusterInfo_result result = new getClusterInfo_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getClusterInfo_args args, org.apache.thrift.async.AsyncMethodCallback<GetClusterInfoTResponse> resultHandler) throws TException {
        iface.getClusterInfo(args.options,resultHandler);
      }
    }
  ...
  public static class getClusterInfo_args implements org.apache.thrift.TBase<getClusterInfo_args, getClusterInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getClusterInfo_args>   {
    ...
    private GetClusterInfoTOptions options; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetClusterInfoTOptions.class)));
    ...
    public getClusterInfo_args(
      GetClusterInfoTOptions options)
    {
      this();
      this.options = options;
    }
    ...
    public getClusterInfo_args(getClusterInfo_args other) {
      if (other.isSetOptions()) {
        this.options = new GetClusterInfoTOptions(other.options);
      }
    }
     ...
     * the method options
     */
    public GetClusterInfoTOptions getOptions() {
      return this.options;
    }
     ...
     * the method options
     */
    public getClusterInfo_args setOptions(GetClusterInfoTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((GetClusterInfoTOptions)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new GetClusterInfoTOptions();
  ...
  public static class getClusterInfo_result implements org.apache.thrift.TBase<getClusterInfo_result, getClusterInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getClusterInfo_result>   {
    ...
    private GetClusterInfoTResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetClusterInfoTResponse.class)));
    ...
    public getClusterInfo_result(
      GetClusterInfoTResponse success,
    ...
    public getClusterInfo_result(getClusterInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new GetClusterInfoTResponse(other.success);
      }
      if (other.isSetE()) {
    ...
    public GetClusterInfoTResponse getSuccess() {
      return this.success;
    }

    public getClusterInfo_result setSuccess(GetClusterInfoTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public getClusterInfo_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((GetClusterInfoTResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getClusterInfo_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new GetClusterInfoTResponse();
