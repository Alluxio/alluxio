            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.blockIds = new ArrayList<Long>(_list110.size);
                long _elem111;
                for (int _i112 = 0; _i112 < _list110.size; ++_i112)
                {
                  _elem111 = iprot.readI64();
                  struct.blockIds.add(_elem111);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PersistFile struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockIds != null) {
        oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter113 : struct.blockIds)
          {
      ...
      if (struct.isSetBlockIds()) {
        {
          ...
          for (long _iter114 : struct.blockIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.blockIds = new ArrayList<Long>(_list115.size);
          long _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = iprot.readI64();
            struct.blockIds.add(_elem116);
          }
        }
        struct.setBlockIdsIsSet(true);
      }
