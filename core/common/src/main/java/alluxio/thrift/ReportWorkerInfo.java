...
public class ReportWorkerInfo implements org.apache.thrift.TBase<ReportWorkerInfo, ReportWorkerInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ReportWorkerInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReportWorkerInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new ReportWorkerInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReportWorkerInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReportWorkerInfo.class, metaDataMap);
  }
   ...
   */
  public ReportWorkerInfo(ReportWorkerInfo other) {
  ...
  public ReportWorkerInfo deepCopy() {
    return new ReportWorkerInfo(this);
  }
  ...
  public ReportWorkerInfo setAddress(alluxio.thrift.WorkerNetAddress address) {
    this.address = address;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReportWorkerInfo)
      return this.equals((ReportWorkerInfo)that);
    return false;
  }

  public boolean equals(ReportWorkerInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReportWorkerInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReportWorkerInfo(");
    boolean first = true;
  ...
  private static class ReportWorkerInfoStandardSchemeFactory implements SchemeFactory {
    public ReportWorkerInfoStandardScheme getScheme() {
      return new ReportWorkerInfoStandardScheme();
    }
  }

  private static class ReportWorkerInfoStandardScheme extends StandardScheme<ReportWorkerInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReportWorkerInfo struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.capacityBytesOnTiers = new HashMap<String,Long>(2*_map36.size);
                String _key37;
                long _val38;
                for (int _i39 = 0; _i39 < _map36.size; ++_i39)
                {
                  ...
                  struct.capacityBytesOnTiers.put(_key37, _val38);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.usedBytesOnTiers = new HashMap<String,Long>(2*_map40.size);
                String _key41;
                long _val42;
                for (int _i43 = 0; _i43 < _map40.size; ++_i43)
                {
                  ...
                  struct.usedBytesOnTiers.put(_key41, _val42);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReportWorkerInfo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.capacityBytesOnTiers != null) {
        oprot.writeFieldBegin(CAPACITY_BYTES_ON_TIERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Long> _iter44 : struct.capacityBytesOnTiers.entrySet())
          {
      ...
      if (struct.usedBytesOnTiers != null) {
        oprot.writeFieldBegin(USED_BYTES_ON_TIERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Long> _iter45 : struct.usedBytesOnTiers.entrySet())
          {
  ...
  private static class ReportWorkerInfoTupleSchemeFactory implements SchemeFactory {
    public ReportWorkerInfoTupleScheme getScheme() {
      return new ReportWorkerInfoTupleScheme();
    }
  }

  private static class ReportWorkerInfoTupleScheme extends TupleScheme<ReportWorkerInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReportWorkerInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCapacityBytesOnTiers()) {
        {
          ...
          for (Map.Entry<String, Long> _iter46 : struct.capacityBytesOnTiers.entrySet())
          {
      ...
      if (struct.isSetUsedBytesOnTiers()) {
        {
          ...
          for (Map.Entry<String, Long> _iter47 : struct.usedBytesOnTiers.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.capacityBytesOnTiers = new HashMap<String,Long>(2*_map48.size);
          String _key49;
          long _val50;
          for (int _i51 = 0; _i51 < _map48.size; ++_i51)
          {
            ...
            struct.capacityBytesOnTiers.put(_key49, _val50);
          }
        }
        struct.setCapacityBytesOnTiersIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          for (int _i55 = 0; _i55 < _map52.size; ++_i55)
          {
            ...
            struct.usedBytesOnTiers.put(_key53, _val54);
          }
        }
        struct.setUsedBytesOnTiersIsSet(true);
      }
