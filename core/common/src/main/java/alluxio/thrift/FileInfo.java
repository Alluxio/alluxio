            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.blockIds = new ArrayList<Long>(_list18.size);
                long _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = iprot.readI64();
                  struct.blockIds.add(_elem19);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fileBlockInfos = new ArrayList<FileBlockInfo>(_list21.size);
                FileBlockInfo _elem22;
                for (int _i23 = 0; _i23 < _list21.size; ++_i23)
                {
                  _elem22 = new FileBlockInfo();
                  _elem22.read(iprot);
                  struct.fileBlockInfos.add(_elem22);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockIds != null) {
        oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter24 : struct.blockIds)
          {
      ...
      if (struct.fileBlockInfos != null) {
        oprot.writeFieldBegin(FILE_BLOCK_INFOS_FIELD_DESC);
        {
          ...
          for (FileBlockInfo _iter25 : struct.fileBlockInfos)
          {
            _iter25.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetBlockIds()) {
        {
          ...
          for (long _iter26 : struct.blockIds)
          {
      ...
      if (struct.isSetFileBlockInfos()) {
        {
          ...
          for (FileBlockInfo _iter27 : struct.fileBlockInfos)
          {
            _iter27.write(oprot);
          }
        }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.blockIds = new ArrayList<Long>(_list28.size);
          long _elem29;
          for (int _i30 = 0; _i30 < _list28.size; ++_i30)
          {
            _elem29 = iprot.readI64();
            struct.blockIds.add(_elem29);
          }
        }
        struct.setBlockIdsIsSet(true);
      }
      ...
      if (incoming.get(21)) {
        {
          ...
          struct.fileBlockInfos = new ArrayList<FileBlockInfo>(_list31.size);
          FileBlockInfo _elem32;
          for (int _i33 = 0; _i33 < _list31.size; ++_i33)
          {
            _elem32 = new FileBlockInfo();
            _elem32.read(iprot);
            struct.fileBlockInfos.add(_elem32);
          }
        }
        struct.setFileBlockInfosIsSet(true);
      }
