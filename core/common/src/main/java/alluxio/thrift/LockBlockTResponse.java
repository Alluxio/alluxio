...
public class LockBlockTResponse implements org.apache.thrift.TBase<LockBlockTResponse, LockBlockTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<LockBlockTResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new LockBlockTResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LockBlockTResponseTupleSchemeFactory());
  }
  ...
  public LockBlockTResponse setBlockPath(String blockPath) {
    this.blockPath = blockPath;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_lockBlockStatus = true && (isSetLockBlockStatus());
    list.add(present_lockBlockStatus);
    if (present_lockBlockStatus)
      list.add(lockBlockStatus.getValue());
  ...
  public int compareTo(LockBlockTResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetLockBlockStatus()).compareTo(other.isSetLockBlockStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LockBlockTResponse(");
    boolean first = true;
  ...
  private static class LockBlockTResponseStandardSchemeFactory implements SchemeFactory {
    public LockBlockTResponseStandardScheme getScheme() {
      return new LockBlockTResponseStandardScheme();
    }
  }

  private static class LockBlockTResponseStandardScheme extends StandardScheme<LockBlockTResponse> {
  ...
  private static class LockBlockTResponseTupleSchemeFactory implements SchemeFactory {
    public LockBlockTResponseTupleScheme getScheme() {
      return new LockBlockTResponseTupleScheme();
    }
  }

  private static class LockBlockTResponseTupleScheme extends TupleScheme<LockBlockTResponse> {
