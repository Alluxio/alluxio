...
public class SetAttributeTOptions implements org.apache.thrift.TBase<SetAttributeTOptions, SetAttributeTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<SetAttributeTOptions> {
  ...
  private static final org.apache.thrift.protocol.TField TTL_EXPIRY_ACTION_FIELD_DESC = new org.apache.thrift.protocol.TField("ttlExpiryAction", org.apache.thrift.protocol.TType.I32, (short)8);
  ...
  private TtlExpiryAction ttlExpiryAction; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TTL_EXPIRY_ACTION((short)8, "ttlExpiryAction");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 7: // RECURSIVE
          return RECURSIVE;
        case 8: // TTL_EXPIRY_ACTION
          return TTL_EXPIRY_ACTION;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.PINNED,_Fields.TTL,_Fields.PERSISTED,_Fields.OWNER,_Fields.GROUP,_Fields.MODE,_Fields.RECURSIVE,_Fields.TTL_EXPIRY_ACTION};
  ...
  static {
    ...
    tmpMap.put(_Fields.RECURSIVE, new org.apache.thrift.meta_data.FieldMetaData("recursive", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.TTL_EXPIRY_ACTION, new org.apache.thrift.meta_data.FieldMetaData("ttlExpiryAction", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, TtlExpiryAction.class)));
  ...
  public SetAttributeTOptions(SetAttributeTOptions other) {
    ...
    if (other.isSetTtlExpiryAction()) {
      this.ttlExpiryAction = other.ttlExpiryAction;
    }
  }
  ...
  public TtlExpiryAction getTtlExpiryAction() {
    return this.ttlExpiryAction;
  }

  public SetAttributeTOptions setTtlExpiryAction(TtlExpiryAction ttlExpiryAction) {
    this.ttlExpiryAction = ttlExpiryAction;
    return this;
  }

  public void unsetTtlExpiryAction() {
    this.ttlExpiryAction = null;
  }

  /** Returns true if field ttlExpiryAction is set (has been assigned a value) and false otherwise */
  public boolean isSetTtlExpiryAction() {
    return this.ttlExpiryAction != null;
  }

  public void setTtlExpiryActionIsSet(boolean value) {
    if (!value) {
      this.ttlExpiryAction = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case TTL_EXPIRY_ACTION:
      if (value == null) {
        unsetTtlExpiryAction();
      } else {
        setTtlExpiryAction((TtlExpiryAction)value);
      }
      break;
  ...
  public boolean equals(SetAttributeTOptions that) {
    ...
    boolean this_present_ttlExpiryAction = true && this.isSetTtlExpiryAction();
    boolean that_present_ttlExpiryAction = true && that.isSetTtlExpiryAction();
    if (this_present_ttlExpiryAction || that_present_ttlExpiryAction) {
      if (!(this_present_ttlExpiryAction && that_present_ttlExpiryAction))
        return false;
      if (!this.ttlExpiryAction.equals(that.ttlExpiryAction))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_ttlExpiryAction = true && (isSetTtlExpiryAction());
    list.add(present_ttlExpiryAction);
    if (present_ttlExpiryAction)
      list.add(ttlExpiryAction.getValue());
  ...
  public int compareTo(SetAttributeTOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetTtlExpiryAction()).compareTo(other.isSetTtlExpiryAction());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTtlExpiryAction()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ttlExpiryAction, other.ttlExpiryAction);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetTtlExpiryAction()) {
      if (!first) sb.append(", ");
      sb.append("ttlExpiryAction:");
      if (this.ttlExpiryAction == null) {
        sb.append("null");
      } else {
        sb.append(this.ttlExpiryAction);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class SetAttributeTOptionsStandardScheme extends StandardScheme<SetAttributeTOptions> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // TTL_EXPIRY_ACTION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.ttlExpiryAction = alluxio.thrift.TtlExpiryAction.findByValue(iprot.readI32());
              struct.setTtlExpiryActionIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SetAttributeTOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.ttlExpiryAction != null) {
        if (struct.isSetTtlExpiryAction()) {
          oprot.writeFieldBegin(TTL_EXPIRY_ACTION_FIELD_DESC);
          oprot.writeI32(struct.ttlExpiryAction.getValue());
          oprot.writeFieldEnd();
        }
      }
