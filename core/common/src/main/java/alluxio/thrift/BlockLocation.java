...
public class BlockLocation implements org.apache.thrift.TBase<BlockLocation, BlockLocation._Fields>, java.io.Serializable, Cloneable, Comparable<BlockLocation> {
  ...
  public BlockLocation(BlockLocation other) {
    ...
    if (other.isSetWorkerAddress()) {
      this.workerAddress = new WorkerNetAddress(other.workerAddress);
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWorkerAddress()) ? 131071 : 524287);
    if (isSetWorkerAddress())
      hashCode = hashCode * 8191 + workerAddress.hashCode();
  ...
  public int compareTo(BlockLocation other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWorkerAddress()).compareTo(other.isSetWorkerAddress());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWorkerAddress()) {
