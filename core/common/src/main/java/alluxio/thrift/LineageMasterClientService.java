...
public class LineageMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * 
     * @param ttlExpiryAction expiry action
     */
    public long reinitializeFile(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void reinitializeFile(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public long reinitializeFile(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_reinitializeFile(path, blockSizeBytes, ttl, ttlExpiryAction);
      return recv_reinitializeFile();
    }

    public void send_reinitializeFile(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction) throws org.apache.thrift.TException
    {
      reinitializeFile_args args = new reinitializeFile_args();
      args.setPath(path);
      args.setBlockSizeBytes(blockSizeBytes);
      args.setTtl(ttl);
      args.setTtlExpiryAction(ttlExpiryAction);
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void reinitializeFile(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      reinitializeFile_call method_call = new reinitializeFile_call(path, blockSizeBytes, ttl, ttlExpiryAction, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class reinitializeFile_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long ttl;
      private TtlExpiryAction ttlExpiryAction;
      public reinitializeFile_call(String path, long blockSizeBytes, long ttl, TtlExpiryAction ttlExpiryAction, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class reinitializeFile<I extends Iface> extends org.apache.thrift.ProcessFunction<I, reinitializeFile_args> {
      ...
      public reinitializeFile_result getResult(I iface, reinitializeFile_args args) throws org.apache.thrift.TException {
        reinitializeFile_result result = new reinitializeFile_result();
        try {
          result.success = iface.reinitializeFile(args.path, args.blockSizeBytes, args.ttl, args.ttlExpiryAction);
          result.setSuccessIsSet(true);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class reinitializeFile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, reinitializeFile_args, Long> {
      ...
      public void start(I iface, reinitializeFile_args args, org.apache.thrift.async.AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.reinitializeFile(args.path, args.blockSizeBytes, args.ttl, args.ttlExpiryAction,resultHandler);
      }
    }
...
;
  ...
  public static class reinitializeFile_args implements org.apache.thrift.TBase<reinitializeFile_args, reinitializeFile_args._Fields>, java.io.Serializable, Cloneable, Comparable<reinitializeFile_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TTL_EXPIRY_ACTION_FIELD_DESC = new org.apache.thrift.protocol.TField("ttlExpiryAction", org.apache.thrift.protocol.TType.I32, (short)4);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
       ...
       * expiry action
       */
      TTL_EXPIRY_ACTION((short)4, "ttlExpiryAction");
    ...
    public reinitializeFile_args setTtlExpiryAction(TtlExpiryAction ttlExpiryAction) {
      this.ttlExpiryAction = ttlExpiryAction;
      return this;
    }
