...
public class CreateUfsFileTOptions implements org.apache.thrift.TBase<CreateUfsFileTOptions, CreateUfsFileTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<CreateUfsFileTOptions> {
  ...
  private static final org.apache.thrift.protocol.TField POSIX_PERM_FIELD_DESC = new org.apache.thrift.protocol.TField("posixPerm", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  private String posixPerm; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USER((short)1, "user"),
    GROUP((short)2, "group"),
    POSIX_PERM((short)3, "posixPerm");
  ...
  private static final _Fields optionals[] = {_Fields.USER,_Fields.GROUP,_Fields.POSIX_PERM};
  ...
  static {
    ...
    tmpMap.put(_Fields.GROUP, new org.apache.thrift.meta_data.FieldMetaData("group", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.POSIX_PERM, new org.apache.thrift.meta_data.FieldMetaData("posixPerm", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public CreateUfsFileTOptions(CreateUfsFileTOptions other) {
    ...
    if (other.isSetPosixPerm()) {
      this.posixPerm = other.posixPerm;
    }
  }
  ...
  public String getPosixPerm() {
    return this.posixPerm;
  }

  public CreateUfsFileTOptions setPosixPerm(String posixPerm) {
    this.posixPerm = posixPerm;
    return this;
  }

  public void unsetPosixPerm() {
    this.posixPerm = null;
  }

  /** Returns true if field posixPerm is set (has been assigned a value) and false otherwise */
  public boolean isSetPosixPerm() {
    return this.posixPerm != null;
  }

  public void setPosixPermIsSet(boolean value) {
    if (!value) {
      this.posixPerm = null;
    }
  }
  ...
  public boolean equals(CreateUfsFileTOptions that) {
    ...
    boolean this_present_posixPerm = true && this.isSetPosixPerm();
    boolean that_present_posixPerm = true && that.isSetPosixPerm();
    if (this_present_posixPerm || that_present_posixPerm) {
      if (!(this_present_posixPerm && that_present_posixPerm))
        return false;
      if (!this.posixPerm.equals(that.posixPerm))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_posixPerm = true && (isSetPosixPerm());
    list.add(present_posixPerm);
    if (present_posixPerm)
      list.add(posixPerm);
  ...
  public int compareTo(CreateUfsFileTOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetPosixPerm()).compareTo(other.isSetPosixPerm());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPosixPerm()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.posixPerm, other.posixPerm);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetPosixPerm()) {
      if (!first) sb.append(", ");
      sb.append("posixPerm:");
      if (this.posixPerm == null) {
        sb.append("null");
      } else {
        sb.append(this.posixPerm);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class CreateUfsFileTOptionsStandardScheme extends StandardScheme<CreateUfsFileTOptions> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, CreateUfsFileTOptions struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // POSIX_PERM
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.posixPerm = iprot.readString();
              struct.setPosixPermIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CreateUfsFileTOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.posixPerm != null) {
        if (struct.isSetPosixPerm()) {
          oprot.writeFieldBegin(POSIX_PERM_FIELD_DESC);
          oprot.writeString(struct.posixPerm);
          oprot.writeFieldEnd();
        }
      }
