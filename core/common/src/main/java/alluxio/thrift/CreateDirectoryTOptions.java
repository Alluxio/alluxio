...
public class CreateDirectoryTOptions implements org.apache.thrift.TBase<CreateDirectoryTOptions, CreateDirectoryTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<CreateDirectoryTOptions> {
  ...
  private static final _Fields optionals[] = {_Fields.PERSISTED,_Fields.RECURSIVE,_Fields.ALLOW_EXISTS,_Fields.MODE,_Fields.TTL,_Fields.TTL_ACTION,_Fields.COMMON_OPTIONS,_Fields.OWNER,_Fields.GROUP};
  ...
  public CreateDirectoryTOptions setOwner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public CreateDirectoryTOptions setGroup(String group) {
    this.group = group;
    return this;
  }
