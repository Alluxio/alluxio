            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.persistFiles = new ArrayList<PersistFile>(_list18.size);
                PersistFile _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = new PersistFile();
                  _elem19.read(iprot);
                  struct.persistFiles.add(_elem19);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PersistCommandOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.persistFiles != null) {
        oprot.writeFieldBegin(PERSIST_FILES_FIELD_DESC);
        {
          ...
          for (PersistFile _iter21 : struct.persistFiles)
          {
            _iter21.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPersistFiles()) {
        {
          ...
          for (PersistFile _iter22 : struct.persistFiles)
          {
            _iter22.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.persistFiles = new ArrayList<PersistFile>(_list23.size);
          PersistFile _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new PersistFile();
            _elem24.read(iprot);
            struct.persistFiles.add(_elem24);
          }
        }
        struct.setPersistFilesIsSet(true);
      }
