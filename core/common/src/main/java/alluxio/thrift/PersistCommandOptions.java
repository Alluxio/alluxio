...
public class PersistCommandOptions implements org.apache.thrift.TBase<PersistCommandOptions, PersistCommandOptions._Fields>, java.io.Serializable, Cloneable, Comparable<PersistCommandOptions> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PersistCommandOptionsStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PersistCommandOptionsTupleSchemeFactory();

  private java.util.List<PersistFile> persistFiles; // required
  ...
  public PersistCommandOptions(
    java.util.List<PersistFile> persistFiles)
  {
    this();
  ...
  public PersistCommandOptions(PersistCommandOptions other) {
    if (other.isSetPersistFiles()) {
      java.util.List<PersistFile> __this__persistFiles = new java.util.ArrayList<PersistFile>(other.persistFiles.size());
  ...
  public void addToPersistFiles(PersistFile elem) {
    if (this.persistFiles == null) {
      this.persistFiles = new java.util.ArrayList<PersistFile>();
    }
    this.persistFiles.add(elem);
  }

  public java.util.List<PersistFile> getPersistFiles() {
    return this.persistFiles;
  }

  public PersistCommandOptions setPersistFiles(java.util.List<PersistFile> persistFiles) {
    this.persistFiles = persistFiles;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PERSIST_FILES:
      if (value == null) {
        ...
        setPersistFiles((java.util.List<PersistFile>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPersistFiles()) ? 131071 : 524287);
    if (isSetPersistFiles())
      hashCode = hashCode * 8191 + persistFiles.hashCode();
  ...
  public int compareTo(PersistCommandOptions other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPersistFiles()).compareTo(other.isSetPersistFiles());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PersistCommandOptions(");
    boolean first = true;
  ...
  private static class PersistCommandOptionsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PersistCommandOptionsStandardScheme getScheme() {
      return new PersistCommandOptionsStandardScheme();
    }
  }

  private static class PersistCommandOptionsStandardScheme extends org.apache.thrift.scheme.StandardScheme<PersistCommandOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.persistFiles = new java.util.ArrayList<PersistFile>(_list58.size);
                PersistFile _elem59;
  ...
  private static class PersistCommandOptionsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public PersistCommandOptionsTupleScheme getScheme() {
      return new PersistCommandOptionsTupleScheme();
    }
  }

  private static class PersistCommandOptionsTupleScheme extends org.apache.thrift.scheme.TupleScheme<PersistCommandOptions> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.persistFiles = new java.util.ArrayList<PersistFile>(_list63.size);
          PersistFile _elem64;
