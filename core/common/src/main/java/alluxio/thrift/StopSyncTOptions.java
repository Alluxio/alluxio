...
public class StopSyncTOptions implements org.apache.thrift.TBase<StopSyncTOptions, StopSyncTOptions._Fields>, java.io.Serializable, Cloneable, Comparable<StopSyncTOptions> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StopSyncTOptions");
  ...
  static {
    schemes.put(StandardScheme.class, new StopSyncTOptionsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StopSyncTOptionsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StopSyncTOptions.class, metaDataMap);
  }

  public StopSyncTOptions() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public StopSyncTOptions(StopSyncTOptions other) {
    if (other.isSetCommonOptions()) {
      this.commonOptions = new FileSystemMasterCommonTOptions(other.commonOptions);
    }
  }

  public StopSyncTOptions deepCopy() {
    return new StopSyncTOptions(this);
  }
  ...
  public StopSyncTOptions setCommonOptions(FileSystemMasterCommonTOptions commonOptions) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StopSyncTOptions)
      return this.equals((StopSyncTOptions)that);
    return false;
  }

  public boolean equals(StopSyncTOptions that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StopSyncTOptions other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StopSyncTOptions(");
    boolean first = true;
  ...
  private static class StopSyncTOptionsStandardSchemeFactory implements SchemeFactory {
    public StopSyncTOptionsStandardScheme getScheme() {
      return new StopSyncTOptionsStandardScheme();
    }
  }

  private static class StopSyncTOptionsStandardScheme extends StandardScheme<StopSyncTOptions> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StopSyncTOptions struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StopSyncTOptions struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class StopSyncTOptionsTupleSchemeFactory implements SchemeFactory {
    public StopSyncTOptionsTupleScheme getScheme() {
      return new StopSyncTOptionsTupleScheme();
    }
  }

  private static class StopSyncTOptionsTupleScheme extends TupleScheme<StopSyncTOptions> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StopSyncTOptions struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StopSyncTOptions struct) throws org.apache.thrift.TException {
