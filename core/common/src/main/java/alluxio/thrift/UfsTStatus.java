...
public class UfsTStatus implements org.apache.thrift.TBase<UfsTStatus, UfsTStatus._Fields>, java.io.Serializable, Cloneable, Comparable<UfsTStatus> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UfsTStatus");

  private static final org.apache.thrift.protocol.TField NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("name", org.apache.thrift.protocol.TType.STRING, (short)1);
  private static final org.apache.thrift.protocol.TField IS_DIRECTORY_FIELD_DESC = new org.apache.thrift.protocol.TField("isDirectory", org.apache.thrift.protocol.TType.BOOL, (short)2);
  ...
  static {
    schemes.put(StandardScheme.class, new UfsTStatusStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UfsTStatusTupleSchemeFactory());
  }

  private String name; // optional
  private boolean isDirectory; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    NAME((short)1, "name"),
    IS_DIRECTORY((short)2, "isDirectory"),
    OWNER((short)3, "owner"),
    GROUP((short)4, "group"),
    MODE((short)5, "mode");
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.IS_DIRECTORY,_Fields.OWNER,_Fields.GROUP,_Fields.MODE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UfsTStatus.class, metaDataMap);
  }
   ...
   */
  public UfsTStatus(UfsTStatus other) {
  ...
  public UfsTStatus deepCopy() {
    return new UfsTStatus(this);
  }
  ...
  public UfsTStatus setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public UfsTStatus setIsDirectory(boolean isDirectory) {
  ...
  public UfsTStatus setOwner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public UfsTStatus setGroup(String group) {
    this.group = group;
    return this;
  }
  ...
  public UfsTStatus setMode(short mode) {
    this.mode = mode;
    setModeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UfsTStatus)
      return this.equals((UfsTStatus)that);
    return false;
  }

  public boolean equals(UfsTStatus that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(UfsTStatus other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UfsTStatus(");
    boolean first = true;
  ...
  private static class UfsTStatusStandardSchemeFactory implements SchemeFactory {
    public UfsTStatusStandardScheme getScheme() {
      return new UfsTStatusStandardScheme();
    }
  }

  private static class UfsTStatusStandardScheme extends StandardScheme<UfsTStatus> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UfsTStatus struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UfsTStatus struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UfsTStatusTupleSchemeFactory implements SchemeFactory {
    public UfsTStatusTupleScheme getScheme() {
      return new UfsTStatusTupleScheme();
    }
  }

  private static class UfsTStatusTupleScheme extends TupleScheme<UfsTStatus> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UfsTStatus struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UfsTStatus struct) throws org.apache.thrift.TException {
