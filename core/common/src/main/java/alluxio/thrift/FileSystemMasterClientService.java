...
public class FileSystemMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * @param options the method options
     */
    public SyncMetadataTResponse syncMetadata(String path, SyncMetadataTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void syncMetadata(String path, SyncMetadataTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public SyncMetadataTResponse syncMetadata(String path, SyncMetadataTOptions options) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_syncMetadata(path, options);
      return recv_syncMetadata();
    }

    public void send_syncMetadata(String path, SyncMetadataTOptions options) throws org.apache.thrift.TException
    {
      syncMetadata_args args = new syncMetadata_args();
      args.setPath(path);
      args.setOptions(options);
      sendBase("syncMetadata", args);
    }

    public SyncMetadataTResponse recv_syncMetadata() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      syncMetadata_result result = new syncMetadata_result();
      receiveBase(result, "syncMetadata");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "syncMetadata failed: unknown result");
    }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void syncMetadata(String path, SyncMetadataTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      syncMetadata_call method_call = new syncMetadata_call(path, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class syncMetadata_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String path;
      private SyncMetadataTOptions options;
      public syncMetadata_call(String path, SyncMetadataTOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
        this.options = options;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("syncMetadata", org.apache.thrift.protocol.TMessageType.CALL, 0));
        syncMetadata_args args = new syncMetadata_args();
        args.setPath(path);
        args.setOptions(options);
        args.write(prot);
      ...
      public SyncMetadataTResponse getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_syncMetadata();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("syncMetadata", new syncMetadata());
    ...
    public static class syncMetadata<I extends Iface> extends org.apache.thrift.ProcessFunction<I, syncMetadata_args> {
      public syncMetadata() {
        super("syncMetadata");
      }

      public syncMetadata_args getEmptyArgsInstance() {
        return new syncMetadata_args();
      }
      ...
      public syncMetadata_result getResult(I iface, syncMetadata_args args) throws org.apache.thrift.TException {
        syncMetadata_result result = new syncMetadata_result();
        try {
          result.success = iface.syncMetadata(args.path, args.options);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class syncMetadata<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, syncMetadata_args, SyncMetadataTResponse> {
      public syncMetadata() {
        super("syncMetadata");
      }
      ...
      public AsyncMethodCallback<SyncMetadataTResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<SyncMetadataTResponse>() { 
          public void onComplete(SyncMetadataTResponse o) {
            syncMetadata_result result = new syncMetadata_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, syncMetadata_args args, org.apache.thrift.async.AsyncMethodCallback<SyncMetadataTResponse> resultHandler) throws TException {
        iface.syncMetadata(args.path, args.options,resultHandler);
      }
    }
...
;
  ...
  public static class syncMetadata_args implements org.apache.thrift.TBase<syncMetadata_args, syncMetadata_args._Fields>, java.io.Serializable, Cloneable, Comparable<syncMetadata_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("syncMetadata_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new syncMetadata_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new syncMetadata_argsTupleSchemeFactory());
    }

    private String path; // required
    private SyncMetadataTOptions options; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      /**
       * the root of the subtree to sync
       */
      PATH((short)1, "path"),
      /**
       * the method options
    ...
    static {
      ...
      tmpMap.put(_Fields.PATH, new org.apache.thrift.meta_data.FieldMetaData("path", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      tmpMap.put(_Fields.OPTIONS, new org.apache.thrift.meta_data.FieldMetaData("options", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SyncMetadataTOptions.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(syncMetadata_args.class, metaDataMap);
    }

    public syncMetadata_args() {
    }

    public syncMetadata_args(
      String path,
      SyncMetadataTOptions options)
    {
      this();
      this.path = path;
      this.options = options;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public syncMetadata_args(syncMetadata_args other) {
      if (other.isSetPath()) {
        this.path = other.path;
      }
      if (other.isSetOptions()) {
        this.options = new SyncMetadataTOptions(other.options);
      }
    }

    public syncMetadata_args deepCopy() {
      return new syncMetadata_args(this);
    }
     ...
     * the root of the subtree to sync
     */
    public syncMetadata_args setPath(String path) {
      this.path = path;
      return this;
    }
     ...
     * the method options
     */
    public SyncMetadataTOptions getOptions() {
      return this.options;
    }
     ...
     * the method options
     */
    public syncMetadata_args setOptions(SyncMetadataTOptions options) {
      this.options = options;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OPTIONS:
        if (value == null) {
          ...
          setOptions((SyncMetadataTOptions)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof syncMetadata_args)
        return this.equals((syncMetadata_args)that);
      return false;
    }

    public boolean equals(syncMetadata_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(syncMetadata_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("syncMetadata_args(");
      boolean first = true;
    ...
    private static class syncMetadata_argsStandardSchemeFactory implements SchemeFactory {
      public syncMetadata_argsStandardScheme getScheme() {
        return new syncMetadata_argsStandardScheme();
      }
    }

    private static class syncMetadata_argsStandardScheme extends StandardScheme<syncMetadata_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, syncMetadata_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new SyncMetadataTOptions();
                struct.options.read(iprot);
                struct.setOptionsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, syncMetadata_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class syncMetadata_argsTupleSchemeFactory implements SchemeFactory {
      public syncMetadata_argsTupleScheme getScheme() {
        return new syncMetadata_argsTupleScheme();
      }
    }

    private static class syncMetadata_argsTupleScheme extends TupleScheme<syncMetadata_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, syncMetadata_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetPath()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, syncMetadata_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.path = iprot.readString();
  ...
  public static class syncMetadata_result implements org.apache.thrift.TBase<syncMetadata_result, syncMetadata_result._Fields>, java.io.Serializable, Cloneable, Comparable<syncMetadata_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("syncMetadata_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new syncMetadata_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new syncMetadata_resultTupleSchemeFactory());
    }

    private SyncMetadataTResponse success; // required
    private alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SyncMetadataTResponse.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(syncMetadata_result.class, metaDataMap);
    }

    public syncMetadata_result() {
    }

    public syncMetadata_result(
      SyncMetadataTResponse success,
      alluxio.thrift.AlluxioTException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public syncMetadata_result(syncMetadata_result other) {
      if (other.isSetSuccess()) {
        this.success = new SyncMetadataTResponse(other.success);
      }
      if (other.isSetE()) {
        this.e = new alluxio.thrift.AlluxioTException(other.e);
      }
    ...
    public syncMetadata_result deepCopy() {
      return new syncMetadata_result(this);
    }
    ...
    public SyncMetadataTResponse getSuccess() {
      return this.success;
    }

    public syncMetadata_result setSuccess(SyncMetadataTResponse success) {
      this.success = success;
      return this;
    }
    ...
    public syncMetadata_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((SyncMetadataTResponse)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof syncMetadata_result)
        return this.equals((syncMetadata_result)that);
      return false;
    }

    public boolean equals(syncMetadata_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(syncMetadata_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("syncMetadata_result(");
      boolean first = true;
    ...
    private static class syncMetadata_resultStandardSchemeFactory implements SchemeFactory {
      public syncMetadata_resultStandardScheme getScheme() {
        return new syncMetadata_resultStandardScheme();
      }
    }

    private static class syncMetadata_resultStandardScheme extends StandardScheme<syncMetadata_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, syncMetadata_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new SyncMetadataTResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, syncMetadata_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class syncMetadata_resultTupleSchemeFactory implements SchemeFactory {
      public syncMetadata_resultTupleScheme getScheme() {
        return new syncMetadata_resultTupleScheme();
      }
    }

    private static class syncMetadata_resultTupleScheme extends TupleScheme<syncMetadata_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, syncMetadata_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, syncMetadata_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new SyncMetadataTResponse();
