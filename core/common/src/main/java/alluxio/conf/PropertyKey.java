...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  //
  // Mount table journal related properties
  //
  public static final PropertyKey MASTER_MOUNT_TABLE_JOURNAL_ALLUXIO =
      new Builder(Template.MASTER_MOUNT_TABLE_ALLUXIO, "journal")
          .setDefaultValue("/.journal")
          .setDescription("Alluxio journal mount point.")
          .setConsistencyCheckLevel(ConsistencyCheckLevel.ENFORCE)
          .setScope(Scope.MASTER)
          .build();
