...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final class Builder {
    ...
    private final Optional<Class<?>> mClassType;
    ...
    public static Builder enumBuilder(String name, Class<? extends Enum> enumType) {
      return new Builder(name, PropertyType.ENUM, enumType);
    }
    ...
    private Builder(String name, PropertyType type) {
      mName = name;
      mType = type;
      mClassType = Optional.empty();
    }

    private Builder(String name, PropertyType type, Class<?> classType) {
      mName = name;
      mType = type;
      mClassType = Optional.of(classType);
    }
    ...
    public Builder setDefaultValue(Object defaultValue) {
      checkArgument(validateValue(defaultValue, mType, mClassType, mValueValidationFunction));
      mDefaultValue = formatValue(defaultValue, mType, mClassType);
      return this;
    }
    ...
    public PropertyKey buildUnregistered() {
      ...
      return new PropertyKey(mName, mDescription, mType, mClassType, defaultSupplier, mAlias,
  ...
  public static final PropertyKey WORKER_TIERED_STORE_LEVEL0_DIRS_QUOTA =
      new Builder(PropertyType.DATASIZE, Template.WORKER_TIERED_STORE_LEVEL_DIRS_QUOTA, 0)
  ...
  public static final PropertyKey WORKER_TIERED_STORE_LEVEL1_DIRS_QUOTA =
      new Builder(PropertyType.DATASIZE, Template.WORKER_TIERED_STORE_LEVEL_DIRS_QUOTA, 1)
          .setDescription(format(
  ...
  public static final PropertyKey WORKER_TIERED_STORE_LEVEL2_DIRS_QUOTA =
      new Builder(PropertyType.DATASIZE, Template.WORKER_TIERED_STORE_LEVEL_DIRS_QUOTA, 2)
          .setDescription(format(
  ...
  public static final PropertyKey FUSE_PERMISSION_CHECK_ENABLED =
      booleanBuilder(Name.FUSE_PERMISSION_CHECK_ENABLED)
          .setDefaultValue(true)
  ...
  public enum Template {
    ...
    Template(String format, String re, Class<? extends Enum> enumType) {
      ...
      mClassType = Optional.of(enumType);
    }
    ...
    public PropertyKey format(Object... params) {
      return new PropertyKey(String.format(mFormat, params), mType, mClassType);
    }
  ...
  private PropertyKey(String name, String description, PropertyType type,
      Optional<Class<?>> classType, DefaultSupplier defaultSupplier, String[] aliases,
   ...
   * @param name String of this property
   */
  private PropertyKey(String name, PropertyType type, Optional<Class<?>> classType) {
    this(name, null, type, classType, new DefaultSupplier(() -> null, "null"), null, false,
  ...
  {
    checkState(mType == PropertyType.ENUM && mClassType.isPresent(),
        format("PropertyKey %s is not of enum type", mName));
    return mClassType.get().asSubclass(Enum.class);
  }
  ...
  public boolean validateValue(Object value) {
    return validateValue(value, mType, mClassType, mValueValidationFunction);
  }

  private static boolean validateValue(
      Object value, PropertyType type, Optional<Class<?>> classType,
      Function<Object, Boolean> valueValidationFunction) {
    ...
    if (!(value instanceof String) && type == PropertyType.ENUM
        && (!value.getClass().equals(classType.get()))) {
      return false;
    }
  ...
  public Object formatValue(Object value) {
    return formatValue(value, mType, mClassType);
  }

  private static Object formatValue(Object value, PropertyType type,
      Optional<Class<?>> classType) {
      ...
      try {
        switch (type) {
          case ENUM:
            ...
            value = Enum.valueOf(classType.get().asSubclass(Enum.class),
          ...
          case DURATION:
            ...
            break;
          case DATASIZE:
            value = FormatUtils.parseSpaceSize((String) value);
            break;
          default:
            break;
        }
