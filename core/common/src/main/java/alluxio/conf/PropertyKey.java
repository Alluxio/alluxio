...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final class Builder {
    ...
    public Builder setDefaultValue(Object defaultValue) {
      checkArgument(defaultValue.getClass().equals(mType.getJavaType())
          || (mType == PropertyType.ENUM && defaultValue.getClass().equals(mClassType.get()))
          || defaultValue.getClass().equals(String.class)
          || (mType == PropertyType.STRING
          && !defaultValue.getClass().equals(Boolean.class)));
  ...
  public boolean validateValue(Object value) {
    ...
    if (!(value instanceof String) && mType == PropertyType.ENUM
        && (!value.getClass().equals(mClassType.get()))) {
      return false;
    }
