...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final class Name {
    ...
    public static final String UNDERFS_OBJECT_STORE_RETRY_BASE_SLEEP_MS =
        "alluxio.underfs.object.store.retry.base.sleep";
    public static final String UNDERFS_OBJECT_STORE_RETRY_MAX_NUM =
        "alluxio.underfs.object.store.retry.max.num";
    public static final String UNDERFS_OBJECT_STORE_RETRY_MAX_SLEEP_MS =
        "alluxio.underfs.object.store.s3a.retry.max.sleep";
