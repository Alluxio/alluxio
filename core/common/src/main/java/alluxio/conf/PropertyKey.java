...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final PropertyKey USER_FILE_WRITE_INIT_MAX_DURATION =
      durationBuilder(Name.USER_FILE_WRITE_INIT_MAX_DURATION)
          ...
          .setScope(Scope.CLIENT)
          .build();
  public static final PropertyKey USER_HDFS_CLIENT_EXCLUDE_MOUNT_INFO =
      booleanBuilder(Name.USER_HDFS_CLIENT_EXCLUDE_MOUNT_INFO)
          .setDefaultValue(false)
          .setDescription("If enabled, the mount info will be excluded from the response "
              + "when a HDFS client calls alluxio.")
          .setConsistencyCheckLevel(ConsistencyCheckLevel.IGNORE)
          .setScope(Scope.CLIENT)
          .build();
  ...
  public static final class Name {
    ...
    public static final String USER_HDFS_CLIENT_EXCLUDE_MOUNT_INFO =
        "alluxio.user.hdfs.client.exclude.mount.info";
