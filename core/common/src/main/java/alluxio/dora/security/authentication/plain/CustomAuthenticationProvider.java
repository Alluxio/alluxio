 ...
 * specified in {@link AlluxioConfiguration} is {@link AuthType#CUSTOM}. It requires
 * the property {@code alluxio.dora.security.authentication.custom.provider} to be set in
 * {@link AlluxioConfiguration} to determine which provider to load.
 */
@NotThreadSafe
