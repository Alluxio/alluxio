...
package alluxio.dora.dora.network.netty;
...
import alluxio.dora.dora.network.protocol.RPCMessageDecoder;
import alluxio.dora.dora.network.protocol.RPCMessageEncoder;
import alluxio.dora.dora.util.network.NettyUtils;
import alluxio.dora.dora.network.ChannelType;
...
public final class NettyClient {
  ...
  public static Bootstrap createClientBootstrap(SocketAddress address) {
    ...
    boot.group(WORKER_GROUP).channel(NettyUtils
        .getClientChannelClass(!(address instanceof InetSocketAddress)));
