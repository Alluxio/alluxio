...
package alluxio.dora.dora.underfs;

import alluxio.dora.dora.AlluxioURI;
import alluxio.dora.dora.SyncInfo;
import alluxio.dora.dora.annotation.PublicApi;
...
import alluxio.dora.dora.recorder.Recorder;
...
public interface UnderFileSystem extends Closeable {
   ...
   * {@link Constants#INVALID_UFS_FINGERPRINT} if there is any error.
   *
   * @deprecated
