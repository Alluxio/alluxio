...
service FileSystemWorkerClientService extends common.AlluxioService {
   ...
   */
  void ufsCancelFile( /** the path of the file in the ufs */ 1: string path,
   ...
   */
  void ufsCompleteFile( /** the path of the file in the ufs */ 1: string path,
   ...
   */
  void ufsCreateFile( /** the path of the file in the ufs */ 1: string path,
