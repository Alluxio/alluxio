 ...
 *
 * 1. Sleep more than the interval of SleepingTimer and see if the SleepingTimer warns correctly 2.
 * Tick continuously for several time and see if the time interval is correct 3. Sleep less than the
 * interval of SleepingTimer and see if the time interval is correct
 */
