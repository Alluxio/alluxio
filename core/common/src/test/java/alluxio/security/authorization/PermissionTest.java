...
public final class PermissionTest {
  ...
  /**
   * Tests the {@link Permission#getOwnerBits(short)} method.
   */
  @Test
  public void getOwnerBitsTest() throws Exception {
    final short[] inputs = new short[] {
        0700,
        0505,
        0640,
        0000,
    };
    final short[] results = new short[] {
        0007,
        0005,
        0006,
        0000,
    ...
    for (int i = 0; i < inputs.length; i++) {
      Assert.assertEquals(results[i], Permission.getOwnerBits(inputs[i]));
    }
  }

  /**
   * Tests the {@link Permission#setOthersBit(short, short)} method.
   */
  @Test
  public void setOthersBitTest() throws Exception {
    final short[] inputs = new short[] {
        0700,
        0505,
        0505,
    ...
    for (int i = 0; i < inputs.length; i++) {
      Assert.assertEquals(results[i], Permission.setOthersBit(inputs[i], others[i]));
    }
  }
}
