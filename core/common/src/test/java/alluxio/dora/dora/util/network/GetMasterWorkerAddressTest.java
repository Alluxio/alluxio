...
public class GetMasterWorkerAddressTest {
  ...
  /**
   * Tests the
   * {@link NetworkAddressUtils#getConnectAddress(NetworkAddressUtils.ServiceType, AlluxioConfiguration)}
  ...
  public void getMasterAddress() {
    ...
    InetSocketAddress masterAddress =
        NetworkAddressUtils.getConnectAddress(NetworkAddressUtils.ServiceType.MASTER_RPC, conf);
    ...
    masterAddress = NetworkAddressUtils.getConnectAddress(NetworkAddressUtils.ServiceType.MASTER_RPC, conf);
