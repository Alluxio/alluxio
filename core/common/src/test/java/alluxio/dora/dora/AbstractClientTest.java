...
import alluxio.dora.dora.security.user.BaseUserState;
...
public final class AbstractClientTest {
  ...
  public void connectFailToDetermineMasterAddress() throws Exception {
    Client client = new BaseTestClient() {
      @Override
  ...
  public void unsupportedVersion() throws Exception {
    ...
    mExpectedException.expectMessage(ExceptionMessage.INCOMPATIBLE_VERSION.getMessage(SERVICE_NAME, 0, 1));
  ...
  public void confAddress() throws Exception {
    ...
    final Client client = new BaseTestClient(context) {
      @Override
