...
public class AlluxioPropertiesTest {
  ...
  @Before
  public void before() {
    mKeyWithValue = PropertyKey.Builder.stringBuilder("key.with.value").setDefaultValue("value").build();
    mKeyWithoutValue = PropertyKey.Builder.stringBuilder("key.without.value").build();
  }
  ...
  public void keySet() {
    ...
    PropertyKey newKey = PropertyKey.Builder.stringBuilder("keySetNew").build();
  ...
  public void forEach() {
    ...
    PropertyKey newKey = PropertyKey.Builder.stringBuilder("forEachNew").build();
    mProperties.put(newKey, "value", Source.RUNTIME);
  ...
  @Test
  public void merge() {
    PropertyKey newKey = PropertyKey.Builder.stringBuilder("mergeNew").setDefaultValue("value3").build();
