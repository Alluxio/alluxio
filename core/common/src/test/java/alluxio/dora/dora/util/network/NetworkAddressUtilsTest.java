...
package alluxio.dora.dora.util.network;
...
public class NetworkAddressUtilsTest {
  ...
  /**
   * Tests the
   * {@link NetworkAddressUtils#getConnectAddress(NetworkAddressUtils.ServiceAttributeProvider,
  ...
  public void testGetConnectAddress() throws Exception {
    for (NetworkAddressUtils.ServiceType service : NetworkAddressUtils.ServiceType.values()) {
      if (service == NetworkAddressUtils.ServiceType.JOB_MASTER_RAFT || service == NetworkAddressUtils.ServiceType.MASTER_RAFT) {
  ...
  private void getConnectAddress(NetworkAddressUtils.ServiceType service) throws Exception {
   ...
   /**
    * Tests the
    * {@link NetworkAddressUtils#getBindAddress(NetworkAddressUtils.ServiceAttributeProvider,
  *                                             AlluxioConfiguration)}
    * method.
   */
  @Test
  ...
  /**
   * Tests the {@link NetworkAddressUtils#getBindAddress(NetworkAddressUtils.ServiceAttributeProvider,
   * AlluxioConfiguration)} method for specific service under different conditions.
   *
   * @param service the service name used to connect
   */
