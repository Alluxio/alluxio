...
package alluxio.dora.dora.conf;
...
import alluxio.dora.dora.DefaultSupplier;
...
public final class PropertyKeyTest {
  ...
  private PropertyKey mTestProperty = PropertyKey.Builder.booleanBuilder("alluxio.test.property")
  ...
  public void defaultSupplier() throws Exception {
    ...
    PropertyKey key = PropertyKey.Builder.intBuilder("test")
  ...
  public void localityTemplates() throws Exception {
    ...
    assertEquals("alluxio.locality.custom", PropertyKey.Template.LOCALITY_TIER.format("custom").toString());
  }
  ...
  public void testKeyIsDeprecatedOrRemoved() throws Exception {
    ...
    assertTrue(PropertyKey.isDeprecated(PropertyKey.Template.TEST_DEPRECATED_TEMPLATE.format("removed")));
  ...
  public void testValueValidation() {
    ...
    PropertyKey.Builder.booleanBuilder("test_boolean_property")
        .setDefaultValue(true)
        .setValueValidationFunction(booleanValidationFunction)
        .build();
    assertThrows(IllegalStateException.class, () -> PropertyKey.Builder.intBuilder("test_boolean_property")
        .setDefaultValue(100)
        .setValueValidationFunction(booleanValidationFunction)
        .build());
  }
