...
import alluxio.dora.dora.master.MasterInquireClient.ConnectDetails;
import alluxio.dora.dora.master.SingleMasterInquireClient.SingleMasterConnectDetails;
import alluxio.dora.dora.master.ZkMasterInquireClient.ZkMasterConnectDetails;
...
public final class MasterInquireClientTest {
  ...
  public void defaultConnectString() {
    ConnectDetails cs = new SingleMasterConnectDetails(
        NetworkAddressUtils.getConnectAddress(NetworkAddressUtils.ServiceType.MASTER_RPC, mConfiguration));
    assertCurrentConnectString(cs);
    assertEquals(NetworkAddressUtils.getConnectHost(NetworkAddressUtils.ServiceType.MASTER_RPC, mConfiguration) + ":"
        + NetworkAddressUtils.getPort(NetworkAddressUtils.ServiceType.MASTER_RPC, mConfiguration), cs.toString());
  }
