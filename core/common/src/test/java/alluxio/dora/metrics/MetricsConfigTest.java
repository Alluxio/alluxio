...
public final class MetricsConfigTest {
  ...
  public final void before() {
    ...
    mMetricsProps.setProperty("sink.console.class", "alluxio.dora.metrics.sink.ConsoleSink");
    mMetricsProps.setProperty("sink.console.period", "15");
    mMetricsProps.setProperty("*.sink.console.unit", "minutes");
    mMetricsProps.setProperty("sink.jmx.class", "alluxio.dora.metrics.sink.JmxSink");
  }
  ...
  public void setProperties() {
    ...
    assertEquals("alluxio.dora.metrics.sink.ConsoleSink",
    ...
    assertEquals("alluxio.dora.metrics.sink.JmxSink", masterProp.getProperty("sink.jmx.class"));
  }
  ...
  public void subProperties() {
    ...
    assertEquals("alluxio.dora.metrics.sink.ConsoleSink", consoleProp.getProperty("class"));

    Properties jmxProp = sinkProps.get("jmx");
    assertEquals(1, jmxProp.size());
    assertEquals("alluxio.dora.metrics.sink.JmxSink", jmxProp.getProperty("class"));
  }
}
