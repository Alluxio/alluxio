...
package alluxio.dora.dora.hadoop;
...
import alluxio.dora.dora.SystemPropertyRule;
import alluxio.dora.dora.client.block.BlockStoreClient;
import alluxio.dora.dora.client.block.BlockWorkerInfo;
import alluxio.dora.dora.client.file.FileSystemContext;
import alluxio.dora.dora.client.file.FileSystemMasterClient;
...
public class AbstractFileSystemTest {
  ...
  private InstancedConfiguration mConfiguration = alluxio.dora.dora.conf.Configuration.copyGlobal();
  ...
  @After
  public void after() {
    mConfiguration = alluxio.dora.dora.conf.Configuration.copyGlobal();
  ...
  public void fsShouldSetPropertyConfWithLogicalUriConfig() throws Exception {
    ...
    conf.set(
        ...
        "host3:19998");
    AbstractFileSystem afs = new FileSystem();
  ...
  public void listStatus() throws Exception {
    ...
    alluxio.dora.dora.client.file.FileSystem alluxioFs =
        mock(alluxio.dora.dora.client.file.FileSystem.class);
  ...
  public void throwFileNotFoundExceptionWhenListStatusNonExistingTest() throws Exception {
    ...
    try {
      ...
      alluxio.dora.dora.client.file.FileSystem alluxioFs = mock(alluxio.dora.dora.client.file.FileSystem.class);
      when(alluxioFs.listStatus(new AlluxioURI(HadoopUtils.getPathWithoutScheme(path))))
  ...
  public void initializeWithZookeeperSystemProperties() throws Exception {
    ...
    try (Closeable p = new SystemPropertyRule(sysProps).toResource()) {
      alluxio.dora.dora.conf.Configuration.reloadProperties();
  ...
  void verifyBlockLocations(List<WorkerNetAddress> blockWorkers, List<String> ufsLocations,
    ...
    FileBlockInfo blockInfo = new FileBlockInfo().setBlockInfo(
        new BlockInfo().setLocations(blockWorkers.stream().map(
            addr -> new alluxio.dora.dora.wire.BlockLocation().setWorkerAddress(addr)).collect(
    ...
    alluxio.dora.dora.client.file.FileSystem fs = alluxio.dora.dora.client.file.FileSystem.Factory.create(fsContext);
    alluxio.dora.dora.client.file.FileSystem spyFs = spy(fs);
