...
public class AbstractFileSystemTest {
  ...
  public void listStatus() throws Exception {
    ...
    alluxio.dora.client.file.FileSystem alluxioFs =
        mock(alluxio.dora.client.file.FileSystem.class);
  ...
  public void throwFileNotFoundExceptionWhenListStatusNonExistingTest() throws Exception {
    ...
    try {
      ...
      alluxio.dora.client.file.FileSystem alluxioFs = mock(alluxio.dora.client.file.FileSystem.class);
      when(alluxioFs.listStatus(new AlluxioURI(HadoopUtils.getPathWithoutScheme(path))))
  ...
  void verifyBlockLocations(List<WorkerNetAddress> blockWorkers, List<String> ufsLocations,
    ...
    alluxio.dora.client.file.FileSystem fs = alluxio.dora.client.file.FileSystem.Factory.create(fsContext);
    alluxio.dora.client.file.FileSystem spyFs = spy(fs);
