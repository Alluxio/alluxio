...
import alluxio.dora.dora.conf.AlluxioProperties;
...
import alluxio.dora.dora.master.MasterInquireClient.Factory;
import alluxio.dora.dora.security.CurrentUser;
 ...
 * really just delegates to {@link alluxio.dora.dora.client.file.FileSystem} for most operations.
 *
...
public abstract class AbstractFileSystem extends org.apache.hadoop.fs.FileSystem {
  ...
  protected alluxio.dora.dora.client.file.FileSystem mFileSystem = null;
  ...
  /**
   * Constructs a new {@link AbstractFileSystem} instance with specified a {@link alluxio.dora.dora.client.file.FileSystem}
   * handler for tests.
   *
   * @param fileSystem handler to file system
   */
  protected AbstractFileSystem(alluxio.dora.dora.client.file.FileSystem fileSystem) {
  ...
  /**
   * Initialize the {@link alluxio.dora.dora.hadoop.FileSystem}.
  ...
  public synchronized void initialize(URI uri, org.apache.hadoop.conf.Configuration conf,
    ...
    AlluxioProperties alluxioProps =
        (alluxioConfiguration != null) ? alluxioConfiguration.copyProperties()
            : alluxio.dora.dora.conf.Configuration.copyProperties();
