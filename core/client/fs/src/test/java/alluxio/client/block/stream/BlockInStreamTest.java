...
public class BlockInStreamTest {
  ...
  public void closeReaderAfterReadingAllData() throws Exception {
    ...
    BlockInStream stream = new BlockInStream(factory,
        WorkerNetAddress.newBuilder("host", 1).build(),
  ...
  public void createShortCircuit() throws Exception {
    WorkerNetAddress dataSource = WorkerNetAddress.newBuilder("host", 1).build();
  ...
  public void createDomainSocketEnabled() throws Exception {
    ...
    PowerMockito.when(
        ...
        .thenReturn(true);
    WorkerNetAddress dataSource = WorkerNetAddress.newBuilder("host", 1)
        .setDomainSocketPath("/domain/socket/path").build();
    BlockInStream.BlockInStreamSource dataSourceType = BlockInStream.BlockInStreamSource.NODE_LOCAL;
