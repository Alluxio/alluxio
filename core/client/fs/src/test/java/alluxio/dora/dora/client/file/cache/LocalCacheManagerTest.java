...
package alluxio.dora.dora.client.file.cache;
...
import alluxio.dora.dora.client.file.CacheContext;
import alluxio.dora.dora.client.file.cache.evictor.CacheEvictor;
import alluxio.dora.dora.client.file.cache.evictor.FIFOCacheEvictor;
import alluxio.dora.dora.client.file.cache.evictor.LRUCacheEvictor;
import alluxio.dora.dora.client.file.cache.evictor.UnevictableCacheEvictor;
import alluxio.dora.dora.client.file.cache.store.LocalPageStore;
import alluxio.dora.dora.client.file.cache.store.LocalPageStoreDir;
import alluxio.dora.dora.client.file.cache.store.PageStoreDir;
import alluxio.dora.dora.client.file.cache.store.PageStoreOptions;
import alluxio.dora.dora.client.file.cache.store.PageStoreType;
import alluxio.dora.dora.client.quota.CacheQuota;
import alluxio.dora.dora.client.quota.CacheScope;
...
import alluxio.dora.dora.exception.PageNotFoundException;
import alluxio.dora.dora.exception.status.ResourceExhaustedException;
