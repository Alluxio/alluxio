...
public class QuotaPageMetaStoreTest extends DefaultMetaStoreTest {
  ...
  public void scopeCacheUsage() {
    ...
    Optional<CacheUsage> partitionUsage = mQuotaMetaStore.getUsage()
        .flatMap(usage -> usage.partitionedBy(CacheUsage.PartitionDescriptor.scope(mPartitionScope)));
    ...
    Optional<CacheUsage> schemaUsage = mQuotaMetaStore.getUsage()
        .flatMap(usage -> usage.partitionedBy(CacheUsage.PartitionDescriptor.scope(mSchemaScope)));
