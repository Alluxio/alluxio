...
import alluxio.dora.client.block.stream.DataWriter;
...
public final class BlockStoreClient {
  ...
  public BlockInStream getInStream(BlockInfo info, InStreamOptions options,
      Map<WorkerNetAddress, Long> failedWorkers) throws IOException {
    Pair<WorkerNetAddress, BlockInStream.BlockInStreamSource> dataSourceAndType = getDataSourceAndType(info,
   ...
   */
  public Pair<WorkerNetAddress, BlockInStream.BlockInStreamSource> getDataSourceAndType(BlockInfo info,
