...
package alluxio.dora.dora.client.file;
...
import alluxio.dora.dora.client.block.BlockMasterClientPool;
import alluxio.dora.dora.client.block.BlockWorkerInfo;
import alluxio.dora.dora.client.block.policy.BlockLocationPolicy;
import alluxio.dora.dora.client.block.stream.BlockWorkerClient;
import alluxio.dora.dora.client.block.stream.BlockWorkerClientPool;
import alluxio.dora.dora.client.metrics.MetricsHeartbeatContext;
...
import alluxio.dora.dora.conf.ReconfigurableRegistry;
import alluxio.dora.dora.conf.path.SpecificPathConfiguration;
...
import alluxio.dora.dora.master.MasterInquireClient;
import alluxio.dora.dora.metrics.MetricsSystem;
import alluxio.dora.dora.network.netty.NettyChannelPool;
import alluxio.dora.dora.network.netty.NettyClient;
import alluxio.dora.dora.refresh.RefreshPolicy;
import alluxio.dora.dora.refresh.TimeoutRefresh;
import alluxio.dora.dora.resource.CloseableResource;
import alluxio.dora.dora.resource.DynamicResourcePool;
import alluxio.dora.dora.security.authentication.AuthenticationUtils;
import alluxio.dora.dora.security.user.UserState;
...
import alluxio.dora.dora.worker.block.BlockWorker;
...
public class FileSystemContext implements Closeable {
  ...
  /**
   * @param clientContext the {@link ClientContext} containing the subject and configuration
   * @return the {@link FileSystemContext}
   */
  ...
  public CloseableResource<FileSystemMasterClient> acquireMasterClientResource() {
    try (FileSystemContextReinitializer.ReinitBlockerResource r = blockReinit()) {
