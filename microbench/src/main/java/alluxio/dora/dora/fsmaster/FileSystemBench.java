...
import alluxio.dora.dora.hadoop.AbstractFileSystem;
...
public class FileSystemBench {
  ...
  public static class AlluxioBenchThreadState extends ThreadState {
    alluxio.dora.dora.client.file.FileSystem mFs;

    @Setup(Level.Trial)
    public void setup() {
      mFs = alluxio.dora.dora.client.file.FileSystem.Factory.create(Configuration.global());
    }
  ...
  public static class HadoopBenchThreadState extends ThreadState {
    ...
    @Setup(Level.Trial)
    public void setup() {
      alluxio.dora.dora.client.file.FileSystem system =
          alluxio.dora.dora.client.file.FileSystem.Factory.create(Configuration.global());
      mFs = new alluxio.dora.dora.hadoop.FileSystem(system);
    }
