...
## `Class alluxio.hadoop.FileSystem not found` Issues with SparkSQL
...
However, sometimes SparkSQL fail to save tables to Hive metastore when the table locations in in Alluxio with an error
