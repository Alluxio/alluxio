...
you should use as many executors as possible, hopefully at least one executor per node. As always, there should be an Alluxio worker on all computation nodes.
