...
An S3 location can be either mounted at
the root of the Alluxio namespace or at a nested directory.
...
`conf/alluxio-site.properties`. Specify an **existing** S3
...
Specify the AWS credentials for S3 access.
...
be found at the console `https://console.aws.amazon.com/iam/home?#/security_credential`.
