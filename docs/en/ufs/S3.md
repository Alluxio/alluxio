...
To share the S3 mount point with other users in Alluxio namespace, one can choose either of:
...
restricted to write using Alluxio but also occurs when listing contents of the under storage.
