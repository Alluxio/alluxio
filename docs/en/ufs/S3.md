...
under storage system. Alluxio recognizes the `s3://` scheme and uses the aws-sdk to access S3.
...
Alluxio makes a best effort to inherit permission information including file owner, group and permission mode from S3 ACL information.
The Alluxio master loads and caches the ACL information of object and bucket upon initially requesting for their metadata.
