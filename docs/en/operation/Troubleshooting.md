...
`job_worker.log`, `job_worker.out`, `cross_cluster_master.log`, `cross_csluter_master.out`, and `user/user_${USER}.log`. Files
...
logs/cross_cluster_master.log*, 
logs/cross_cluster_master.out*,  
logs/worker.log*, 
logs/worker.out*, 
logs/job_worker.log*, 
logs/job_worker.out*, 
