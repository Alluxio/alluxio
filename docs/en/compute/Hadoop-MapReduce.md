...
[Using the HDFS API to connect to Alluxio with high availability]({{ '/en/install/Running-Alluxio-On-a-Cluster.html' | relativize_url }}#configure-alluxio-clients-for-ha).
...
See [HA mode client configuration parameters]({{ '/en/install/Running-Alluxio-On-a-Cluster.html' | relativize_url }}#ha-configuration-parameters)
for more details.
