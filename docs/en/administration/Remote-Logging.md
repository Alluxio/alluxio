...
log4j.appender.REMOTE_MASTER_LOGGER.filter.ID=alluxio.dora.AlluxioRemoteLogFilter
...
log4j.appender.CLIENT_REMOTE_LOGGER.filter.ID=alluxio.dora.AlluxioRemoteLogFilter
