...
to reduce the numbers of evictions triggered. This changed starting in Alluxio 2.3.0 which decommissioned [the old watermark-based eviction process](#evictor-emulation).
