...
sharing with file system based applications, and storage system abstraction (for example, using
Ceph instead of S3 as the backing store). For example, a simple application that downloads reports
