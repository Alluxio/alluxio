...
请[创建一个Alluxio JIRA账户](https://alluxio.atlassian.net/admin/users/sign-up)来打开tickets,跟踪tickets以及为tickets提供修复。如果不能通过上述链接建立JIRA账户，请按下述格式发送邮件

至jira-admin@alluxio.org：
