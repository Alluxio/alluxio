...
export const getSagaFetchGenerator = (endpoint: string, successFunction: ActionType<any>, errorFunction: ActionType<any>) => function* (params: any) {
  ...
  try {
    ...
    if (err instanceof Error) {
      ...
      yield put(errorFunction('An unknown fetch error occurred.'));
    }
  }
};
