 ...
 */
public class GDCPartition implements UdbPartition {
  private static final Logger LOG = LoggerFactory.getLogger(GDCPartition.class);
   ...
   */
  public GDCPartition(HiveLayout layout) {
    mLayout = layout;
  }
