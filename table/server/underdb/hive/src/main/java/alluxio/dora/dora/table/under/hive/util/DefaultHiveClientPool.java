...
public final class DefaultHiveClientPool extends AbstractHiveClientPool {
  ...
  public DefaultHiveClientPool(String connectionUri) {
    super(Options.defaultOptions()
        .setMinCapacity(Configuration.getInt(PropertyKey.TABLE_UDB_HIVE_CLIENTPOOL_MIN))
        .setMaxCapacity(Configuration.getInt(PropertyKey.TABLE_UDB_HIVE_CLIENTPOOL_MAX))
