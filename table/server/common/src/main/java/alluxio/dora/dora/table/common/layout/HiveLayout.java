...
package alluxio.dora.dora.table.common.layout;
...
import alluxio.dora.dora.table.common.LayoutFactory;
...
public class HiveLayout implements Layout {
  ...
  private HiveLayout transformLayout(AlluxioURI transformedUri, TransformDefinition definition) {
    ...
    final String compressionKey = PartitionInfo.PARQUET_COMPRESSION;
