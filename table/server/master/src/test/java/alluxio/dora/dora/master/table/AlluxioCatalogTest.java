...
import alluxio.dora.dora.job.plan.transform.PartitionInfo;
...
import alluxio.dora.dora.table.common.transform.action.TransformActionUtils;
import alluxio.dora.dora.table.common.udb.UdbContext;
import alluxio.dora.dora.table.common.udb.UdbTable;
import alluxio.dora.dora.table.common.udb.UnderDatabaseRegistry;
...
public class AlluxioCatalogTest {
  ...
  public void getTransformPlanTransformedLayout() throws Exception {
    ...
    assertEquals(1, plans.size());
    PartitionInfo transformedPartitionInfo =
