...
public class SpecificTierWriteIntegrationTest {
  ...
  public LocalAlluxioClusterResource mLocalAlluxioClusterResource =
      new LocalAlluxioClusterResource.Builder()
          ...
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_ALIAS.format(1), "SSD")
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_ALIAS.format(2), "HDD")
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_DIRS_PATH.format(0),
              Files.createTempDir().getAbsolutePath())
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_DIRS_PATH.format(1),
              Files.createTempDir().getAbsolutePath())
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_DIRS_QUOTA.format(1),
              String.valueOf(CAPACITY_BYTES))
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_DIRS_PATH.format(2),
              Files.createTempDir().getAbsolutePath())
          .setProperty(ParameterizedPropertyKey.WORKER_TIERED_STORE_LEVEL_DIRS_QUOTA.format(2),
