...
package alluxio.dora.dora.stress;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertFalse;
import static org.junit.Assert.assertTrue;

import alluxio.dora.dora.stress.cli.BatchTaskRunner;
import alluxio.dora.dora.stress.common.FileSystemClientType;
import alluxio.dora.dora.stress.master.MasterBenchSummary;
import alluxio.dora.dora.stress.master.MasterBenchTaskResult;
import alluxio.dora.dora.util.JsonSerializable;
...
public class BatchTaskRunnerIntegrationTest extends AbstractStressBenchIntegrationTest {
  ...
  public void MasterIntegrationFileTestAllParameters() throws Exception {
    ...
    for (int i = 0; i < resultList.size(); i++) {
      ...
      Assert.assertEquals(summary.getParameters().mClientType, FileSystemClientType.ALLUXIO_HDFS);
      ...
      for (MasterBenchTaskResult res : results.values()) {
        Assert.assertEquals(res.getBaseParameters().mClusterLimit, 1);
