...
import alluxio.dora.dora.worker.block.BlockHeartbeatReporter;
import alluxio.dora.dora.master.MasterClientContext;
import alluxio.dora.dora.master.PortRegistry;
...
public final class IntegrationTestUtils {
  ...
  public static void reserveMasterPorts() {
    for (NetworkAddressUtils.ServiceType service : Arrays.asList(NetworkAddressUtils.ServiceType.MASTER_RPC, NetworkAddressUtils.ServiceType.MASTER_WEB,
        NetworkAddressUtils.ServiceType.MASTER_RAFT, NetworkAddressUtils.ServiceType.JOB_MASTER_RPC, NetworkAddressUtils.ServiceType.JOB_MASTER_WEB,
        NetworkAddressUtils.ServiceType.JOB_MASTER_RAFT)) {
