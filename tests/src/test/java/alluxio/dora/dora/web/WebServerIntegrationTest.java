...
import alluxio.dora.dora.client.rest.TestCase;
import alluxio.dora.dora.client.rest.TestCaseOptions;
...
public class WebServerIntegrationTest extends BaseIntegrationTest {
  ...
  private static final Multimap<NetworkAddressUtils.ServiceType, String> PAGES =
      new ImmutableListMultimap.Builder<NetworkAddressUtils.ServiceType, String>().putAll(NetworkAddressUtils.ServiceType.MASTER_WEB, "/")
          .putAll(NetworkAddressUtils.ServiceType.WORKER_WEB, "/").build();
  ...
  public void serverUp() throws Exception {
    for (Entry<NetworkAddressUtils.ServiceType, String> entry : PAGES.entries()) {
  ...
  private InetSocketAddress getInetSocketAddresss(NetworkAddressUtils.ServiceType serviceType) {
    int port;
    if (serviceType == NetworkAddressUtils.ServiceType.MASTER_WEB) {
