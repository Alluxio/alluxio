...
import alluxio.dora.dora.master.meta.AlluxioMasterRestServiceHandler;
import alluxio.dora.dora.testutils.LocalAlluxioClusterResource;
import alluxio.dora.dora.testutils.underfs.UnderFileSystemTestUtils;
...
public final class AlluxioMasterRestApiTest extends RestApiTest {
  ...
  public void getRpcAddress() throws Exception {
    assertTrue(getInfo(NO_PARAMS).getRpcAddress()
        .contains(String.valueOf(NetworkAddressUtils.getPort(NetworkAddressUtils.ServiceType.MASTER_RPC,
