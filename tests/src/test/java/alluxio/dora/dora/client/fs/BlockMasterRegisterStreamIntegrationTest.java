...
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.BATCH_SIZE;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.CAPACITY_MAP;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.EMPTY_CONFIG;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.LOST_STORAGE;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.MEM_CAPACITY_BYTES;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.NET_ADDRESS_1;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.TIER_BLOCK_TOTAL;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.TIER_CONFIG;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.USAGE_MAP;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.getErrorCapturingResponseObserver;
import static alluxio.dora.dora.client.fs.RegisterStreamTestUtils.parseTierConfig;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertThrows;

import alluxio.dora.dora.clock.ManualClock;
import alluxio.dora.dora.conf.Configuration;
import alluxio.dora.dora.conf.PropertyKey;
import alluxio.dora.dora.exception.BlockInfoException;
import alluxio.dora.dora.exception.runtime.FailedPreconditionRuntimeException;
...
import alluxio.dora.dora.master.block.meta.MasterWorkerInfo;
import alluxio.dora.dora.master.metrics.MetricsMaster;
...
import alluxio.dora.dora.util.executor.ExecutorServiceFactories;
import alluxio.dora.dora.util.executor.ExecutorServiceFactory;
...
import alluxio.dora.dora.master.block.BlockMasterTestUtils;
import alluxio.dora.dora.master.block.BlockMasterWorkerServiceHandler;
import alluxio.dora.dora.master.block.DefaultBlockMaster;
import alluxio.dora.dora.master.block.RegisterStreamObserver;
import alluxio.dora.dora.master.block.WorkerRegisterContext;
...
public class BlockMasterRegisterStreamIntegrationTest {
  ...
  public void before() throws Exception {
    ...
    mBlockMaster = new DefaultBlockMaster(mMetricsMaster, mMasterContext, mClock,
  ...
  public void registerExistingWorkerBlocksAdded() throws Exception {
    ...
    List<String> tierAliases = getTierAliases(parseTierConfig(TIER_CONFIG));
    Map<String, Long> capacityMap = Maps.toMap(tierAliases, (tier) -> RpcBenchPreparationUtils.CAPACITY);
