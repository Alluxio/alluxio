...
package alluxio.dora.dora.client.cli.fs;
...
import alluxio.dora.dora.cli.GetConf;
...
public final class GetConfTest {
  ...
  public void getConfByAlias() {
    PropertyKey testProperty = PropertyKey.Builder.stringBuilder("alluxio.test.property")
  ...
  public void getConfFromMaster() throws Exception {
    ...
    Mockito.when(client.getConfiguration(any())).thenReturn(
        alluxio.dora.dora.wire.Configuration.fromProto(prepareGetConfigurationResponse()));
  ...
  public void getConfFromMasterWithSource() throws Exception {
    ...
    RetryHandlingMetaMasterConfigClient client =
        Mockito.mock(RetryHandlingMetaMasterConfigClient.class);
    Mockito.when(client.getConfiguration(any())).thenReturn(alluxio.dora.dora.wire.Configuration.fromProto(
