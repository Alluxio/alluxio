...
public class RegisterStreamTestUtils {
  ...
  static final Map<String, Long> CAPACITY_MAP = ImmutableMap.of("MEM", RpcBenchPreparationUtils.CAPACITY,
      "SSD", RpcBenchPreparationUtils.CAPACITY, "HDD", RpcBenchPreparationUtils.CAPACITY);
