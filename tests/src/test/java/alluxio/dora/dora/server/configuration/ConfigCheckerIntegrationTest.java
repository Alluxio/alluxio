...
package alluxio.dora.dora.server.configuration;
...
public class ConfigCheckerIntegrationTest extends BaseIntegrationTest {
  ...
  public void multiMasters() throws Exception {
    ...
    assertEquals(mCluster.getDeployMode().equals(MultiProcessCluster.DeployMode.ZOOKEEPER_HA)
  ...
  public void unsetVsSet() throws Exception {
    ...
    if (mCluster.getDeployMode().equals(MultiProcessCluster.DeployMode.ZOOKEEPER_HA)) {
