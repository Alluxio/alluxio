...
import alluxio.hadoop.TFS;
import alluxio.master.LocalTachyonCluster;

/**
 * This class provides an implementation of {@link AbstractFSContract} using
 * {@link alluxio.hadoop.TFS}. This will be used to run Hadoop Contract tests which verify the
 * {@link alluxio.hadoop.AbstractTFS} interface.
...
public class TachyonFSContract extends AbstractFSContract {
  ...
  public void init() throws IOException {
    ...
    conf.set("fs.alluxio.impl", TFS.class.getName());
