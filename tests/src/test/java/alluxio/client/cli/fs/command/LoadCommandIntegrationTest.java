...
//    while (!mOutput.toString().contains("SUCCEEDED")) {
//      assertEquals(0, sFsShell.run("load", "/testRoot", "--submit --progress"));
//      Thread.sleep(1000);
//    }
//  }
//
...
////    FileSystemUtils.waitForAlluxioPercentage(sFileSystem, uriC, 100);
//    while (!mOutput.toString().contains("SUCCEEDED")) {
//      assertEquals(0, sFsShell.run("load", "/testRootPartial", "--submit --progress"));
//      Thread.sleep(1000);
//    }
//  }
//
...
//    FileSystemUtils.waitForAlluxioPercentage(sFileSystem, uriC, 100);
//    while (!mOutput.toString().contains("SUCCEEDED")) {
//      assertEquals(0, sFsShell.run("load", "/testRootLoaded", "--submit --progress"));
//      Thread.sleep(1000);
//    }
