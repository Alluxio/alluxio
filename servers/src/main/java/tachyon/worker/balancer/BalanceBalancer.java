...
/**
 * A Getter that get the worker with most free space.
 */
public class BalanceBalancer implements Balancer {

  private static final Logger LOG = LoggerFactory.getLogger(Constants.LOGGER_TYPE);

  public BalanceBalancer() {
  ...
  public NetAddress getWorker(boolean random, String host,
    ...
    NetAddress res = null;
    for (Long workerId : mWorkerAddressToId.values()) {
