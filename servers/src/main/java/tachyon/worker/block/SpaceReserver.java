...
/**
 * {@code SpaceReserver} periodically checks if there is enough space reserved on each storage
 * tier, if there is no enough free space on some tier, free space from it.
 */
