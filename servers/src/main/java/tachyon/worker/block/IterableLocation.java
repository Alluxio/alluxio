...
/**
 * Iterate over all {@link tachyon.worker.block.meta.StorageDir} contained in
 * {@link BlockStoreLocation} tier by tier.
 *
 ...
 */
public class IterableLocation implements Iterable<StorageDir> {
