...
public final class Lineage {
  ...
  public static final class AsyncPersistRequestEntry extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tachyon.proto.journal.Lineage.internal_static_tachyon_proto_journal_AsyncPersistRequestEntry_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return tachyon.proto.journal.Lineage.internal_static_tachyon_proto_journal_AsyncPersistRequestEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              tachyon.proto.journal.Lineage.AsyncPersistRequestEntry.class, tachyon.proto.journal.Lineage.AsyncPersistRequestEntry.Builder.class);
    }
    ...
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseFrom(
    ...
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseFrom(
    ...
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(tachyon.proto.journal.Lineage.AsyncPersistRequestEntry prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      // Construct using tachyon.proto.journal.Lineage.AsyncPersistRequestEntry.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public tachyon.proto.journal.Lineage.AsyncPersistRequestEntry getDefaultInstanceForType() {
        return tachyon.proto.journal.Lineage.AsyncPersistRequestEntry.getDefaultInstance();
      }

      public tachyon.proto.journal.Lineage.AsyncPersistRequestEntry build() {
        tachyon.proto.journal.Lineage.AsyncPersistRequestEntry result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public tachyon.proto.journal.Lineage.AsyncPersistRequestEntry buildPartial() {
        tachyon.proto.journal.Lineage.AsyncPersistRequestEntry result = new tachyon.proto.journal.Lineage.AsyncPersistRequestEntry(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof tachyon.proto.journal.Lineage.AsyncPersistRequestEntry) {
          return mergeFrom((tachyon.proto.journal.Lineage.AsyncPersistRequestEntry)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(tachyon.proto.journal.Lineage.AsyncPersistRequestEntry other) {
        if (other == tachyon.proto.journal.Lineage.AsyncPersistRequestEntry.getDefaultInstance()) return this;
        if (other.hasFileId()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        tachyon.proto.journal.Lineage.AsyncPersistRequestEntry parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (tachyon.proto.journal.Lineage.AsyncPersistRequestEntry) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
