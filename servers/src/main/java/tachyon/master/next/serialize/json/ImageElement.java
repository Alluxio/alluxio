 ...
 */
public class ImageElement extends JsonObject {
  ...
  /**
   * Write an ImageElement to the specified OutputStream using the specified ObjectWriter.
   *
   * @param os The target output stream
   * @throws IOException when exception happens during writing
   */
  public void dump(OutputStream os) throws IOException {
    JsonObject.OBJECT_WRITER.writeValue(os, this);
