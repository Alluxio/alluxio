 ...
 * the type.
 */
class JsonEvent extends JsonObject {
  ...
  public JsonEvent(EventType type, long transId) {
    mType = type;
    mTransId = transId;
  }
  ...
  @JsonCreator
  public JsonEvent(@JsonProperty("type") EventType type, @JsonProperty("transId") long transId,
  ...
  @Override
  public JsonEvent withParameter(String name, Object value) {
    return (JsonEvent) super.withParameter(name, value);
  }
}
