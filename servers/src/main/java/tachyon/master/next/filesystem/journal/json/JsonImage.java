...
class JsonImage extends JsonObject {
  ...
  @Override
  public JsonImage withParameter(String name, Object value) {
    return (JsonImage) super.withParameter(name, value);
  }
}
