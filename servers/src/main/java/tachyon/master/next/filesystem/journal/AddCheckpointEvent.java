...
public class AddCheckpointEvent implements Event {
  private final int mFileId;
  private final long mLength;
  private final TachyonURI mCheckpointPath;
  private final long mOpTimeMs;

  public AddCheckpointEvent(int fileId, long length, TachyonURI checkpointPath, long opTimeMs) {
    mFileId = fileId;
    mLength = length;
  ...
  public EventType type() {
    return EventType.ADD_CHECKPOINT;
  }
}
