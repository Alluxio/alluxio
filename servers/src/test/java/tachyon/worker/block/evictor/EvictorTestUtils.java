...
class EvictorTestUtils {
  ...
  /**
   * Assert plan is not null and both {@link #blocksInTheSameDir} and {@link #requestSpaceSatisfied}
   * to be true. This method is to be called in unit tests, if the return values of the two methods
   * are not all true, the unit test will fail.
   *
   * @param bytesToBeAvailable the requested bytes to be available
   * @param plan the eviction plan
   * @param meta the meta data manager
