...
public class GreedyAllocatorTest extends BaseAllocatorTest {
  ...
  public void allocateBlockTest() throws Exception {
    ...
    conf.set(Constants.WORKER_ALLOCATE_STRATEGY_CLASS, GreedyAllocator.class.getName());
    ...
    //  2               └─── 3000
    //
    assertTempBlockMeta(mAllocator, mAnyDirInTierLoc1, 1000, true, 2, 0);
    //
    // idx | tier1 | tier2 | tier3
    //  0     500
    //  0      ├───── 1000   <--- alloc
    ...
    //  2               └─── 3000
    //
    assertTempBlockMeta(mAllocator, mAnyDirInTierLoc1, 1500, true, 2, 1);
    //
    // idx | tier1 | tier2 | tier3
    //  0     500
    //  0      ├───── 1000
    ...
    //  2               └─── 3000
    //
    assertTempBlockMeta(mAllocator, mAnyDirInTierLoc2, 1000, true, 3, 1);
    //
    // idx | tier1 | tier2 | tier3
    //  0      0
    //  0      ├───── 0
