...
public class LoadDefinitionTest {
  ...
  public void replicationSatisfied() throws Exception {
    ...
    Set<Pair<WorkerInfo, ArrayList<LoadDefinition.LoadTask>>> assignments = new LoadDefinition()
    ...
    for (Pair<WorkerInfo, ArrayList<LoadDefinition.LoadTask>> assignment : assignments) {
