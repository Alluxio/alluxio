...
package alluxio.dora.dora.job.plan.replicate;
...
import alluxio.dora.dora.client.block.stream.BlockOutStream;
import alluxio.dora.dora.client.block.stream.TestBlockInStream;
import alluxio.dora.dora.client.block.stream.TestBlockOutStream;
...
import alluxio.dora.dora.client.file.options.OutStreamOptions;
...
public final class SetReplicaDefinitionReplicateTest {
  ...
  private void runTaskReplicateTestHelper(List<BlockWorkerInfo> blockWorkers,
    ...
    SetReplicaDefinition definition = new SetReplicaDefinition();
    definition.runTask(config, new SetReplicaTask(Mode.REPLICATE),
        new RunTaskContext(1, 1, mMockJobServerContext));
  }
