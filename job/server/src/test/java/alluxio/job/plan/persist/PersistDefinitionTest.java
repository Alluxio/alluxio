...
public final class PersistDefinitionTest {
  ...
  public void selectExecutorsTest() throws Exception {
    ...
    WorkerNetAddress workerNetAddress1 = WorkerNetAddress.newBuilder()
        .setDataPort(10).setHost("host1").build();
    WorkerNetAddress workerNetAddress2 = WorkerNetAddress.newBuilder()
        .setDataPort(100).setHost("host2").build();
