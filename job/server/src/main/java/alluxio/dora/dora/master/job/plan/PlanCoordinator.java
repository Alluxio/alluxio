...
public final class PlanCoordinator {
   ...
   */
  public synchronized alluxio.dora.dora.job.wire.PlanInfo getPlanInfoWire(boolean verbose) {
    return new alluxio.dora.dora.job.wire.PlanInfo(mPlanInfo, verbose);
  }
