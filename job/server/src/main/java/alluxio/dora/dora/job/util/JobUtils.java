...
import alluxio.dora.dora.client.block.policy.LocalFirstPolicy;
...
public final class JobUtils {
  ...
  public static void loadBlock(URIStatus status, FileSystemContext context, long blockId,
    ...
    String localHostName = NetworkAddressUtils.getConnectHost(NetworkAddressUtils.ServiceType.WORKER_RPC, conf);
