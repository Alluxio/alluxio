...
public class MigrateCliConfigTest {
  ...
  public void jsonTest() throws Exception {
    MigrateCliConfig config = new MigrateCliConfig("/path/from", "/path/to", "THROUGH", true, 2);
  ...
  public void nullTest() {
    try {
      new MigrateCliConfig(null, "dst", "THROUGH", true, 1);
    ...
    try {
      new MigrateCliConfig("src", null, "THROUGH", true, 1);
      Assert.fail("Cannot create config with null path");
    } catch (NullPointerException exception) {
