  ...
  protected InputStream openObject(String key, OpenOptions options) throws IOException {
    try {
      RetryPolicy retryPolicy = new ExponentialBackoffRetry(
          (int) mUfsConf.getMs(PropertyKey.UNDERFS_S3A_READ_RETRY_BASE_SLEEP_MS),
          (int) mUfsConf.getMs(PropertyKey.UNDERFS_S3A_READ_RETRY_MAX_SLEEP_MS),
          mUfsConf.getInt(PropertyKey.UNDERFS_S3A_READ_RETRY_MAX_NUM));
