...
/**
 * Unit tests for the {@link StocatorUnderFileSystem}.
 */
public class StocatorUnderFileSystemFactoryTest {
  ...
  public void factoryTest() {
    UnderFileSystemFactory factory = UnderFileSystemRegistry.find("swift2d://localhost/test/path");
