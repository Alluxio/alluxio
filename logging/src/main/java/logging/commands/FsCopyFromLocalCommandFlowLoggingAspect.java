...
@Aspect
public class FsCreateDirectoryCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsCreateDirectoryCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.master.file.DefaultFileSystemMaster.createDirectory(..))";
