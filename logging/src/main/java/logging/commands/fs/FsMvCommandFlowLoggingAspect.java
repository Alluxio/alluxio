...
@Aspect
public class FsMvCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsMvCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.MvCommand.run(..))";
