...
@Aspect
public class FsChgrpCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsChgrpCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.ChgrpCommand.run(..))";
