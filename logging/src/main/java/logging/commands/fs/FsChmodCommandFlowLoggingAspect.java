...
@Aspect
public class FsChmodCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsChmodCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.ChmodCommand.run(..))";
