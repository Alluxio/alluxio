...
@Aspect
public class FsUpdateMountCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsUpdateMountCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.UpdateMountCommand.run(..))";
