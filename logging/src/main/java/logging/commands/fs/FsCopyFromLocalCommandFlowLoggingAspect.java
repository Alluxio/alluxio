...
@Aspect
public class FsCopyFromLocalCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsCopyFromLocalCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.CopyFromLocalCommand.run(..))";
