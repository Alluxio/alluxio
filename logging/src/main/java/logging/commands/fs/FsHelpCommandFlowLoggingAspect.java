...
@Aspect
public class FsHelpCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsHelpCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.HelpCommand.run(..))";
