...
@Aspect
public class FsStopSyncCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsStopSyncCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.StopSyncCommand.run(..))";
