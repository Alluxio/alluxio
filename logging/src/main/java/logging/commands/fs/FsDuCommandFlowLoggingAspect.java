...
@Aspect
public class FsDuCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsDuCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.DuCommand.run(..))";
