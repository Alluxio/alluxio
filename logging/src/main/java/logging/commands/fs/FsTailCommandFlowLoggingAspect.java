...
@Aspect
public class FsTailCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsTailCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.TailCommand.run(..))";
