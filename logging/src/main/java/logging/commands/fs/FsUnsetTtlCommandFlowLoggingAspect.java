...
@Aspect
public class FsUnsetTtlCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsUnsetTtlCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.UnsetTtlCommand.run(..))";
