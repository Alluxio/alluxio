...
@Aspect
public class FsLocationCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsLocationCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.LocationCommand.run(..))";
