...
@Aspect
public class FsDistributedCpCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsDistributedCpCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.DistributedCpCommand.run(..))";
