...
@Aspect
public class FsTouchCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsTouchCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.TouchCommand.run(..))";
