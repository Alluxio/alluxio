...
@Aspect
public class FsCheckConsistencyCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsCheckConsistencyCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.CheckConsistencyCommand.run(..))";
