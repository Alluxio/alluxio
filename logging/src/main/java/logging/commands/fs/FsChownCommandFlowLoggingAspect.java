...
@Aspect
public class FsChownCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsChownCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.ChownCommand.run(..))";
