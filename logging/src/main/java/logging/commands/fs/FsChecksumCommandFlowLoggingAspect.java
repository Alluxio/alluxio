...
@Aspect
public class FsChecksumCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsChecksumCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.ChecksumCommand.run(..))";
