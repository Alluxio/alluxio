...
@Aspect
public class FsGetCapacityBytesCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsGetCapacityBytesCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.GetCapacityBytesCommand.run(..))";
