...
@Aspect
public class FsLeaderCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsLeaderCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.LeaderCommand.run(..))";
