...
@Aspect
public class FsTestCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsTestCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.TestCommand.run(..))";
