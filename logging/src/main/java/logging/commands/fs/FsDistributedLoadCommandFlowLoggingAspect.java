...
@Aspect
public class FsDistributedLoadCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsDistributedLoadCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.DistributedLoadCommand.run(..))";
