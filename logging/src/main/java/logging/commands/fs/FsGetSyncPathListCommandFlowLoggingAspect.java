...
@Aspect
public class FsGetSyncPathListCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsGetSyncPathListCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.GetSyncPathListCommand.run(..))";
