...
@Aspect
public class FsGetUsedBytesCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsGetUsedBytesCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.GetUsedBytesCommand.run(..))";
