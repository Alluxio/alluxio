...
@Aspect
public class FsCopyToLocalCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsCopyToLocalCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.CopyToLocalCommand.run(..))";
