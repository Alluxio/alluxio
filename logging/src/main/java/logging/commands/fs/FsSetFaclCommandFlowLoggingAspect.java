...
@Aspect
public class FsSetFaclCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsSetFaclCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.SetFaclCommand.run(..))";
