...
@Aspect
public class FsUnpinCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsUnpinCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.UnpinCommand.run(..))";
