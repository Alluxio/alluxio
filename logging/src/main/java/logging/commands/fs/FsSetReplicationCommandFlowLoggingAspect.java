...
@Aspect
public class FsSetReplicationCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsSetReplicationCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.SetReplicationCommand.run(..))";
