...
@Aspect
public class FsPinCommandFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "FsPinCommandFlow";

    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.PinCommand.run(..))";
