package logging.alluxio.job_master;
...
@Aspect
public class JobMasterFullFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "JobMasterFullFlow";
