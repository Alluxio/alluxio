package logging.alluxio.job_worker;
...
import static logging.alluxio.list.LoggingAspectBoundaries.*;

@Aspect
public class JobWorkerFullFlowLoggingAspect extends BaseAspect {

    private static final String FLOW_NAME = "JobWorkerFullFlow";
