...
public class DataServerIntegrationTest {
  ...
  public void lengthTooSmall() throws IOException {
    ...
    FileBlockInfo block = mTFS.getFileBlocks(fileId).get(0);
  ...
  public void readMultiFiles() throws IOException {
    ...
    FileBlockInfo block1 = mTFS.getFileBlocks(fileId1).get(0);
    ...
    FileBlockInfo block2 = mTFS.getFileBlocks(fileId2).get(0);
   ...
   */
  private DataServerMessage request(final FileBlockInfo block) throws IOException {
   ...
   */
  private DataServerMessage request(final FileBlockInfo block, final long offset,
