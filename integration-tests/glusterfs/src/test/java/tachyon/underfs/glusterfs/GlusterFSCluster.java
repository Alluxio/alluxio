...
public class GlusterFSCluster extends UnderFileSystemCluster {
  ...
  private static final String INTEGRATION_GLUSTER_VOLUMES = "glusterfs.volumes";
  private static final String INTEGRATION_GLUSTER_MOUNTS = "glusterfs.mounts";

  public GlusterFSCluster(String baseDir, TachyonConf tachyonConf) {
    super(baseDir, tachyonConf);
    tachyonConf.set(Constants.UNDERFS_GLUSTERFS_MOUNTS,
        System.getProperty(INTEGRATION_GLUSTER_MOUNTS));
    tachyonConf.set(Constants.UNDERFS_GLUSTERFS_VOLUMES,
        System.getProperty(INTEGRATION_GLUSTER_VOLUMES));
