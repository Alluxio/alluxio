...
public class SwiftUnderStorageCluster extends UnderFileSystemCluster {
  ...
  private static final String INTEGRATION_SWIFT_BASE = "swift.base";

  private String mSwiftBase;

  public SwiftUnderStorageCluster(String baseDir, TachyonConf tachyonConf) {
    super(baseDir, tachyonConf);
    mSwiftBase = System.getProperty(INTEGRATION_SWIFT_BASE, "");
    if (!mSwiftBase.startsWith("swift://")) {
      mSwiftBase = "swift://" + mSwiftBase;
    }
    mBaseDir = mSwiftBase + UUID.randomUUID();
  }
