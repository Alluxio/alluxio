...
package alluxio.dora.dora.cli.fsadmin.report;

import alluxio.dora.dora.cli.fsadmin.FileSystemAdminShellUtils;
...
public class SummaryCommand {
  ...
  private void printBlockMasterInfo() throws IOException {
    Set<BlockMasterInfo.BlockMasterInfoField> blockMasterInfoFilter = new HashSet<>(Arrays
        .asList(BlockMasterInfo.BlockMasterInfoField.LIVE_WORKER_NUM, BlockMasterInfo.BlockMasterInfoField.LOST_WORKER_NUM,
            BlockMasterInfo.BlockMasterInfoField.CAPACITY_BYTES, BlockMasterInfo.BlockMasterInfoField.USED_BYTES,
            BlockMasterInfo.BlockMasterInfoField.FREE_BYTES, BlockMasterInfo.BlockMasterInfoField.CAPACITY_BYTES_ON_TIERS,
            BlockMasterInfo.BlockMasterInfoField.USED_BYTES_ON_TIERS));
