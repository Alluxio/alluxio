...
public class TFsShellUtils {
   ...
   * @throws IOException
   */
  public static List<TachyonURI> getTachyonURIs(StreamingTachyonFileSystem tachyonClient,
   ...
   * @throws IOException
   */
  private static List<TachyonURI> getTachyonURIs(StreamingTachyonFileSystem tachyonClient,
