...
public class MetricsCommandTest {
  ...
  private void checkIfOutputValid() {
    ...
    List<String> expectedOutput = Arrays.asList(
        ...
        "Cluster.BytesReadAlluxioThroughput  (Type: GAUGE, Value: 518.36MB/SEC)",
        "Cluster.BytesReadDomain  (Type: GAUGE, Value: 4145.73KB)",
        "Cluster.BytesReadDomainThroughput  (Type: GAUGE, Value: 29.97MB/SEC)",
        "Cluster.BytesReadLocal  (Type: GAUGE, Value: 11.47GB)",
        "Cluster.BytesReadLocalThroughput  (Type: GAUGE, Value: 117.42MB/SEC)",
        "Cluster.BytesReadUfsAll  (Type: GAUGE, Value: 509.47MB)",
        "Cluster.BytesReadUfsThroughput  (Type: GAUGE, Value: 728.16KB/SEC)",
        "Cluster.BytesWrittenAlluxio  (Type: GAUGE, Value: 22.98KB)",
        "Cluster.BytesWrittenAlluxioThroughput  (Type: GAUGE, Value: 8.03MB/SEC)",
        "Cluster.BytesWrittenDomain  (Type: GAUGE, Value: 62.43MB)",
        "Cluster.BytesWrittenDomainThroughput  (Type: GAUGE, Value: 1202.37KB/SEC)",
        "Cluster.BytesWrittenUfsAll  (Type: GAUGE, Value: 317.70KB)",
        "Cluster.BytesWrittenUfsThroughput  (Type: GAUGE, Value: 33.46KB/SEC)",
