...
public class LogLevelTest {
  ...
  public void parseWorkerTargets() throws Exception {
    ...
    workers.add(new BlockWorkerInfo(WorkerNetAddress.newBuilder("workers-1", 1)
        .setWebPort(WORKER_WEB_PORT).build(), 0, 0));
    workers.add(new BlockWorkerInfo(WorkerNetAddress.newBuilder("workers-2", 2)
        .setWebPort(WORKER_WEB_PORT).build(), 0, 0));
