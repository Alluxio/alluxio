...
import (
	...
	"github.com/Alluxio/alluxio/integration/kubernetes/operator/presto/controllers"
...
func init() {
	...
	utilruntime.Must(alluxiocomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "768ae07c.alluxio.com",
	})
	if err != nil {
