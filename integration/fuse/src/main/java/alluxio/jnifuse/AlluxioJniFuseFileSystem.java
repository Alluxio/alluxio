 ...
 */
@ThreadSafe
public final class AlluxioJniFuseFileSystem extends FuseStubFS {
...
//            stat.st_mtim.tv_nsec.set(ctime_nsec);
     ...
     */
    @Override
    public int readdir(String path, long buff, FuseFillDir filter,
    ...
    private int readdirInternal(String path, long buff, FuseFillDir filter,
                                @off_t long offset, FuseFileInfo fi) {
        final AlluxioURI turi = mPathResolverCache.getUnchecked(path);
        try {
