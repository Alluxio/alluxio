 ...
 */
@ThreadSafe
public final class AlluxioJniFuse {
    private static final Logger LOG = LoggerFactory.getLogger(AlluxioJniFuse.class);

    // prevent instantiation
    private AlluxioJniFuse() {}
    ...
    public static void main(String[] args) {
        ...
        final AlluxioJniFuseFileSystem fs = new AlluxioJniFuseFileSystem(tfs, opts, conf);
    ...
    private static AlluxioFuseOptions parseOptions(String[] args, AlluxioConfiguration alluxioConf) {
        ...
        try {
            ...
            if (cli.hasOption("h")) {
                ...
                fmt.printHelp(AlluxioJniFuse.class.getName(), opts);
                return null;
            }
