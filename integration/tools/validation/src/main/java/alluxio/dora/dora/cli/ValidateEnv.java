...
import alluxio.dora.dora.cli.hdfs.HdfsConfParityValidationTask;
import alluxio.dora.dora.cli.hdfs.HdfsConfValidationTask;
import alluxio.dora.dora.cli.hdfs.HdfsProxyUserValidationTask;
import alluxio.dora.dora.cli.hdfs.HdfsVersionValidationTask;
import alluxio.dora.dora.cli.hdfs.SecureHdfsValidationTask;
...
public final class ValidateEnv {
  ...
  public ValidateEnv(String path, AlluxioConfiguration conf) {
    ...
    registerTask("master.rpc.port.available",
            ...
            new PortAvailabilityValidationTask(NetworkAddressUtils.ServiceType.MASTER_RPC, ALLUXIO_MASTER_CLASS, mConf),
            mMasterTasks);
    registerTask("master.web.port.available",
            "validate master web port is available",
            new PortAvailabilityValidationTask(NetworkAddressUtils.ServiceType.MASTER_WEB, ALLUXIO_MASTER_CLASS, mConf),
            mMasterTasks);
    registerTask("worker.rpc.port.available",
            "validate worker RPC port is available",
            new PortAvailabilityValidationTask(NetworkAddressUtils.ServiceType.WORKER_RPC, ALLUXIO_WORKER_CLASS, mConf),
            mWorkerTasks);
    registerTask("worker.web.port.available",
            "validate worker web port is available",
            new PortAvailabilityValidationTask(NetworkAddressUtils.ServiceType.WORKER_WEB, ALLUXIO_WORKER_CLASS, mConf),
            mWorkerTasks);
    registerTask("proxy.web.port.available",
            "validate proxy web port is available",
            new PortAvailabilityValidationTask(NetworkAddressUtils.ServiceType.PROXY_WEB, ALLUXIO_PROXY_CLASS, mConf),
            mCommonTasks);
