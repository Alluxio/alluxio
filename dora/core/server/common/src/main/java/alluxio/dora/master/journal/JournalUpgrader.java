...
import alluxio.dora.master.ServiceUtils;
import alluxio.dora.master.journalv0.JournalWriter;
import alluxio.dora.master.journalv0.MutableJournal;
 ...
 *   alluxio.dora.journal.master.JournalUpgrader -journalDirectoryV0 YourJournalDirectoryV0
 * </pre>
 */
@NotThreadSafe
public final class JournalUpgrader {
   ...
   * alluxio.dora.journal.master.JournalUpgrader -master BlockMaster}.
   *
  ...
  private static void usage() {
    new HelpFormatter().printHelp("java -cp alluxio-" + RuntimeConstants.VERSION
            + "-jar-with-dependencies.jar alluxio.dora.journal.master.JournalUpgrader",
