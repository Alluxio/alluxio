...
import alluxio.coordinator.journal.checkpoint.Checkpointed;
import alluxio.coordinator.journal.checkpoint.CompoundCheckpointFormat.CompoundCheckpointReader;
import alluxio.coordinator.journal.checkpoint.CompoundCheckpointFormat.CompoundCheckpointReader.Entry;
