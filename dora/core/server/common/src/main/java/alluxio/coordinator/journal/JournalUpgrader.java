...
public final class JournalUpgrader {
  ...
  private static final class Upgrader {
    ...
    private final alluxio.coordinator.journalv0.MutableJournal mJournalV0;
    ...
    private Upgrader(String master, AlluxioConfiguration alluxioConf) {
      ...
      mJournalV0 = (new alluxio.coordinator.journalv0.MutableJournal.Factory(
    ...
    private void prepare() throws IOException {
      alluxio.coordinator.journalv0.JournalWriter journalWriterV0 = mJournalV0.getWriter();
