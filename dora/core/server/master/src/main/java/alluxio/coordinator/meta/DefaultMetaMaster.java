...
import alluxio.coordinator.backup.BackupLeaderRole;
import alluxio.coordinator.backup.BackupRole;
import alluxio.coordinator.backup.BackupWorkerRole;
...
import alluxio.coordinator.meta.checkconf.ConfigurationChecker;
import alluxio.coordinator.meta.checkconf.ConfigurationStore;
...
public final class DefaultMetaMaster extends CoreMaster implements MetaMaster {
   ...
   */
  @NotThreadSafe
  public static final class State implements alluxio.coordinator.journal.Journaled {
