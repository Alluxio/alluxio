...
import static alluxio.coordinator.file.InodeSyncStream.SyncStatus.FAILED;
import static alluxio.coordinator.file.InodeSyncStream.SyncStatus.NOT_NEEDED;
import static alluxio.coordinator.file.InodeSyncStream.SyncStatus.OK;
...
import alluxio.coordinator.CoreMaster;
...
import alluxio.coordinator.file.activesync.ActiveSyncManager;
import alluxio.coordinator.file.contexts.CallTracker;
import alluxio.coordinator.file.contexts.CheckAccessContext;
import alluxio.coordinator.file.contexts.CheckConsistencyContext;
import alluxio.coordinator.file.contexts.CompleteFileContext;
...
import alluxio.coordinator.file.contexts.ExistsContext;
import alluxio.coordinator.file.contexts.FreeContext;
import alluxio.coordinator.file.contexts.GetStatusContext;
...
import alluxio.coordinator.file.contexts.LoadMetadataContext;
...
import alluxio.coordinator.file.contexts.ScheduleAsyncPersistenceContext;
import alluxio.coordinator.file.contexts.SetAclContext;
import alluxio.coordinator.file.contexts.SetAttributeContext;
...
import alluxio.coordinator.file.meta.InodeDirectoryIdGenerator;
import alluxio.coordinator.file.meta.InodeDirectoryView;
import alluxio.coordinator.file.meta.InodeFile;
import alluxio.coordinator.file.meta.InodeLockManager;
import alluxio.coordinator.file.meta.InodePathPair;
...
import alluxio.coordinator.file.meta.LockedInodePathList;
...
import alluxio.coordinator.file.meta.UfsBlockLocationCache;
...
import alluxio.coordinator.journal.JournaledGroup;
import alluxio.coordinator.journal.NoopJournalContext;
import alluxio.coordinator.journal.checkpoint.CheckpointName;
import alluxio.coordinator.metastore.DelegatingReadOnlyInodeStore;
import alluxio.coordinator.metastore.InodeStore;
import alluxio.coordinator.metastore.ReadOnlyInodeStore;
import alluxio.coordinator.metrics.TimeSeriesStore;
import alluxio.coordinator.scheduler.DefaultWorkerProvider;
import alluxio.coordinator.scheduler.JournaledJobMetaStore;
import alluxio.coordinator.scheduler.Scheduler;
  ...
  public void start(Boolean isPrimary) throws IOException {
    ...
    if (isPrimary) {
      ...
      mReplicationCheckHeartbeatThread = new HeartbeatThread(
          ...
          new alluxio.coordinator.file.replication.ReplicationChecker(mInodeTree, mBlockMaster,
