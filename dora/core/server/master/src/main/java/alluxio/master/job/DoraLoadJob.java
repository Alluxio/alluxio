...
public class DoraLoadJob extends AbstractJob<DoraLoadJob.DoraLoadTask> {
  ...
  private List<LoadSubTask> createSubTasks(UfsStatus ufsStatus, Collection<WorkerInfo> workers) {
    ...
    List<LoadSubTask> subTasksWithWorker = assignTasksToWorkers(subTasks, workers, mNumReplica);
  ...
  private List<LoadSubTask> assignTasksToWorkers(List<LoadSubTask> subTasks,
