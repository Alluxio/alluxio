...
import alluxio.coordinator.meta.DefaultMetaMaster;
import alluxio.coordinator.meta.MetaMaster;
import alluxio.coordinator.service.SimpleService;
import alluxio.coordinator.service.jvmmonitor.JvmMonitorService;
import alluxio.coordinator.service.metrics.MetricsService;
import alluxio.coordinator.service.rpc.RpcServerService;
import alluxio.coordinator.service.web.WebServerService;
...
public class AlluxioMasterProcess extends MasterProcess {
  ...
  AlluxioMasterProcess(JournalSystem journalSystem, PrimarySelector leaderSelector) {
    ...
    if (Configuration.getBoolean(PropertyKey.MASTER_THROTTLE_ENABLED)) {
      mRegistry.get(alluxio.coordinator.throttle.DefaultThrottleMaster.class).setMaster(this);
    }
