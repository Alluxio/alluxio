...
public class LockedInodePath implements Closeable {
   ...
   * {@link alluxio.coordinator.journal.MetadataSyncMergeJournalContext} only
   ...
   * if {@link alluxio.coordinator.journal.FileSystemMergeJournalContext} is used because
   ...
   * {@link alluxio.coordinator.file.InodeSyncStream}. Where traverse() is called right before the
