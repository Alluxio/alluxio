...
public class HttpLoadService {
   ...
   * <p>example:</p>
   * <p>http://localhost:28080/v1/load?path=/&opType=submit&partialListing=true&verify=true
   * &loadMetadataOnly=true&verbose=true&skipIfExists=true</p>
   * <hr/>
   * <h3>STOP:</h3>
   * <p>description: stop the load job</p>
   * <p>example:</p>
   * <p>http://localhost:28080/v1/load?path=/&opType=stop</p>
   * <hr/>
   * <h3>PROGRESS:</h3>
   * <p>description: get the progress of the load job</p>
   * <p>example:</p>
   * <p>http://localhost:28080/v1/load?path=/&opType=progress&progressFormat=text&verbose=true</p>
   * <hr/>
