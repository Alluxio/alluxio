 ...
 * native API defined in {@link alluxio.dora.client.file.FileSystem}, which this API is built on top of.
 */
@NotThreadSafe
public class FileSystem extends AbstractFileSystem {
   ...
   * specified {@link alluxio.dora.client.file.FileSystem} handler for tests.
   *
   * @param fileSystem handler to file system
   */
  public FileSystem(alluxio.dora.client.file.FileSystem fileSystem) {
    super(fileSystem);
  }
