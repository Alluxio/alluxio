...
public class DelegatingFileSystem implements FileSystem {
  ...
  @Override
<<<<<<< HEAD:dora/core/client/fs/src/main/java/alluxio/client/file/DelegatingFileSystem.java
...
||||||| parent of 45ec28e77e ([SMALLFIX] Import class type before code class):core/client/fs/src/main/java/alluxio/client/file/DelegatingFileSystem.java
...
=======
  public String getLoadProgress(AlluxioURI path,
    ...
    return mDelegatedFileSystem.getLoadProgress(path, format, verbose);
>>>>>>> 45ec28e77e ([SMALLFIX] Import class type before code class):core/client/fs/src/main/java/alluxio/client/file/DelegatingFileSystem.java
  }
