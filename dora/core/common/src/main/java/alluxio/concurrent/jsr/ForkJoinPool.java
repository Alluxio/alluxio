 ...
 * employing <em>work-stealing</em>: all threads in the pool attempt to find and execute tasks
 ...
 * external clients. Especially when setting <em>asyncMode</em> to true in constructors, {@code
 ...
 * <ul>
 * <li>{@code java.util.concurrent.ForkJoinPool.common.parallelism} - the parallelism level, a
 * non-negative integer
 * <li>{@code java.util.concurrent.ForkJoinPool.common.threadFactory} - the class name of a
 ...
 * <li>{@code java.util.concurrent.ForkJoinPool.common.exceptionHandler} - the class name of a
 ...
 * <li>{@code java.util.concurrent.ForkJoinPool.common.maximumSpares} - the maximum number of
 ...
 *
 * <p>
 * <b>Implementation Note:</b> This implementation restricts the maximum number of running threads
...
public class ForkJoinPool extends AbstractExecutorService {
          ...
          if ((a = w.array) != null && (d = b - s) < 0 && (al = a.length) > 0) {
            ...
            if (blocker.isReleasable())
              ...
              if (t == null) {
                ...
                break;
              else if (U.compareAndSetObject(a, offset, t, null)) {
                w.base = b;
                t.doExec();
              }
            }
  ...
  private void tryAddWorker(long c) {
    do {
      ...
      if (ctl == c && U.compareAndSetLong(this, CTL, c, nc)) {
        createWorker();
        break;
      }
  ...
  final void deregisterWorker(ForkJoinWorkerThread wt, Throwable ex) {
    ...
    if (phase != QUIET) { // else pre-adjusted
      ...
      do {
      } while (!U.compareAndSetLong(this, CTL, c = ctl,
  ...
  final void signalWork() {
    for (;;) {
      ...
      if ((c = ctl) >= 0L) // enough workers
        ...
        Thread vt = v.owner;
        if (sp == vp && U.compareAndSetObject(this, CTL, c, nc)) {
          v.phase = np;
          if (v.source < 0)
  ...
  private int tryCompensate(WorkQueue w) {
    ...
    if ((t = (short) (c >>> TC_SHIFT)) >= 0) {
      if (ws == null || (n = ws.length) <= 0 || w == null)
        ...
        if (v != null) {
          ...
          if (vp == sp && U.compareAndSetLong(this, CTL, c, nc)) {
            v.phase = np;
            if (v.source < 0)
              LockSupport.unpark(vt);
            return (wp < 0) ? -1 : 1;
        ...
        return U.compareAndSetLong(this, CTL, c, nc) ? 1 : 0;
      } else { // validate
    ...
    return U.compareAndSetLong(this, CTL, c, nc) && createWorker() ? 1 : 0;
  }
    ...
    while ((ws = workQueues) != null) {
      ...
      for (int n = ws.length, j = n, m = n - 1; j > 0; --j) {
        ...
        if ((i = r & m) >= 0 && i < n && // always true
          ...
          long offset = ((long) index << ASHIFT) + ABASE;
          ForkJoinTask<?> t = (ForkJoinTask<?>) U.getObjectVolatile(a, offset);
          if (t != null && b++ == q.base && U.compareAndSetObject(a, offset, t, null)) {
      ...
      if (nonempty) { // move (xorshift)
        ...
        if ((phase = w.phase) >= 0) { // enqueue
          ...
          } while (!U.compareAndSetLong(this, CTL, c, nc));
        } else { // already queued
          ...
          for (int n = ws.length, m = n - 1, j = -n; j < n; j += 2) {
            ...
            if ((i = (r + j) & m) >= 0 && i < n && (q = ws[i]) != null && q.source == id
              ...
              if (t != null && b++ == q.base && id == q.source
                  && U.compareAndSetObject(a, offset, t, null)) {
                q.base = b;
                w.source = qid;
                t.doExec();
                w.source = src;
  ...
  private boolean tryTerminate(boolean now, boolean enable) {
    ...
    while (((md = mode) & SHUTDOWN) == 0) {
      if (!enable || this == common) // cannot shutdown
        ...
        U.compareAndSetInt(this, MODE, md, md | SHUTDOWN);
    }
    ...
    while (((md = mode) & STOP) == 0) { // try to initiate termination
      ...
      if ((md & STOP) == 0)
        U.compareAndSetInt(this, MODE, md, md | STOP);
    }
    ...
    while (((md = mode) & TERMINATED) == 0) { // help terminate others
      ...
      if ((md & TERMINATED) != 0)
        ...
        break;
      else if (U.compareAndSetInt(this, MODE, md, md | TERMINATED)) {
        synchronized (this) {
  ...
  public ForkJoinTask<?> submit(Runnable task) {
    Objects.requireNonNull(task);
    return externalSubmit((task instanceof ForkJoinTask<?>) ? (ForkJoinTask<Void>) task // avoid
                                                                                        // re-wrap
  ...
  static final class WorkQueue {
    ...
    final void push(ForkJoinTask<?> task) {
      ...
      if ((a = array) != null && (al = a.length) > 0) {
        ...
        ForkJoinPool p = pool;
        top = s + 1;
        U.putObjectVolatile(a, offset, task);
    ...
    final ForkJoinTask<?>[] growArray() {
      ...
      if (oldA != null && (oldMask = oldSize - 1) > 0 && (t = top) - (b = base) > 0) {
        ...
        do { // emulate poll from old array, push to new array
          ...
          if (x != null && U.compareAndSetObject(oldA, offset, x, null))
            a[b & mask] = x;
        } while (++b != t);
        U.storeFence();
      }
    ...
    final ForkJoinTask<?> pop() {
      ...
      if ((a = array) != null && b != s && (al = a.length) > 0) {
        ...
        if (t != null && U.compareAndSetObject(a, offset, t, null)) {
          top = s;
          U.storeFence();
          return t;
        }
    ...
    final ForkJoinTask<?> poll() {
      for (;;) {
        ...
        if ((a = array) != null && (d = b - s) < 0 && (al = a.length) > 0) {
          ...
          if (b++ == base) {
            if (t != null) {
              if (U.compareAndSetObject(a, offset, t, null)) {
                base = b;
                return t;
              }
            } else if (d == -1)
    ...
    final boolean tryUnpush(ForkJoinTask<?> task) {
      ...
      if ((a = array) != null && b != s && (al = a.length) > 0) {
        int index = (al - 1) & --s;
        long offset = ((long) index << ASHIFT) + ABASE;
        if (U.compareAndSetObject(a, offset, task, null)) {
          top = s;
          U.storeFence();
          return true;
        }
      ...
      if (base - (s = top) < 0 && // traverse from top
        ...
        for (int m = wal - 1, ns = s - 1, i = ns;; --i) {
          ...
          if (t == null)
            ...
            if (U.compareAndSetObject(wa, offset, t, null)) {
              ...
              for (int j = i; j != ns; ++j) {
                ...
                U.putObjectVolatile(wa, jOffset, f);
              }
              U.storeFence();
              t.doExec();
            }
    ...
    final boolean tryLockSharedQueue() {
      return U.compareAndSetInt(this, PHASE, 0, QLOCK);
    }
    ...
    final boolean trySharedUnpush(ForkJoinTask<?> task) {
      ...
      if ((a = array) != null && (al = a.length) > 0) {
        ...
        long offset = ((long) index << ASHIFT) + ABASE;
        ForkJoinTask<?> t = (ForkJoinTask<?>) U.getObject(a, offset);
        if (t == task && U.compareAndSetInt(this, PHASE, 0, QLOCK)) {
          if (top == s + 1 && array == a && U.compareAndSetObject(a, offset, task, null)) {
            popped = true;
            top = s;
          }
          U.putIntVolatile(this, PHASE, 0);
        }
      }
      return popped;
    }
            ...
            if (o instanceof CountedCompleter) {
              ...
              for (CountedCompleter<?> f = t;;) {
                if (f != task) {
                  ...
                  if (U.compareAndSetInt(this, PHASE, 0, QLOCK)) {
                    if (top == s && array == a && U.compareAndSetObject(a, offset, t, null)) {
                      help = true;
                      top = s - 1;
                    }
                    U.putInt(this. PHASE, 0);
                    if (help)
                      t.doExec();
                  }
                  break;
