...
public abstract class ObjectUnderFileSystem extends BaseUnderFileSystem {
  ...
  @Override
  public String initObjectMultiPart(String path,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return initMultiPart(stripPrefixIfPresent(path), options);
  }

  @Override
  public OutputStream uploadObjectMultiPart(String path, String uploadId, int partNum,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return uploadPart(stripPrefixIfPresent(path), uploadId, partNum, options);
  }

  @Override
  public String uploadObjectMultiPart(String path, String uploadId, int partNum, long fileSize,
      InputStream stream,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return uploadPartWithStream(stripPrefixIfPresent(path), uploadId, partNum, fileSize, stream,
        options);
  }

  @Override
  public String uploadPartCopy(String destPath, String srcPath, String uploadId, int partNum,
      @Nullable Long firstByte, @Nullable Long lastByte,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return copyPart(stripPrefixIfPresent(destPath), stripPrefixIfPresent(srcPath), uploadId,
        partNum, firstByte, lastByte, options);
  }

  @Override
  public String completeObjectMultiPart(String path, String uploadId,
      List<Pair<Integer, String>> etags,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return completeMultiPart(stripPrefixIfPresent(path), uploadId, etags, options);
  }

  @Override
  public List<alluxio.underfs.response.PartSummaryInfo> listUfsParts(String path, String uploadId,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    return listParts(stripPrefixIfPresent(path), uploadId, options);
  }

  @Override
  public alluxio.underfs.response.ListMultipartUploadResult listMultipartUploads(
  ...
  @Override
  public void abortUfsMultipartTask(String path, String uploadId,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    abortMultipartTask(stripPrefixIfPresent(path), uploadId, options);
  }

  protected String initMultiPart(String key, alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    throw new IOException("not support");
  }

  protected OutputStream uploadPart(String key, String uploadId, int partNum,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    throw new IOException("not support");
  }
  ...
  protected String copyPart(String key, String copySrc, String uploadId, int partNum,
      @Nullable Long firstByte, @Nullable Long lastByte,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    throw new IOException("not support");
  ...
  protected List<alluxio.underfs.response.PartSummaryInfo> listParts(String key, String uploadId,
      alluxio.underfs.options.MultipartUfsOptions options)
      throws IOException {
    throw new IOException("not support");
  }
