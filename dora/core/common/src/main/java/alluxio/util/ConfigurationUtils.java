...
public final class ConfigurationUtils {
  ...
  public static List<InetSocketAddress> getEmbeddedJournalAddresses(AlluxioConfiguration conf,
    ...
    Preconditions.checkState(
        serviceType == NetworkAddressUtils.ServiceType.MASTER_RAFT || serviceType == NetworkAddressUtils.ServiceType.JOB_MASTER_RAFT);
  ...
  public static List<InetSocketAddress> getMasterRpcAddresses(AlluxioConfiguration conf) {
    ...
    return overridePort(getEmbeddedJournalAddresses(conf, NetworkAddressUtils.ServiceType.MASTER_RAFT), rpcPort);
  }
  ...
  public static List<InetSocketAddress> getJobMasterRpcAddresses(AlluxioConfiguration conf) {
    ...
    // Fall back on server-side journal configuration.
    return overridePort(getEmbeddedJournalAddresses(conf, NetworkAddressUtils.ServiceType.JOB_MASTER_RAFT), jobRpcPort);
  }
