...
public final class GrpcUtils {
   ...
   */
  public static alluxio.wire.BlockLocation fromProto(alluxio.grpc.BlockLocation blockPLocation) {
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.BlockInfo fromProto(alluxio.grpc.BlockInfo blockPInfo) {
   ...
   */
  public static alluxio.wire.FileInfo fromProto(alluxio.grpc.FileInfo pInfo) {
    alluxio.wire.FileInfo fileInfo = new alluxio.wire.FileInfo().setFileId(pInfo.getFileId()).setName(pInfo.getName())
        ...
        .setFileBlockInfos(StreamUtils.map(GrpcUtils::fromProto, pInfo.getFileBlockInfosList()))
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.FileBlockInfo fromProto(alluxio.grpc.FileBlockInfo fileBlockPInfo) {
    return new alluxio.wire.FileBlockInfo().setBlockInfo(fromProto(fileBlockPInfo.getBlockInfo()))
        .setOffset(fileBlockPInfo.getOffset()).setUfsLocations(
            fileBlockPInfo.getUfsLocationsCount() > 0 ? fileBlockPInfo.getUfsStringLocationsList()
                : StreamUtils.map(addr -> HostAndPort.fromParts(addr.getHost(), addr.getDataPort()).toString(),
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.TieredIdentity fromProto(alluxio.grpc.TieredIdentity tieredPIdentity) {
    return new alluxio.wire.TieredIdentity(tieredPIdentity.getTiersList().stream().map(GrpcUtils::fromProto)
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.TieredIdentity.LocalityTier fromProto(alluxio.grpc.LocalityTier localityPTier) {
    return new alluxio.wire.TieredIdentity.LocalityTier(localityPTier.getTierName(),
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.MountPointInfo fromProto(alluxio.grpc.MountPointInfo mountPointPInfo) {
    return new alluxio.wire.MountPointInfo().setUfsUri(mountPointPInfo.getUfsUri())
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.WorkerInfo fromProto(alluxio.grpc.WorkerInfo workerInfo) {
    return new alluxio.wire.WorkerInfo().setAddress(fromProto(workerInfo.getAddress()))
   ...
   * @return the converted wire type
   */
  public static alluxio.wire.WorkerNetAddress fromProto(alluxio.grpc.WorkerNetAddress workerNetPAddress) {
   ...
   */
  public static alluxio.grpc.BlockInfo toProto(alluxio.wire.BlockInfo blockInfo) {
   ...
   * @return the converted proto type
   */
  public static alluxio.grpc.BlockLocation toProto(alluxio.wire.BlockLocation blockLocation) {
   ...
   */
  public static alluxio.grpc.FileInfo toProto(alluxio.wire.FileInfo fileInfo) {
   ...
   */
  public static alluxio.grpc.FileBlockInfo toProto(alluxio.wire.FileBlockInfo fileBlockInfo) {
   ...
   * @return converted proto representation
   */
  public static alluxio.grpc.LocalityTier toProto(alluxio.wire.TieredIdentity.LocalityTier localityTier) {
   ...
   * @return converted proto representation
   */
  public static alluxio.grpc.MountPointInfo toProto(alluxio.wire.MountPointInfo info) {
   ...
   */
  public static alluxio.grpc.TieredIdentity toProto(alluxio.wire.TieredIdentity tieredIdentity) {
   ...
   * @return the converted proto representation
   */
  public static alluxio.grpc.WorkerInfo toProto(alluxio.wire.WorkerInfo workerInfo) {
   ...
   * @return the converted proto representation
   */
  public static alluxio.grpc.WorkerNetAddress toProto(alluxio.wire.WorkerNetAddress workerNetAddress) {
   ...
   */
  public static alluxio.grpc.CommandType toProto(alluxio.wire.CommandType commandType) {
   ...
   * @return proto representation of given wire type
   */
  public static alluxio.grpc.PersistFile toProto(alluxio.wire.PersistFile persistFile) {
   ...
   * @return proto representation of given wire type
   */
  public static alluxio.grpc.FileSystemCommand toProto(alluxio.wire.FileSystemCommand fsCommand) {
   ...
   * @return proto representation of given wire type
   */
  public static alluxio.grpc.UfsInfo toProto(alluxio.wire.UfsInfo ufsInfo) {
