...
public enum AuthType {
   ...
   * "alluxio.dora.security.login.username" property, or the OS user upon failure.
   ...
   * (Specified by property "alluxio.dora.security.authentication.custom.provider.class").
   */
  CUSTOM,
