...
package alluxio.dora.conf;

import static alluxio.dora.conf.PropertyKey.Builder.booleanBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.classBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.dataSizeBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.doubleBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.durationBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.enumBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.intBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.listBuilder;
import static alluxio.dora.conf.PropertyKey.Builder.longBuilder;
...
import alluxio.dora.DefaultSupplier;
...
import alluxio.dora.client.file.cache.ShadowCacheType;
import alluxio.dora.client.file.cache.store.PageStoreType;
import alluxio.dora.exception.ExceptionMessage;
import alluxio.dora.executor.RpcExecutorType;
import alluxio.dora.executor.ThreadPoolExecutorQueueType;
import alluxio.grpc.LoadMetadataPType;
import alluxio.grpc.Scope;
import alluxio.grpc.TtlAction;
import alluxio.grpc.WritePType;
import alluxio.dora.master.GraceMode;
import alluxio.dora.master.ZookeeperConnectionErrorPolicy;
import alluxio.dora.master.file.MetadataSyncTraversalOrder;
...
import alluxio.dora.worker.block.management.BackoffStrategy;
...
public final class PropertyKey implements Comparable<PropertyKey> {
  ...
  public static final PropertyKey PROXY_STREAM_CACHE_TIMEOUT_MS =
      durationBuilder(Name.PROXY_STREAM_CACHE_TIMEOUT_MS)
          .setAlias("alluxio.dora.proxy.stream.cache.timeout.ms")
          .setDefaultValue("1hour")
  ...
  public static final PropertyKey SECURITY_AUTHENTICATION_CUSTOM_PROVIDER_CLASS =
      classBuilder(Name.SECURITY_AUTHENTICATION_CUSTOM_PROVIDER_CLASS)
          .setDescription("The class to provide customized authentication implementation, "
              + "when alluxio.dora.security.authentication.type is set to CUSTOM. It must "
              + "implement the interface "
              + "'alluxio.dora.security.authentication.AuthenticationProvider'.")
          .setConsistencyCheckLevel(ConsistencyCheckLevel.WARN)
          .setScope(Scope.ALL)
          .build();
  ...
  public static final PropertyKey SECURITY_GROUP_MAPPING_CACHE_TIMEOUT_MS =
      durationBuilder(Name.SECURITY_GROUP_MAPPING_CACHE_TIMEOUT_MS)
          .setAlias("alluxio.dora.security.group.mapping.cache.timeout.ms")
          .setDefaultValue("1min")
  ...
  public static final PropertyKey SECURITY_GROUP_MAPPING_CLASS =
      classBuilder(Name.SECURITY_GROUP_MAPPING_CLASS)
          .setDefaultValue("alluxio.dora.security.group.provider.ShellBasedUnixGroupsMapping")
          .setDescription("The class to provide user-to-groups mapping service. Master could "
              ...
              + "interface 'alluxio.dora.security.group.GroupMappingService'. The default "
  ...
  public static final PropertyKey SECURITY_LOGIN_USERNAME =
      stringBuilder(Name.SECURITY_LOGIN_USERNAME)
          .setDescription("When alluxio.dora.security.authentication.type is set to SIMPLE or "
  ...
  public static final PropertyKey S3_REST_AUTHENTICATOR_CLASSNAME =
       classBuilder(Name.S3_REST_AUTHENTICATOR_CLASSNAME)
           ...
           .setDefaultValue("alluxio.dora.proxy.s3.auth.PassAllAuthenticator")
           .setConsistencyCheckLevel(ConsistencyCheckLevel.ENFORCE)
           .setScope(Scope.ALL)
           .build();
  //
  ...
  public static final class Name {
    ...
    public static final String METRICS_CONF_FILE = "alluxio.dora.metrics.conf.file";
    public static final String METRICS_CONTEXT_SHUTDOWN_TIMEOUT =
        "alluxio.dora.metrics.context.shutdown.timeout";
    public static final String METRICS_EXECUTOR_TASK_WARN_SIZE =
        "alluxio.dora.metrics.executor.task.warn.size";
    public static final String METRICS_EXECUTOR_TASK_WARN_FREQUENCY =
        "alluxio.dora.metrics.executor.task.warn.frequency";
    ...
    public static final String WEB_FILE_INFO_ENABLED = "alluxio.dora.web.file.info.enabled";
    public static final String WEB_RESOURCES = "alluxio.dora.web.resources";
    public static final String WEB_THREADS = "alluxio.dora.web.threads";
    public static final String WEB_CORS_ENABLED = "alluxio.dora.web.cors.enabled";
    public static final String WEB_REFRESH_INTERVAL = "alluxio.dora.web.refresh.interval";
    public static final String WEB_THREAD_DUMP_TO_LOG = "alluxio.dora.web.threaddump.log.enabled";
    public static final String WEB_UI_ENABLED = "alluxio.dora.web.ui.enabled";
    ...
    // Proxy related properties
    //
    public static final String PROXY_S3_WRITE_TYPE = "alluxio.dora.proxy.s3.writetype";
    public static final String PROXY_S3_DELETE_TYPE = "alluxio.dora.proxy.s3.deletetype";
    public static final String PROXY_S3_MULTIPART_UPLOAD_CLEANER_ENABLED =
        "alluxio.dora.proxy.s3.multipart.upload.cleaner.enabled";
    public static final String PROXY_S3_MULTIPART_UPLOAD_CLEANER_TIMEOUT =
        "alluxio.dora.proxy.s3.multipart.upload.cleaner.timeout";
    public static final String PROXY_S3_MULTIPART_UPLOAD_CLEANER_RETRY_COUNT =
        "alluxio.dora.proxy.s3.multipart.upload.cleaner.retry.count";
    public static final String PROXY_S3_MULTIPART_UPLOAD_CLEANER_RETRY_DELAY =
        "alluxio.dora.proxy.s3.multipart.upload.cleaner.retry.delay";
    public static final String PROXY_S3_MULTIPART_UPLOAD_CLEANER_POOL_SIZE =
        "alluxio.dora.proxy.s3.multipart.upload.cleaner.pool.size";
    public static final String PROXY_S3_COMPLETE_MULTIPART_UPLOAD_KEEPALIVE_ENABLED =
        "alluxio.dora.proxy.s3.complete.multipart.upload.keepalive.enabled";
    public static final String PROXY_S3_COMPLETE_MULTIPART_UPLOAD_KEEPALIVE_TIME_INTERVAL =
        "alluxio.dora.proxy.s3.complete.multipart.upload.keepalive.time.interval";
    public static final String PROXY_S3_COMPLETE_MULTIPART_UPLOAD_MIN_PART_SIZE =
        "alluxio.dora.proxy.s3.complete.multipart.upload.min.part.size";
    public static final String PROXY_S3_COMPLETE_MULTIPART_UPLOAD_POOL_SIZE =
        "alluxio.dora.proxy.s3.complete.multipart.upload.pool.size";
    public static final String PROXY_S3_HEADER_METADATA_MAX_SIZE =
        "alluxio.dora.proxy.s3.header.metadata.max.size";
    public static final String PROXY_S3_BUCKET_NAMING_RESTRICTIONS_ENABLED =
        "alluxio.dora.proxy.s3.bucket.naming.restrictions.enabled";
    public static final String PROXY_S3_TAGGING_RESTRICTIONS_ENABLED =
        "alluxio.dora.proxy.s3.tagging.restrictions.enabled";
    public static final String PROXY_STREAM_CACHE_TIMEOUT_MS =
        "alluxio.dora.proxy.stream.cache.timeout";
    public static final String PROXY_WEB_BIND_HOST = "alluxio.dora.proxy.web.bind.host";
    public static final String PROXY_WEB_HOSTNAME = "alluxio.dora.proxy.web.hostname";
    public static final String PROXY_WEB_PORT = "alluxio.dora.proxy.web.port";
    public static final String PROXY_AUDIT_LOGGING_ENABLED =
        "alluxio.dora.proxy.audit.logging.enabled";
    ...
    public static final String SECURITY_AUTHENTICATION_CUSTOM_PROVIDER_CLASS =
        "alluxio.dora.security.authentication.custom.provider.class";
    public static final String SECURITY_AUTHENTICATION_TYPE =
        "alluxio.dora.security.authentication.type";
    public static final String SECURITY_AUTHORIZATION_PERMISSION_ENABLED =
        "alluxio.dora.security.authorization.permission.enabled";
    public static final String SECURITY_AUTHORIZATION_PERMISSION_SUPERGROUP =
        "alluxio.dora.security.authorization.permission.supergroup";
    public static final String SECURITY_AUTHORIZATION_PERMISSION_UMASK =
        "alluxio.dora.security.authorization.permission.umask";
    public static final String SECURITY_GROUP_MAPPING_CACHE_TIMEOUT_MS =
        "alluxio.dora.security.group.mapping.cache.timeout";
    public static final String SECURITY_GROUP_MAPPING_CLASS =
        "alluxio.dora.security.group.mapping.class";
    public static final String SECURITY_LOGIN_IMPERSONATION_USERNAME =
        "alluxio.dora.security.login.impersonation.username";
    public static final String SECURITY_LOGIN_USERNAME = "alluxio.dora.security.login.username";
    public static final String AUTHENTICATION_INACTIVE_CHANNEL_REAUTHENTICATE_PERIOD =
        "alluxio.dora.security.stale.channel.purge.interval";
