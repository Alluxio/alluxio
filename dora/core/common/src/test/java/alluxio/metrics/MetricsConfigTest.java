...
public final class MetricsConfigTest {
  ...
  public final void before() {
    ...
    mMetricsProps.setProperty("sink.console.class", "alluxio.sink.metrics.ConsoleSink");
    mMetricsProps.setProperty("sink.console.period", "15");
    mMetricsProps.setProperty("*.sink.console.unit", "minutes");
    mMetricsProps.setProperty("sink.jmx.class", "alluxio.sink.metrics.JmxSink");
  }
  ...
  public void setProperties() {
    ...
    assertEquals("alluxio.sink.metrics.ConsoleSink",
    ...
    assertEquals("alluxio.sink.metrics.JmxSink", masterProp.getProperty("sink.jmx.class"));
  }
  ...
  public void subProperties() {
    ...
    assertEquals("alluxio.sink.metrics.ConsoleSink", consoleProp.getProperty("class"));

    Properties jmxProp = sinkProps.get("jmx");
    assertEquals(1, jmxProp.size());
    assertEquals("alluxio.sink.metrics.JmxSink", jmxProp.getProperty("class"));
  }
}
