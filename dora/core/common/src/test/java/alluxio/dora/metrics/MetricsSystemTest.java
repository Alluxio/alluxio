...
public final class MetricsSystemTest {
  ...
  public void multipleSinksTest() {
    ...
    metricsProps.setProperty("sink.console.class", "alluxio.dora.metrics.sink.ConsoleSink");
    metricsProps.setProperty("sink.console.period", "20");
    metricsProps.setProperty("sink.console.period", "20");
    metricsProps.setProperty("sink.console.unit", "minutes");
    metricsProps.setProperty("sink.jmx.class", "alluxio.dora.metrics.sink.JmxSink");
  ...
  public void startStopSinkTest() throws Exception {
    ...
    properties.put("sink.csv.class", "alluxio.dora.metrics.sink.CsvSink");
