...
public final class CustomAuthenticationProviderTest {
  ...
  public void classNotProvider() {
    ...
    mThrown.expectMessage("alluxio.dora.security.authentication.CustomAuthenticationProviderTest "
        + "cannot be cast to ");
    mThrown.expectMessage("alluxio.dora.security.authentication.AuthenticationProvider");
