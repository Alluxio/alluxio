...
/**
 * Unit tests for the {@link InstancedConfiguration} class.
 */
public class InstancedConfigurationTest {
  ...
  public void toMap() throws Exception {
    ...
    assertTrue(resolvedMap.containsKey("alluxio.dora.proxy.web.port"));
    assertTrue(resolvedMap.containsKey("alluxio.dora.security.authentication.type"));
