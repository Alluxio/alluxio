...
import alluxio.dora.underfs.UnderFileSystem.SpaceType;
...
/**
 * Unit tests for {@link alluxio.dora.util.CommonUtils}.
 */
...
public final class CommonTestUtilsTest {
  ...
  private static class MissingField {
    private String mField1;
    private boolean mField2;
    private alluxio.dora.util.CommonUtils mField3;
  ...
  public void testEqualsBasic() throws Exception {
    alluxio.dora.test.util.CommonUtils.testEquals(Basic.class);
  }

  @Test
  public void testEqualsManyFields() {
    alluxio.dora.test.util.CommonUtils.testEquals(ManyFields.class);
  }
