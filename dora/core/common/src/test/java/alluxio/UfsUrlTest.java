 ...
 * This test intends to match with {@link AlluxioURITest}
 * and verifies that {@link UfsUrl} provides equivalent functionalities to {@link AlluxioURI}.
 */
public class UfsUrlTest {
   ...
   */
  @Test
  public void constructFromNullSchemeNullAuthorityNullPath() {
   ...
   */
  @Test
  public void constructFromNullAuthorityAndEmptyPath() {
