...
public final class CustomAuthenticationProviderTest {
  ...
  public void classNotProvider() {
    ...
    mThrown.expectMessage("alluxio.authentication.security.CustomAuthenticationProviderTest "
        + "cannot be cast to ");
    mThrown.expectMessage("alluxio.authentication.security.AuthenticationProvider");
