...
/**
 * Unit tests for {@link alluxio.util.CommonUtils}.
 */
...
public final class CommonTestUtilsTest {
  ...
  private static class MissingField {
    private String mField1;
    private boolean mField2;
    private alluxio.util.CommonUtils mField3;
  ...
  public void testEqualsBasic() throws Exception {
    alluxio.test.util.CommonUtils.testEquals(Basic.class);
  }

  @Test
  public void testEqualsManyFields() {
    alluxio.test.util.CommonUtils.testEquals(ManyFields.class);
  }
  ...
  private void testFail(Class<?> clazz) {
    try {
      alluxio.test.util.CommonUtils.testEquals(clazz);
