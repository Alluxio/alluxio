...
import alluxio.dora.grpc.RegisterCommand;
...
import alluxio.dora.master.job.tracker.CmdJobTracker;
  ...
  public List<JobInfo> failed(int limit, long before, long after) {
    ...
    mPlanTracker.failed()
        ...
        .forEachOrdered((planInfoMeta) ->
            jobInfos.add(new PlanInfo(planInfoMeta, false)));
    return jobInfos;
  }
