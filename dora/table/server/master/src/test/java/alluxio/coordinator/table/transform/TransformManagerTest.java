...
package alluxio.coordinator.table.transform;
...
import alluxio.coordinator.PortRegistry;
import alluxio.coordinator.journal.JournalSystem;
import alluxio.coordinator.journal.JournalTestUtils;
import alluxio.coordinator.journal.JournalType;
import alluxio.coordinator.table.DefaultTableMaster;
import alluxio.coordinator.table.Partition;
import alluxio.coordinator.table.TableMaster;
import alluxio.coordinator.table.TestDatabase;
import alluxio.coordinator.table.TestUdbFactory;
...
/**
 * See the design of {@link alluxio.coordinator.table.transform.TransformManager}.
 *
