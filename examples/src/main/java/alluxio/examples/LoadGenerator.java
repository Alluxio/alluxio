...
public class LoadGenerator {
  private static final int FILE_NUMBER = 8000000;
  ...
  /**
   * Creates a new instance of {@link LoadGenerator}.
   */
  public LoadGenerator() {}

  /**
   * Creates files in flat hierarchy and pauses according to file number interval.
   *
   * @param args could provide one parameter, specifying the number of files to create
   */
  public static void main(String[] args) {
    AlluxioURI file;
    FileOutStream out;
    CreateFileOptions options = CreateFileOptions.defaults();
    int fileNumber = FILE_NUMBER;
    if (args.length == 1) {
