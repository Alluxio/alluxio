...
export class OverviewPresenter extends React.Component<AllProps> {
          ...
          <Table hover={true}>
            <tbody>
              ...
              <tr>
                ...
                <td
                  className={
                    data.configCheckStatus === 'FAILED' ? 'text-danger' : ''
                  }
                >
                  {data.configCheckStatus}
                </td>
              </tr>
              {this.renderConfigurationIssues(
                data.configCheckErrors,
                'text-error'
              )}
              {this.renderConfigurationIssues(
                data.configCheckWarns,
                'text-warning'
              )}
            </tbody>
          </Table>
  ...
  private renderConfigurationIssues(
    issues: IScopedPropertyInfo[],
    className: string
  ) {
