...
const watchRequest = function*(): IterableIterator<ForkEffect> {
  yield takeLatest(BrowseActionTypes.FETCH_REQUEST, getSagaRequest(axios.get, API_ENDPOINT, fetchSuccess, fetchError));
};

export const browseSaga = function*(): IterableIterator<AllEffect<ForkEffect>> {
