...
const watchRequest = function*(): IterableIterator<ForkEffect> {
  yield takeLatest(DataActionTypes.FETCH_REQUEST, getSagaRequest(axios.get, API_ENDPOINT, fetchSuccess, fetchError));
};

export const dataSaga = function*(): IterableIterator<AllEffect<ForkEffect>> {
