...
const API_ENDPOINT = `${process.env.REACT_APP_API_ROOT}/webui_mounttable`;

const watchRequest = function*(): IterableIterator<ForkEffect> {
  yield takeLatest(
    MountTableActionTypes.FETCH_REQUEST,
    getSagaRequest(axios.get, API_ENDPOINT, fetchSuccess, fetchError),
  );
};

export const mountTableSaga = function*(): IterableIterator<AllEffect<ForkEffect>> {
