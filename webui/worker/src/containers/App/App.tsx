...
import { BlockInfo, Metrics, Overview, WorkerLogs } from '..';
import {
        ...
        <div className="App h-100">
          ...
          <div className="w-100 pt-5 mt-3 pb-4 mb-2">
            <Switch>
              ...
              />
              <Route
                path={routePaths.blockInfo}
                exact={true}
                render={this.renderView(BlockInfo, undefined)}
              />
              <Route
                path={routePaths.logs}
                exact={true}
                render={this.renderView(WorkerLogs, { history })}
              />
              <Route
