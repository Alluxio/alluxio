                ...
                <td>
                  <Progress className="h-50 mt-1" multi={true}>
                    <Progress
                      bar={true}
                      color="dark"
                      value={`${data.workerCapacityFreePercentage}`}
                    >
                    ...
                    <Progress
                      bar={true}
                      color="secondary"
                      value={`${data.workerCapacityUsedPercentage}`}
                    >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  data.operationMetrics.BytesReadRemote
                ...
                <td>
                  {data.operationMetrics &&
                  data.operationMetrics.BytesWrittenRemote
