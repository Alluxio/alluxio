            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.checkpointFiles = new ArrayList<CheckpointFile>(_list32.size);
                CheckpointFile _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new CheckpointFile();
                  _elem33.read(iprot);
                  struct.checkpointFiles.add(_elem33);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LineageCommand struct) throws org.apache.thrift.TException {
      ...
      if (struct.checkpointFiles != null) {
        oprot.writeFieldBegin(CHECKPOINT_FILES_FIELD_DESC);
        {
          ...
          for (CheckpointFile _iter35 : struct.checkpointFiles)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetCheckpointFiles()) {
        {
          ...
          for (CheckpointFile _iter36 : struct.checkpointFiles)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.checkpointFiles = new ArrayList<CheckpointFile>(_list37.size);
          CheckpointFile _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new CheckpointFile();
            _elem38.read(iprot);
            struct.checkpointFiles.add(_elem38);
          }
        }
        struct.setCheckpointFilesIsSet(true);
      }
