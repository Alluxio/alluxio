...
public class LineageMasterService {
  ...
  public interface Iface {
    ...
    public long createLineage(List<String> inputFiles, List<String> outputFiles, CommandLineJobInfo job) throws TachyonTException, ThriftIOException, org.apache.thrift.TException;

    public boolean deleteLineage(long lineageId, boolean cascade) throws TachyonTException, org.apache.thrift.TException;

    public List<LineageInfo> getLineageInfoList() throws org.apache.thrift.TException;

    public long reinitializeFile(String path, long blockSizeBytes, long ttl) throws TachyonTException, org.apache.thrift.TException;

    public void asyncCompleteFile(long fileId) throws TachyonTException, org.apache.thrift.TException;

    public LineageCommand workerLineageHeartbeat(long workerId, List<Long> persistedFiles) throws TachyonTException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public long recv_createLineage() throws TachyonTException, ThriftIOException, org.apache.thrift.TException
    {
    ...
    public boolean recv_deleteLineage() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public long recv_reinitializeFile() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public void recv_asyncCompleteFile() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public LineageCommand recv_workerLineageHeartbeat() throws TachyonTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class workerLineageHeartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public LineageCommand getResult() throws TachyonTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.inputFiles = new ArrayList<String>(_list180.size);
                  String _elem181;
                  for (int _i182 = 0; _i182 < _list180.size; ++_i182)
                  {
                    _elem181 = iprot.readString();
                    struct.inputFiles.add(_elem181);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.outputFiles = new ArrayList<String>(_list183.size);
                  String _elem184;
                  for (int _i185 = 0; _i185 < _list183.size; ++_i185)
                  {
                    _elem184 = iprot.readString();
                    struct.outputFiles.add(_elem184);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, createLineage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.inputFiles != null) {
          oprot.writeFieldBegin(INPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter186 : struct.inputFiles)
            {
        ...
        if (struct.outputFiles != null) {
          oprot.writeFieldBegin(OUTPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter187 : struct.outputFiles)
            {
        ...
        if (struct.isSetInputFiles()) {
          {
            ...
            for (String _iter188 : struct.inputFiles)
            {
        ...
        if (struct.isSetOutputFiles()) {
          {
            ...
            for (String _iter189 : struct.outputFiles)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.inputFiles = new ArrayList<String>(_list190.size);
            String _elem191;
            for (int _i192 = 0; _i192 < _list190.size; ++_i192)
            {
              _elem191 = iprot.readString();
              struct.inputFiles.add(_elem191);
            }
          }
          struct.setInputFilesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.outputFiles = new ArrayList<String>(_list193.size);
            String _elem194;
            for (int _i195 = 0; _i195 < _list193.size; ++_i195)
            {
              _elem194 = iprot.readString();
              struct.outputFiles.add(_elem194);
            }
          }
          struct.setOutputFilesIsSet(true);
        }
  ...
  public static class createLineage_result implements org.apache.thrift.TBase<createLineage_result, createLineage_result._Fields>, java.io.Serializable, Cloneable, Comparable<createLineage_result>   {
    ...
    public createLineage_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public createLineage_result setIoe(ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
  ...
  public static class deleteLineage_result implements org.apache.thrift.TBase<deleteLineage_result, deleteLineage_result._Fields>, java.io.Serializable, Cloneable, Comparable<deleteLineage_result>   {
    ...
    public deleteLineage_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
...
;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LineageInfo>(_list196.size);
                  LineageInfo _elem197;
                  for (int _i198 = 0; _i198 < _list196.size; ++_i198)
                  {
                    _elem197 = new LineageInfo();
                    _elem197.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLineageInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (LineageInfo _iter199 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (LineageInfo _iter200 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LineageInfo>(_list201.size);
            LineageInfo _elem202;
            for (int _i203 = 0; _i203 < _list201.size; ++_i203)
            {
              _elem202 = new LineageInfo();
              _elem202.read(iprot);
  ...
  public static class reinitializeFile_result implements org.apache.thrift.TBase<reinitializeFile_result, reinitializeFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<reinitializeFile_result>   {
    ...
    public reinitializeFile_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
  ...
  public static class asyncCompleteFile_result implements org.apache.thrift.TBase<asyncCompleteFile_result, asyncCompleteFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<asyncCompleteFile_result>   {
    ...
    public asyncCompleteFile_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.persistedFiles = new ArrayList<Long>(_list204.size);
                  long _elem205;
                  for (int _i206 = 0; _i206 < _list204.size; ++_i206)
                  {
                    _elem205 = iprot.readI64();
                    struct.persistedFiles.add(_elem205);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerLineageHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.persistedFiles != null) {
          oprot.writeFieldBegin(PERSISTED_FILES_FIELD_DESC);
          {
            ...
            for (long _iter207 : struct.persistedFiles)
            {
        ...
        if (struct.isSetPersistedFiles()) {
          {
            ...
            for (long _iter208 : struct.persistedFiles)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.persistedFiles = new ArrayList<Long>(_list209.size);
            long _elem210;
            for (int _i211 = 0; _i211 < _list209.size; ++_i211)
            {
              _elem210 = iprot.readI64();
              struct.persistedFiles.add(_elem210);
            }
          }
          struct.setPersistedFilesIsSet(true);
        }
  ...
  public static class workerLineageHeartbeat_result implements org.apache.thrift.TBase<workerLineageHeartbeat_result, workerLineageHeartbeat_result._Fields>, java.io.Serializable, Cloneable, Comparable<workerLineageHeartbeat_result>   {
    ...
    public workerLineageHeartbeat_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
