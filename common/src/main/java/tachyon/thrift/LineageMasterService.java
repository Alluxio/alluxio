...
>>>>>>> [TACHYON-724] Allow for Configurable Storage Levels
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.inputFiles = new ArrayList<String>(_list194.size);
                  String _elem195;
                  for (int _i196 = 0; _i196 < _list194.size; ++_i196)
                  {
                    _elem195 = iprot.readString();
                    struct.inputFiles.add(_elem195);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.outputFiles = new ArrayList<String>(_list197.size);
                  String _elem198;
                  for (int _i199 = 0; _i199 < _list197.size; ++_i199)
                  {
                    _elem198 = iprot.readString();
                    struct.outputFiles.add(_elem198);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, createLineage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.inputFiles != null) {
          oprot.writeFieldBegin(INPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter200 : struct.inputFiles)
            {
        ...
        if (struct.outputFiles != null) {
          oprot.writeFieldBegin(OUTPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter201 : struct.outputFiles)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.inputFiles = new ArrayList<String>(_list204.size);
            String _elem205;
            for (int _i206 = 0; _i206 < _list204.size; ++_i206)
            {
              _elem205 = iprot.readString();
              struct.inputFiles.add(_elem205);
            }
          }
          struct.setInputFilesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.outputFiles = new ArrayList<String>(_list207.size);
            String _elem208;
            for (int _i209 = 0; _i209 < _list207.size; ++_i209)
            {
              _elem208 = iprot.readString();
              struct.outputFiles.add(_elem208);
            }
          }
          struct.setOutputFilesIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LineageInfo>(_list210.size);
                  LineageInfo _elem211;
                  for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                  {
                    _elem211 = new LineageInfo();
                    _elem211.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLineageInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (LineageInfo _iter213 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (LineageInfo _iter214 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LineageInfo>(_list215.size);
            LineageInfo _elem216;
            for (int _i217 = 0; _i217 < _list215.size; ++_i217)
            {
              _elem216 = new LineageInfo();
              _elem216.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.persistedFiles = new ArrayList<Long>(_list218.size);
                  long _elem219;
                  for (int _i220 = 0; _i220 < _list218.size; ++_i220)
                  {
                    _elem219 = iprot.readI64();
                    struct.persistedFiles.add(_elem219);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerLineageHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.persistedFiles != null) {
          oprot.writeFieldBegin(PERSISTED_FILES_FIELD_DESC);
          {
            ...
            for (long _iter221 : struct.persistedFiles)
            {
        ...
        if (struct.isSetPersistedFiles()) {
          {
            ...
            for (long _iter222 : struct.persistedFiles)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.persistedFiles = new ArrayList<Long>(_list223.size);
            long _elem224;
            for (int _i225 = 0; _i225 < _list223.size; ++_i225)
            {
              _elem224 = iprot.readI64();
              struct.persistedFiles.add(_elem224);
            }
          }
          struct.setPersistedFilesIsSet(true);
        }
