...
public class LineageMasterService {
  ...
  public static class Client extends tachyon.thrift.TachyonService.Client implements Iface {
    ...
    public void recv_asyncCompleteFile() throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
  ...
  public static class asyncCompleteFile_result implements org.apache.thrift.TBase<asyncCompleteFile_result, asyncCompleteFile_result._Fields>, java.io.Serializable, Cloneable, Comparable<asyncCompleteFile_result>   {
    ...
    public asyncCompleteFile_result setE(tachyon.thrift.TachyonTException e) {
      this.e = e;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.inputFiles = new ArrayList<String>(_list48.size);
                  String _elem49;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.outputFiles = new ArrayList<String>(_list51.size);
                  String _elem52;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, createLineage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.inputFiles != null) {
          oprot.writeFieldBegin(INPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter54 : struct.inputFiles)
            {
        ...
        if (struct.outputFiles != null) {
          oprot.writeFieldBegin(OUTPUT_FILES_FIELD_DESC);
          {
            ...
            for (String _iter55 : struct.outputFiles)
            {
        ...
        if (struct.isSetInputFiles()) {
          {
            ...
            for (String _iter56 : struct.inputFiles)
            {
        ...
        if (struct.isSetOutputFiles()) {
          {
            ...
            for (String _iter57 : struct.outputFiles)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.inputFiles = new ArrayList<String>(_list58.size);
            String _elem59;
            for (int _i60 = 0; _i60 < _list58.size; ++_i60)
            {
              _elem59 = iprot.readString();
              struct.inputFiles.add(_elem59);
            }
          }
          struct.setInputFilesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            ...
            struct.outputFiles = new ArrayList<String>(_list61.size);
            String _elem62;
            for (int _i63 = 0; _i63 < _list61.size; ++_i63)
            {
              _elem62 = iprot.readString();
              struct.outputFiles.add(_elem62);
            }
          }
          struct.setOutputFilesIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<LineageInfo>(_list64.size);
                  LineageInfo _elem65;
                  for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                  {
                    _elem65 = new LineageInfo();
                    _elem65.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLineageInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (LineageInfo _iter67 : struct.success)
            {
              _iter67.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (LineageInfo _iter68 : struct.success)
            {
              _iter68.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<LineageInfo>(_list69.size);
            LineageInfo _elem70;
            for (int _i71 = 0; _i71 < _list69.size; ++_i71)
            {
              _elem70 = new LineageInfo();
              _elem70.read(iprot);
