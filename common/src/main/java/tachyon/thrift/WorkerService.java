...
public class WorkerService {
  ...
  public interface Iface {
    ...
    public boolean asyncCheckpoint(long fileId) throws TachyonTException, org.apache.thrift.TException;
     ...
     * @param blockId
     */
    public void cacheBlock(long sessionId, long blockId) throws TachyonTException, ThriftIOException, org.apache.thrift.TException;
     ...
     * @param blockId
     */
    public void cancelBlock(long sessionId, long blockId) throws TachyonTException, ThriftIOException, org.apache.thrift.TException;
     ...
     * @param sessionId
     */
    public String lockBlock(long blockId, long sessionId) throws TachyonTException, org.apache.thrift.TException;

    public void persistFile(long fileId, long nonce, String path) throws TachyonTException, org.apache.thrift.TException;
     ...
     * @param blockId
     */
    public boolean promoteBlock(long blockId) throws TachyonTException, ThriftIOException, org.apache.thrift.TException;
     ...
     * @param initialBytes
     */
    public String requestBlockLocation(long sessionId, long blockId, long initialBytes) throws TachyonTException, ThriftIOException, org.apache.thrift.TException;
     ...
     * @param requestBytes
     */
    public boolean requestSpace(long sessionId, long blockId, long requestBytes) throws TachyonTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void persistFile(long fileId, long nonce, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public boolean recv_asyncCheckpoint() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public void recv_cacheBlock() throws TachyonTException, ThriftIOException, org.apache.thrift.TException
    {
    ...
    public void recv_cancelBlock() throws TachyonTException, ThriftIOException, org.apache.thrift.TException
    {
    ...
    public String recv_lockBlock() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public void persistFile(long fileId, long nonce, String path) throws TachyonTException, org.apache.thrift.TException
    {
      send_persistFile(fileId, nonce, path);
      recv_persistFile();
    }

    public void send_persistFile(long fileId, long nonce, String path) throws org.apache.thrift.TException
    {
    ...
    public void recv_persistFile() throws TachyonTException, org.apache.thrift.TException
    {
    ...
    public boolean recv_promoteBlock() throws TachyonTException, ThriftIOException, org.apache.thrift.TException
    {
    ...
    public String recv_requestBlockLocation() throws TachyonTException, ThriftIOException, org.apache.thrift.TException
    {
    ...
    public boolean recv_requestSpace() throws TachyonTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class lockBlock_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public String getResult() throws TachyonTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public void persistFile(long fileId, long nonce, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      persistFile_call method_call = new persistFile_call(fileId, nonce, path, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class persistFile_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long nonce;
      private String path;
      public persistFile_call(long fileId, long nonce, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.fileId = fileId;
        this.nonce = nonce;
        this.path = path;
    ...
    public static class requestBlockLocation_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public String getResult() throws TachyonTException, ThriftIOException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class persistFile<I extends Iface> extends org.apache.thrift.ProcessFunction<I, persistFile_args> {
      ...
      public persistFile_result getResult(I iface, persistFile_args args) throws org.apache.thrift.TException {
        persistFile_result result = new persistFile_result();
        try {
          iface.persistFile(args.fileId, args.nonce, args.path);
        } catch (TachyonTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class persistFile<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, persistFile_args, Void> {
      ...
      public void start(I iface, persistFile_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.persistFile(args.fileId, args.nonce, args.path,resultHandler);
      }
    }
...
;
  ...
  public static class asyncCheckpoint_result implements org.apache.thrift.TBase<asyncCheckpoint_result, asyncCheckpoint_result._Fields>, java.io.Serializable, Cloneable, Comparable<asyncCheckpoint_result>   {
    ...
    public asyncCheckpoint_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
  ...
  public static class cacheBlock_result implements org.apache.thrift.TBase<cacheBlock_result, cacheBlock_result._Fields>, java.io.Serializable, Cloneable, Comparable<cacheBlock_result>   {
    ...
    public cacheBlock_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public cacheBlock_result setIoe(ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
  ...
  public static class cancelBlock_result implements org.apache.thrift.TBase<cancelBlock_result, cancelBlock_result._Fields>, java.io.Serializable, Cloneable, Comparable<cancelBlock_result>   {
    ...
    public cancelBlock_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public cancelBlock_result setIoe(ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
  ...
  public static class lockBlock_result implements org.apache.thrift.TBase<lockBlock_result, lockBlock_result._Fields>, java.io.Serializable, Cloneable, Comparable<lockBlock_result>   {
    ...
    public lockBlock_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
  ...
  public static class persistFile_args implements org.apache.thrift.TBase<persistFile_args, persistFile_args._Fields>, java.io.Serializable, Cloneable, Comparable<persistFile_args>   {
    ...
    private static final org.apache.thrift.protocol.TField FILE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("fileId", org.apache.thrift.protocol.TType.I64, (short)1);
    private static final org.apache.thrift.protocol.TField NONCE_FIELD_DESC = new org.apache.thrift.protocol.TField("nonce", org.apache.thrift.protocol.TType.I64, (short)2);
    ...
    public persistFile_args setNonce(long nonce) {
      this.nonce = nonce;
      setNonceIsSet(true);
      return this;
    }
    ...
    public persistFile_args setPath(String path) {
      this.path = path;
      return this;
    }
  ...
  public static class promoteBlock_result implements org.apache.thrift.TBase<promoteBlock_result, promoteBlock_result._Fields>, java.io.Serializable, Cloneable, Comparable<promoteBlock_result>   {
    ...
    public promoteBlock_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public promoteBlock_result setIoe(ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
  ...
  public static class requestBlockLocation_result implements org.apache.thrift.TBase<requestBlockLocation_result, requestBlockLocation_result._Fields>, java.io.Serializable, Cloneable, Comparable<requestBlockLocation_result>   {
    ...
    public requestBlockLocation_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public requestBlockLocation_result setIoe(ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
  ...
  public static class requestSpace_result implements org.apache.thrift.TBase<requestSpace_result, requestSpace_result._Fields>, java.io.Serializable, Cloneable, Comparable<requestSpace_result>   {
    ...
    public requestSpace_result setE(TachyonTException e) {
      this.e = e;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metrics = new ArrayList<Long>(_list212.size);
                  long _elem213;
                  for (int _i214 = 0; _i214 < _list212.size; ++_i214)
                  {
                    _elem213 = iprot.readI64();
                    struct.metrics.add(_elem213);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sessionHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.metrics != null) {
          oprot.writeFieldBegin(METRICS_FIELD_DESC);
          {
            ...
            for (long _iter215 : struct.metrics)
            {
        ...
        if (struct.isSetMetrics()) {
          {
            ...
            for (long _iter216 : struct.metrics)
            {
              oprot.writeI64(_iter216);
            }
          }
        }
      }
