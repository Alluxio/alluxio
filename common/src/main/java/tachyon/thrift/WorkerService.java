              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metrics = new ArrayList<Long>(_list220.size);
                  long _elem221;
                  for (int _i222 = 0; _i222 < _list220.size; ++_i222)
                  {
                    _elem221 = iprot.readI64();
                    struct.metrics.add(_elem221);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sessionHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.metrics != null) {
          oprot.writeFieldBegin(METRICS_FIELD_DESC);
          {
            ...
            for (long _iter223 : struct.metrics)
            {
        ...
        if (struct.isSetMetrics()) {
          {
            ...
            for (long _iter224 : struct.metrics)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.metrics = new ArrayList<Long>(_list225.size);
            long _elem226;
            for (int _i227 = 0; _i227 < _list225.size; ++_i227)
            {
              _elem226 = iprot.readI64();
              struct.metrics.add(_elem226);
            }
          }
          struct.setMetricsIsSet(true);
        }
