              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metrics = new ArrayList<Long>(_list204.size);
                  long _elem205;
                  for (int _i206 = 0; _i206 < _list204.size; ++_i206)
                  {
                    _elem205 = iprot.readI64();
                    struct.metrics.add(_elem205);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sessionHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.metrics != null) {
          oprot.writeFieldBegin(METRICS_FIELD_DESC);
          {
            ...
            for (long _iter207 : struct.metrics)
            {
        ...
        if (struct.isSetMetrics()) {
          {
            ...
            for (long _iter208 : struct.metrics)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.metrics = new ArrayList<Long>(_list209.size);
            long _elem210;
            for (int _i211 = 0; _i211 < _list209.size; ++_i211)
            {
              _elem210 = iprot.readI64();
              struct.metrics.add(_elem210);
            }
          }
          struct.setMetricsIsSet(true);
        }
