            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.blockIds = new ArrayList<Long>(_list64.size);
                long _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = iprot.readI64();
                  struct.blockIds.add(_elem65);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckpointFile struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockIds != null) {
        oprot.writeFieldBegin(BLOCK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter67 : struct.blockIds)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.blockIds = new ArrayList<Long>(_list69.size);
          long _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readI64();
            struct.blockIds.add(_elem70);
          }
        }
        struct.setBlockIdsIsSet(true);
      }
