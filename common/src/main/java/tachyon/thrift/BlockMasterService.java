  ...
  public static class workerRegister_args implements org.apache.thrift.TBase<workerRegister_args, workerRegister_args._Fields>, java.io.Serializable, Cloneable, Comparable<workerRegister_args>   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.totalBytesOnTiers = new ArrayList<Long>(_list32.size);
                  long _elem33;
                  for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                  {
                    _elem33 = iprot.readI64();
                    struct.totalBytesOnTiers.add(_elem33);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.usedBytesOnTiers = new ArrayList<Long>(_list35.size);
                  long _elem36;
                  for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                  {
                    _elem36 = iprot.readI64();
                    struct.usedBytesOnTiers.add(_elem36);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.currentBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map38.size);
                  long _key39;
                  List<Long> _val40;
                  for (int _i41 = 0; _i41 < _map38.size; ++_i41)
                  {
                    _key39 = iprot.readI64();
                    {
                      ...
                      _val40 = new ArrayList<Long>(_list42.size);
                      long _elem43;
                    ...
                    struct.currentBlocksOnTiers.put(_key39, _val40);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.totalBytesOnTiers != null) {
          oprot.writeFieldBegin(TOTAL_BYTES_ON_TIERS_FIELD_DESC);
          {
            ...
            for (long _iter45 : struct.totalBytesOnTiers)
            {
        ...
        if (struct.usedBytesOnTiers != null) {
          oprot.writeFieldBegin(USED_BYTES_ON_TIERS_FIELD_DESC);
          {
            ...
            for (long _iter46 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.currentBlocksOnTiers != null) {
          oprot.writeFieldBegin(CURRENT_BLOCKS_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter47 : struct.currentBlocksOnTiers.entrySet())
            {
              oprot.writeI64(_iter47.getKey());
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter47.getValue().size()));
    ...
    private static class workerRegister_argsTupleScheme extends TupleScheme<workerRegister_args> {
        ...
        if (struct.isSetTotalBytesOnTiers()) {
          {
            ...
            for (long _iter49 : struct.totalBytesOnTiers)
            {
        ...
        if (struct.isSetUsedBytesOnTiers()) {
          {
            ...
            for (long _iter50 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.isSetCurrentBlocksOnTiers()) {
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter51 : struct.currentBlocksOnTiers.entrySet())
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, workerRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.totalBytesOnTiers = new ArrayList<Long>(_list53.size);
            long _elem54;
            for (int _i55 = 0; _i55 < _list53.size; ++_i55)
            {
              _elem54 = iprot.readI64();
              struct.totalBytesOnTiers.add(_elem54);
            }
          }
          struct.setTotalBytesOnTiersIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.usedBytesOnTiers = new ArrayList<Long>(_list56.size);
            long _elem57;
            for (int _i58 = 0; _i58 < _list56.size; ++_i58)
            {
              _elem57 = iprot.readI64();
              struct.usedBytesOnTiers.add(_elem57);
            }
          }
          struct.setUsedBytesOnTiersIsSet(true);
        }
        if (incoming.get(3)) {
          {
            org.apache.thrift.protocol.TMap _map59 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
            struct.currentBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map59.size);
            long _key60;
            List<Long> _val61;
            for (int _i62 = 0; _i62 < _map59.size; ++_i62)
            {
              _key60 = iprot.readI64();
              {
                ...
                _val61 = new ArrayList<Long>(_list63.size);
                long _elem64;
              ...
              struct.currentBlocksOnTiers.put(_key60, _val61);
            }
          }
          struct.setCurrentBlocksOnTiersIsSet(true);
        }
    ...
    private static class workerHeartbeat_argsStandardScheme extends StandardScheme<workerHeartbeat_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.removedBlockIds = new ArrayList<Long>(_list69.size);
                  long _elem70;
                  for (int _i71 = 0; _i71 < _list69.size; ++_i71)
                  {
                    _elem70 = iprot.readI64();
                    struct.removedBlockIds.add(_elem70);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.addedBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map72.size);
                  long _key73;
                  List<Long> _val74;
                  for (int _i75 = 0; _i75 < _map72.size; ++_i75)
                  {
                    _key73 = iprot.readI64();
                    {
                      ...
                      _val74 = new ArrayList<Long>(_list76.size);
                      long _elem77;
                    ...
                    struct.addedBlocksOnTiers.put(_key73, _val74);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usedBytesOnTiers != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, struct.usedBytesOnTiers.size()));
            for (long _iter79 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.removedBlockIds != null) {
          oprot.writeFieldBegin(REMOVED_BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter80 : struct.removedBlockIds)
            {
        ...
        if (struct.addedBlocksOnTiers != null) {
          oprot.writeFieldBegin(ADDED_BLOCKS_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter81 : struct.addedBlocksOnTiers.entrySet())
            {
    ...
    private static class workerHeartbeat_argsTupleScheme extends TupleScheme<workerHeartbeat_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, workerHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetUsedBytesOnTiers()) {
          {
            oprot.writeI32(struct.usedBytesOnTiers.size());
            for (long _iter83 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.isSetRemovedBlockIds()) {
          {
            ...
            for (long _iter84 : struct.removedBlockIds)
            {
        ...
        if (struct.isSetAddedBlocksOnTiers()) {
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter85 : struct.addedBlocksOnTiers.entrySet())
            {
              oprot.writeI64(_iter85.getKey());
              {
                oprot.writeI32(_iter85.getValue().size());
                for (long _iter86 : _iter85.getValue())
                {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, workerHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.usedBytesOnTiers = new ArrayList<Long>(_list87.size);
            long _elem88;
            for (int _i89 = 0; _i89 < _list87.size; ++_i89)
            {
              _elem88 = iprot.readI64();
              struct.usedBytesOnTiers.add(_elem88);
            }
          }
          struct.setUsedBytesOnTiersIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.removedBlockIds = new ArrayList<Long>(_list90.size);
            long _elem91;
            for (int _i92 = 0; _i92 < _list90.size; ++_i92)
            {
              _elem91 = iprot.readI64();
              struct.removedBlockIds.add(_elem91);
            }
          }
          struct.setRemovedBlockIdsIsSet(true);
        }
        if (incoming.get(3)) {
          {
            org.apache.thrift.protocol.TMap _map93 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
            struct.addedBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map93.size);
            long _key94;
            List<Long> _val95;
            for (int _i96 = 0; _i96 < _map93.size; ++_i96)
            {
              _key94 = iprot.readI64();
              {
                ...
                _val95 = new ArrayList<Long>(_list97.size);
                long _elem98;
              ...
              struct.addedBlocksOnTiers.put(_key94, _val95);
            }
          }
          struct.setAddedBlocksOnTiersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<WorkerInfo>(_list100.size);
                  WorkerInfo _elem101;
                  for (int _i102 = 0; _i102 < _list100.size; ++_i102)
                  {
                    _elem101 = new WorkerInfo();
                    _elem101.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getWorkerInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (WorkerInfo _iter103 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (WorkerInfo _iter104 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<WorkerInfo>(_list105.size);
            WorkerInfo _elem106;
            for (int _i107 = 0; _i107 < _list105.size; ++_i107)
            {
              _elem106 = new WorkerInfo();
              _elem106.read(iprot);
