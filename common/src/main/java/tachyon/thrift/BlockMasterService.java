...
public class BlockMasterService {
  ...
  public interface Iface {
    ...
    public void workerCommitBlock(long workerId, long usedBytesOnTier, int tier, long blockId, long length) throws TachyonTException, org.apache.thrift.TException;

    public long workerGetWorkerId(NetAddress workerNetAddress) throws org.apache.thrift.TException;

    public Command workerHeartbeat(long workerId, List<Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<Long,List<Long>> addedBlocksOnTiers) throws TachyonTException, org.apache.thrift.TException;

    public void workerRegister(long workerId, List<Long> totalBytesOnTiers, List<Long> usedBytesOnTiers, Map<Long,List<Long>> currentBlocksOnTiers) throws TachyonTException, org.apache.thrift.TException;
