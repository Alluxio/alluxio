...
public class BlockMasterService {
  ...
  public interface Iface {
    ...
    public void workerRegister(long workerId, List<Long> totalBytesOnTiers, List<Long> usedBytesOnTiers, Map<Long,List<Long>> currentBlocksOnTiers) throws WorkerDoesNotExistException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void recv_workerRegister() throws WorkerDoesNotExistException, org.apache.thrift.TException
    {
      workerRegister_result result = new workerRegister_result();
      receiveBase(result, "workerRegister");
      if (result.wdnee != null) {
        throw result.wdnee;
      }
      return;
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class workerRegister_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws WorkerDoesNotExistException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class workerRegister<I extends Iface> extends org.apache.thrift.ProcessFunction<I, workerRegister_args> {
      ...
      public workerRegister_result getResult(I iface, workerRegister_args args) throws org.apache.thrift.TException {
        ...
        } catch (WorkerDoesNotExistException wdnee) {
          result.wdnee = wdnee;
        }
        return result;
      }
      ...
      public AsyncMethodCallback<Void> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        ...
        return new AsyncMethodCallback<Void>() { 
          ...
          public void onError(Exception e) {
            ...
            org.apache.thrift.TBase msg;
            workerRegister_result result = new workerRegister_result();
            if (e instanceof WorkerDoesNotExistException) {
                        result.wdnee = (WorkerDoesNotExistException) e;
                        result.setWdneeIsSet(true);
                        msg = result;
            }
             else 
            {
  ...
  public static class workerRegister_result implements org.apache.thrift.TBase<workerRegister_result, workerRegister_result._Fields>, java.io.Serializable, Cloneable, Comparable<workerRegister_result>   {
    ...
    private static final org.apache.thrift.protocol.TField WDNEE_FIELD_DESC = new org.apache.thrift.protocol.TField("wdnee", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public WorkerDoesNotExistException wdnee; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.WDNEE, new org.apache.thrift.meta_data.FieldMetaData("wdnee", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public workerRegister_result(
      WorkerDoesNotExistException wdnee)
    {
      this();
      this.wdnee = wdnee;
    }
    ...
    public workerRegister_result(workerRegister_result other) {
      if (other.isSetWdnee()) {
        this.wdnee = new WorkerDoesNotExistException(other.wdnee);
      }
    }
    ...
    public WorkerDoesNotExistException getWdnee() {
      return this.wdnee;
    }

    public workerRegister_result setWdnee(WorkerDoesNotExistException wdnee) {
      this.wdnee = wdnee;
      return this;
    }

    public void unsetWdnee() {
      this.wdnee = null;
    }

    /** Returns true if field wdnee is set (has been assigned a value) and false otherwise */
    public boolean isSetWdnee() {
      return this.wdnee != null;
    }

    public void setWdneeIsSet(boolean value) {
      if (!value) {
        this.wdnee = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case WDNEE:
        if (value == null) {
          ...
          setWdnee((WorkerDoesNotExistException)value);
        }
        break;
    ...
    public boolean equals(workerRegister_result that) {
      ...
      boolean this_present_wdnee = true && this.isSetWdnee();
      boolean that_present_wdnee = true && that.isSetWdnee();
      if (this_present_wdnee || that_present_wdnee) {
        if (!(this_present_wdnee && that_present_wdnee))
          return false;
        if (!this.wdnee.equals(that.wdnee))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_wdnee = true && (isSetWdnee());
      list.add(present_wdnee);
      if (present_wdnee)
        list.add(wdnee);
    ...
    public int compareTo(workerRegister_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetWdnee()).compareTo(other.isSetWdnee());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetWdnee()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wdnee, other.wdnee);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    private static class workerRegister_resultStandardScheme extends StandardScheme<workerRegister_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, workerRegister_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // WDNEE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.wdnee = new WorkerDoesNotExistException();
                struct.wdnee.read(iprot);
                struct.setWdneeIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerRegister_result struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.wdnee != null) {
          oprot.writeFieldBegin(WDNEE_FIELD_DESC);
          struct.wdnee.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
