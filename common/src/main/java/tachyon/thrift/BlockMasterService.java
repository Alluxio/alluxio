  ...
  public static class workerHeartbeat_args implements org.apache.thrift.TBase<workerHeartbeat_args, workerHeartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<workerHeartbeat_args>   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.removedBlockIds = new ArrayList<Long>(_list91.size);
                  long _elem92;
                  for (int _i93 = 0; _i93 < _list91.size; ++_i93)
                  {
                    _elem92 = iprot.readI64();
                    struct.removedBlockIds.add(_elem92);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.addedBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map94.size);
                  long _key95;
                  List<Long> _val96;
                  for (int _i97 = 0; _i97 < _map94.size; ++_i97)
                  {
                    _key95 = iprot.readI64();
                    {
                      ...
                      _val96 = new ArrayList<Long>(_list98.size);
                      long _elem99;
                    ...
                    struct.addedBlocksOnTiers.put(_key95, _val96);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usedBytesOnTiers != null) {
          oprot.writeFieldBegin(USED_BYTES_ON_TIERS_FIELD_DESC);
          {
            ...
            for (long _iter101 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.removedBlockIds != null) {
          oprot.writeFieldBegin(REMOVED_BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter102 : struct.removedBlockIds)
            {
        ...
        if (struct.addedBlocksOnTiers != null) {
          oprot.writeFieldBegin(ADDED_BLOCKS_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter103 : struct.addedBlocksOnTiers.entrySet())
            {
              oprot.writeI64(_iter103.getKey());
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter103.getValue().size()));
    ...
    private static class workerHeartbeat_argsTupleScheme extends TupleScheme<workerHeartbeat_args> {
        ...
        if (struct.isSetUsedBytesOnTiers()) {
          {
            ...
            for (long _iter105 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.isSetRemovedBlockIds()) {
          {
            ...
            for (long _iter106 : struct.removedBlockIds)
            {
        ...
        if (struct.isSetAddedBlocksOnTiers()) {
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter107 : struct.addedBlocksOnTiers.entrySet())
            {
              oprot.writeI64(_iter107.getKey());
              {
                oprot.writeI32(_iter107.getValue().size());
                for (long _iter108 : _iter107.getValue())
                {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, workerHeartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.usedBytesOnTiers = new ArrayList<Long>(_list109.size);
            long _elem110;
            for (int _i111 = 0; _i111 < _list109.size; ++_i111)
            {
              _elem110 = iprot.readI64();
              struct.usedBytesOnTiers.add(_elem110);
            }
          }
          struct.setUsedBytesOnTiersIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.removedBlockIds = new ArrayList<Long>(_list112.size);
            long _elem113;
            for (int _i114 = 0; _i114 < _list112.size; ++_i114)
            {
              _elem113 = iprot.readI64();
              struct.removedBlockIds.add(_elem113);
            }
          }
          struct.setRemovedBlockIdsIsSet(true);
        }
        if (incoming.get(3)) {
          {
            org.apache.thrift.protocol.TMap _map115 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
            struct.addedBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map115.size);
            long _key116;
            List<Long> _val117;
            for (int _i118 = 0; _i118 < _map115.size; ++_i118)
            {
              _key116 = iprot.readI64();
              {
                ...
                _val117 = new ArrayList<Long>(_list119.size);
                long _elem120;
              ...
              struct.addedBlocksOnTiers.put(_key116, _val117);
            }
          }
          struct.setAddedBlocksOnTiersIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.totalBytesOnTiers = new ArrayList<Long>(_list122.size);
                  long _elem123;
                  for (int _i124 = 0; _i124 < _list122.size; ++_i124)
                  {
                    _elem123 = iprot.readI64();
                    struct.totalBytesOnTiers.add(_elem123);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.usedBytesOnTiers = new ArrayList<Long>(_list125.size);
                  long _elem126;
                  for (int _i127 = 0; _i127 < _list125.size; ++_i127)
                  {
                    _elem126 = iprot.readI64();
                    struct.usedBytesOnTiers.add(_elem126);
                  }
                  iprot.readListEnd();
                }
                struct.setUsedBytesOnTiersIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.currentBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map128.size);
                  long _key129;
                  List<Long> _val130;
                  for (int _i131 = 0; _i131 < _map128.size; ++_i131)
                  {
                    _key129 = iprot.readI64();
                    {
                      ...
                      _val130 = new ArrayList<Long>(_list132.size);
                      long _elem133;
                    ...
                    struct.currentBlocksOnTiers.put(_key129, _val130);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.totalBytesOnTiers != null) {
          oprot.writeFieldBegin(TOTAL_BYTES_ON_TIERS_FIELD_DESC);
          {
            ...
            for (long _iter135 : struct.totalBytesOnTiers)
            {
        ...
        if (struct.usedBytesOnTiers != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, struct.usedBytesOnTiers.size()));
            for (long _iter136 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.currentBlocksOnTiers != null) {
          oprot.writeFieldBegin(CURRENT_BLOCKS_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter137 : struct.currentBlocksOnTiers.entrySet())
            {
    ...
    private static class workerRegister_argsTupleScheme extends TupleScheme<workerRegister_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, workerRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetTotalBytesOnTiers()) {
          {
            ...
            for (long _iter139 : struct.totalBytesOnTiers)
            {
        ...
        if (struct.isSetUsedBytesOnTiers()) {
          {
            oprot.writeI32(struct.usedBytesOnTiers.size());
            for (long _iter140 : struct.usedBytesOnTiers)
            {
        ...
        if (struct.isSetCurrentBlocksOnTiers()) {
          {
            ...
            for (Map.Entry<Long, List<Long>> _iter141 : struct.currentBlocksOnTiers.entrySet())
            {
              oprot.writeI64(_iter141.getKey());
              {
                oprot.writeI32(_iter141.getValue().size());
                for (long _iter142 : _iter141.getValue())
                {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, workerRegister_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.totalBytesOnTiers = new ArrayList<Long>(_list143.size);
            long _elem144;
            for (int _i145 = 0; _i145 < _list143.size; ++_i145)
            {
              _elem144 = iprot.readI64();
              struct.totalBytesOnTiers.add(_elem144);
            }
          }
          struct.setTotalBytesOnTiersIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.usedBytesOnTiers = new ArrayList<Long>(_list146.size);
            long _elem147;
            for (int _i148 = 0; _i148 < _list146.size; ++_i148)
            {
              _elem147 = iprot.readI64();
              struct.usedBytesOnTiers.add(_elem147);
            }
          }
          struct.setUsedBytesOnTiersIsSet(true);
        }
        if (incoming.get(3)) {
          {
            org.apache.thrift.protocol.TMap _map149 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
            struct.currentBlocksOnTiers = new HashMap<Long,List<Long>>(2*_map149.size);
            long _key150;
            List<Long> _val151;
            for (int _i152 = 0; _i152 < _map149.size; ++_i152)
            {
              _key150 = iprot.readI64();
              {
                ...
                _val151 = new ArrayList<Long>(_list153.size);
                long _elem154;
              ...
              struct.currentBlocksOnTiers.put(_key150, _val151);
            }
          }
          struct.setCurrentBlocksOnTiersIsSet(true);
        }
