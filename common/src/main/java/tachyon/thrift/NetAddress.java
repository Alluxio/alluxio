...
public class NetAddress implements org.apache.thrift.TBase<NetAddress, NetAddress._Fields>, java.io.Serializable, Cloneable, Comparable<NetAddress> {
  ...
  public int hashCode() {
    ...
    boolean present_mHost = true && (isSetMHost());
    list.add(present_mHost);
    if (present_mHost)
      list.add(mHost);
    ...
    boolean present_mSecondaryPort = true;
    list.add(present_mSecondaryPort);
    if (present_mSecondaryPort)
      list.add(mSecondaryPort);
