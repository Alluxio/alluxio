...
public class FileSystemMasterClientService {
  ...
  public interface Iface extends tachyon.thrift.TachyonService.Iface {
     ...
     */
    public tachyon.thrift.FileBlockInfo getFileBlockInfo(String path, int fileBlockIndex) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException;
     ...
     * @param path the path of the file
     */
    public FileInfo getFileInfo(String path) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException;
     ...
     * @param path the path of the file
     */
    public List<FileInfo> getFileInfoList(String path) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends tachyon.thrift.TachyonService .AsyncIface {
    ...
    public void getFileBlockInfo(String path, int fileBlockIndex, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void getFileInfo(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getFileInfoList(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends tachyon.thrift.TachyonService.Client implements Iface {
    ...
    public tachyon.thrift.FileBlockInfo getFileBlockInfo(String path, int fileBlockIndex) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
      send_getFileBlockInfo(path, fileBlockIndex);
      return recv_getFileBlockInfo();
    }

    public void send_getFileBlockInfo(String path, int fileBlockIndex) throws org.apache.thrift.TException
    {
    ...
    public FileInfo getFileInfo(String path) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
      send_getFileInfo(path);
      return recv_getFileInfo();
    }

    public void send_getFileInfo(String path) throws org.apache.thrift.TException
    {
    ...
    public List<FileInfo> getFileInfoList(String path) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
      send_getFileInfoList(path);
      return recv_getFileInfoList();
    }

    public void send_getFileInfoList(String path) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends tachyon.thrift.TachyonService.AsyncClient implements AsyncIface {
    ...
    public void getFileBlockInfo(String path, int fileBlockIndex, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getFileBlockInfo_call method_call = new getFileBlockInfo_call(path, fileBlockIndex, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getFileBlockInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getFileBlockInfo_call(String path, int fileBlockIndex, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
    ...
    public void getFileInfo(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getFileInfo_call method_call = new getFileInfo_call(path, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getFileInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String path;
      public getFileInfo_call(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
      }
    ...
    public void getFileInfoList(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getFileInfoList_call method_call = new getFileInfoList_call(path, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getFileInfoList_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String path;
      public getFileInfoList_call(String path, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
      }
  ...
  public static class Processor<I extends Iface> extends tachyon.thrift.TachyonService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getFileBlockInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFileBlockInfo_args> {
      ...
      public getFileBlockInfo_result getResult(I iface, getFileBlockInfo_args args) throws org.apache.thrift.TException {
        getFileBlockInfo_result result = new getFileBlockInfo_result();
        try {
          result.success = iface.getFileBlockInfo(args.path, args.fileBlockIndex);
        } catch (tachyon.thrift.TachyonTException e) {
          result.e = e;
        }
        return result;
    ...
    public static class getFileInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFileInfo_args> {
      ...
      public getFileInfo_result getResult(I iface, getFileInfo_args args) throws org.apache.thrift.TException {
        getFileInfo_result result = new getFileInfo_result();
        try {
          result.success = iface.getFileInfo(args.path);
        } catch (tachyon.thrift.TachyonTException e) {
          result.e = e;
        }
        return result;
    ...
    public static class getFileInfoList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFileInfoList_args> {
      ...
      public getFileInfoList_result getResult(I iface, getFileInfoList_args args) throws org.apache.thrift.TException {
        getFileInfoList_result result = new getFileInfoList_result();
        try {
          result.success = iface.getFileInfoList(args.path);
        } catch (tachyon.thrift.TachyonTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends tachyon.thrift.TachyonService.AsyncProcessor<I> {
    ...
    public static class getFileBlockInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFileBlockInfo_args, tachyon.thrift.FileBlockInfo> {
      ...
      public void start(I iface, getFileBlockInfo_args args, org.apache.thrift.async.AsyncMethodCallback<tachyon.thrift.FileBlockInfo> resultHandler) throws TException {
        iface.getFileBlockInfo(args.path, args.fileBlockIndex,resultHandler);
      }
    }
    ...
    public static class getFileInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFileInfo_args, FileInfo> {
      ...
      public void start(I iface, getFileInfo_args args, org.apache.thrift.async.AsyncMethodCallback<FileInfo> resultHandler) throws TException {
        iface.getFileInfo(args.path,resultHandler);
      }
    }
    ...
    public static class getFileInfoList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFileInfoList_args, List<FileInfo>> {
      ...
      public void start(I iface, getFileInfoList_args args, org.apache.thrift.async.AsyncMethodCallback<List<FileInfo>> resultHandler) throws TException {
        iface.getFileInfoList(args.path,resultHandler);
      }
    }
  ...
  public static class getFileBlockInfo_args implements org.apache.thrift.TBase<getFileBlockInfo_args, getFileBlockInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFileBlockInfo_args>   {
    ...
    // isset id assignments
    private static final int __FILEBLOCKINDEX_ISSET_ID = 0;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
     ...
     * the path of the file
     */
    public getFileBlockInfo_args setPath(String path) {
      this.path = path;
      return this;
    }
  ...
  public static class getFileInfo_args implements org.apache.thrift.TBase<getFileInfo_args, getFileInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFileInfo_args>   {
     ...
     * the path of the file
     */
    public getFileInfo_args setPath(String path) {
      this.path = path;
      return this;
    }
  ...
  public static class getFileInfoList_args implements org.apache.thrift.TBase<getFileInfoList_args, getFileInfoList_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFileInfoList_args>   {
     ...
     * the path of the file
     */
    public getFileInfoList_args setPath(String path) {
      this.path = path;
      return this;
    }
