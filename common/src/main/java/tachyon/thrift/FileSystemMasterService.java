...
public class FileSystemMasterService {
  ...
  public interface Iface {
    ...
    public boolean mkdir(String path, boolean recursive) throws FileAlreadyExistException, InvalidPathException, org.apache.thrift.TException;

    public long create(String path, long blockSizeBytes, boolean recursive, long ttl) throws FileAlreadyExistException, BlockInfoException, SuspectedFileSizeException, TachyonException, org.apache.thrift.TException;
