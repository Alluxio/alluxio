...
public class FileSystemMasterService {
  ...
  public static class Client extends tachyon.thrift.TachyonService.Client implements Iface {
    ...
    public boolean recv_persistFile() throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<Long>(2*_set24.size);
                  long _elem25;
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<Long>(2*_set29.size);
            long _elem30;
