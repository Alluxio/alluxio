...
public class FileSystemMasterService {
  ...
  public interface Iface {
    ...
    public long loadFileInfoFromUfs(String path, String ufsPath, boolean recursive) throws FileAlreadyExistException, BlockInfoException, SuspectedFileSizeException, TachyonException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void loadFileInfoFromUfs(String path, String ufsPath, boolean recursive, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public long loadFileInfoFromUfs(String path, String ufsPath, boolean recursive) throws FileAlreadyExistException, BlockInfoException, SuspectedFileSizeException, TachyonException, org.apache.thrift.TException
    {
      send_loadFileInfoFromUfs(path, ufsPath, recursive);
      return recv_loadFileInfoFromUfs();
    }

    public void send_loadFileInfoFromUfs(String path, String ufsPath, boolean recursive) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void loadFileInfoFromUfs(String path, String ufsPath, boolean recursive, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      loadFileInfoFromUfs_call method_call = new loadFileInfoFromUfs_call(path, ufsPath, recursive, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class loadFileInfoFromUfs<I extends Iface> extends org.apache.thrift.ProcessFunction<I, loadFileInfoFromUfs_args> {
      ...
      public loadFileInfoFromUfs_result getResult(I iface, loadFileInfoFromUfs_args args) throws org.apache.thrift.TException {
        loadFileInfoFromUfs_result result = new loadFileInfoFromUfs_result();
        try {
          result.success = iface.loadFileInfoFromUfs(args.path, args.ufsPath, args.recursive);
          result.setSuccessIsSet(true);
        } catch (FileAlreadyExistException faee) {
          result.faee = faee;
        } catch (BlockInfoException bie) {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class loadFileInfoFromUfs<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, loadFileInfoFromUfs_args, Long> {
      ...
      public void start(I iface, loadFileInfoFromUfs_args args, org.apache.thrift.async.AsyncMethodCallback<Long> resultHandler) throws TException {
        iface.loadFileInfoFromUfs(args.path, args.ufsPath, args.recursive,resultHandler);
      }
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<Long>(2*_set148.size);
                  long _elem149;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, workerGetPinIdList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (long _iter151 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (long _iter152 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<Long>(2*_set153.size);
            long _elem154;
