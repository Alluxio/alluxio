              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<FileBlockInfo>(_list170.size);
                  FileBlockInfo _elem171;
                  for (int _i172 = 0; _i172 < _list170.size; ++_i172)
                  {
                    _elem171 = new FileBlockInfo();
                    _elem171.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFileBlockInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (FileBlockInfo _iter173 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (FileBlockInfo _iter174 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<FileBlockInfo>(_list175.size);
            FileBlockInfo _elem176;
            for (int _i177 = 0; _i177 < _list175.size; ++_i177)
            {
              _elem176 = new FileBlockInfo();
              _elem176.read(iprot);
    ...
    private static class getFileInfoList_resultStandardScheme extends StandardScheme<getFileInfoList_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<FileInfo>(_list178.size);
                  FileInfo _elem179;
                  for (int _i180 = 0; _i180 < _list178.size; ++_i180)
                  {
                    _elem179 = new FileInfo();
                    _elem179.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFileInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (FileInfo _iter181 : struct.success)
            {
    ...
    private static class getFileInfoList_resultTupleScheme extends TupleScheme<getFileInfoList_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getFileInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (FileInfo _iter182 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<FileInfo>(_list183.size);
            FileInfo _elem184;
            for (int _i185 = 0; _i185 < _list183.size; ++_i185)
            {
              _elem184 = new FileInfo();
              _elem184.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.success = new HashSet<Long>(2*_set186.size);
                  long _elem187;
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashSet<Long>(2*_set191.size);
            long _elem192;
