            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mData = new ArrayList<Long>(_list24.size);
                long _elem25;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.mData = new ArrayList<Long>(_list29.size);
          long _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = iprot.readI64();
            struct.mData.add(_elem30);
          }
        }
        struct.setMDataIsSet(true);
      }
