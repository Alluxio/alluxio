...
public class FileSystemMasterWorkerService {
  ...
  public interface Iface extends tachyon.thrift.TachyonService.Iface {
     ...
     */
    public PersistCommand heartbeat(long workerId, List<Long> persistedFiles) throws tachyon.thrift.TachyonTException, org.apache.thrift.TException;
  ...
  public static class Client extends tachyon.thrift.TachyonService.Client implements Iface {
    ...
    public PersistCommand recv_heartbeat() throws tachyon.thrift.TachyonTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends tachyon.thrift.TachyonService.AsyncClient implements AsyncIface {
    ...
    public static class heartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public PersistCommand getResult() throws tachyon.thrift.TachyonTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends tachyon.thrift.TachyonService.AsyncProcessor<I> {
    ...
    public static class heartbeat<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, heartbeat_args, PersistCommand> {
      public heartbeat() {
        super("heartbeat");
      }
      ...
      public AsyncMethodCallback<PersistCommand> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<PersistCommand>() { 
          public void onComplete(PersistCommand o) {
            heartbeat_result result = new heartbeat_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, heartbeat_args args, org.apache.thrift.async.AsyncMethodCallback<PersistCommand> resultHandler) throws TException {
...
;
  ...
  public static class heartbeat_result implements org.apache.thrift.TBase<heartbeat_result, heartbeat_result._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_result>   {
    ...
    public PersistCommand success; // required
    public tachyon.thrift.TachyonTException e; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PersistCommand.class)));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public heartbeat_result(heartbeat_result other) {
      if (other.isSetSuccess()) {
        this.success = new PersistCommand(other.success);
      }
      if (other.isSetE()) {
        this.e = new tachyon.thrift.TachyonTException(other.e);
      }
    ...
    public PersistCommand getSuccess() {
      return this.success;
    }

    public heartbeat_result setSuccess(PersistCommand success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((PersistCommand)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, heartbeat_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new PersistCommand();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
