...
public class WorkerInfo implements org.apache.thrift.TBase<WorkerInfo, WorkerInfo._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerInfo> {
  ...
  public tachyon.thrift.NetAddress address; // required
  ...
  public WorkerInfo(
    long id,
    tachyon.thrift.NetAddress address,
    int lastContactSec,
    String state,
    long capacityBytes,
    long usedBytes,
  ...
  public WorkerInfo(WorkerInfo other) {
    ...
    if (other.isSetAddress()) {
      this.address = new tachyon.thrift.NetAddress(other.address);
    }
  ...
  public tachyon.thrift.NetAddress getAddress() {
    return this.address;
  }

  public WorkerInfo setAddress(tachyon.thrift.NetAddress address) {
    this.address = address;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ADDRESS:
      if (value == null) {
        ...
        setAddress((tachyon.thrift.NetAddress)value);
      }
      break;
