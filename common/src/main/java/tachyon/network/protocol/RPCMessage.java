...
public abstract class RPCMessage implements EncodedMessage {
   ...
   * field in the input.
   *
   * The encoding scheme is: [(long) frame length][message payload] The frame length is NOT included
   * in the output ByteBuf.
   *
  ...
  public enum Type implements EncodedMessage {
    RPC_ERROR_RESPONSE(0), RPC_BLOCK_READ_REQUEST(1), RPC_BLOCK_READ_RESPONSE(2), RPC_BLOCK_WRITE_REQUEST(
        3), RPC_BLOCK_WRITE_RESPONSE(4);
