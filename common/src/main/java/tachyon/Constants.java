...
public class Constants {
   ...
   * {@code String.format(Constants.WORKER_TIERED_STORAGE_LEVEL_ALIAS_FORMAT, level)}
   */
  public static final String WORKER_TIERED_STORAGE_LEVEL_ALIAS_FORMAT =
      "tachyon.worker.tieredstore.level%d.alias";
  /**
   * This format is used as a template to generate the property name for a given level. e.g.,
   * {@code String.format(Constants.WORKER_TIERED_STORAGE_LEVEL_DIRS_PATH_FORMAT, level)}
   */
  public static final String WORKER_TIERED_STORAGE_LEVEL_DIRS_PATH_FORMAT =
      "tachyon.worker.tieredstore.level%d.dirs.path";
  /**
   * This format is used as a template to generate the property name for a given level. e.g.,
   * {@code String.format(Constants.WORKER_TIERED_STORAGE_LEVEL_DIRS_QUOTA_FORMAT, level)}
   */
  ...
  public static final String ACCESS_LOGGER_TYPE = System
      .getProperty(TACHYON_ACCESS_LOGGER_TYPE, "");
