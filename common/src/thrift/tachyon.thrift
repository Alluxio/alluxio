...
service BlockMasterService {
  ...
  Command workerHeartbeat(1: i64 workerId, 2: map<string, i64> usedBytesOnTiers,
      3: list<i64> removedBlockIds, 4: map<string, list<i64>> addedBlocksOnTiers)
    throws (1: TachyonTException e)

  void workerRegister(1: i64 workerId, 2: list<string> storageTiers,
      3: map<string, i64> totalBytesOnTiers, 4: map<string, i64> usedBytesOnTiers,
      5: map<string, list<i64>> currentBlocksOnTiers)
    throws (1: TachyonTException e)
}
