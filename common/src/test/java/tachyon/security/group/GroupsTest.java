...
import tachyon.security.group.provider.SimpleUserGroupsMapping;

/**
 * Unit test for {@link tachyon.security.group.Groups}
 */
public final class GroupsTest {
  ...
  public void groupTest() throws Throwable {
    ...
    conf.set(Constants.SECURITY_GROUP_MAPPING, SimpleUserGroupsMapping.class.getName());
