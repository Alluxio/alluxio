...
public class KeyValueWorkerClientService {
  ...
  public interface Iface extends tachyon.thrift.TachyonService.Iface {
     ...
     */
    public List<ByteBuffer> getAllKeys(long blockId) throws tachyon.thrift.TachyonTException, tachyon.thrift.ThriftIOException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends tachyon.thrift.TachyonService .AsyncIface {
    ...
    public void getAllKeys(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends tachyon.thrift.TachyonService.Client implements Iface {
    ...
    public List<ByteBuffer> getAllKeys(long blockId) throws tachyon.thrift.TachyonTException, tachyon.thrift.ThriftIOException, org.apache.thrift.TException
    {
      send_getAllKeys(blockId);
      return recv_getAllKeys();
    }

    public void send_getAllKeys(long blockId) throws org.apache.thrift.TException
    {
    ...
    public List<ByteBuffer> recv_getAllKeys() throws tachyon.thrift.TachyonTException, tachyon.thrift.ThriftIOException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends tachyon.thrift.TachyonService.AsyncClient implements AsyncIface {
    ...
    public void getAllKeys(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getAllKeys_call method_call = new getAllKeys_call(blockId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getAllKeys_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long blockId;
      public getAllKeys_call(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.blockId = blockId;
      }
  ...
  public static class Processor<I extends Iface> extends tachyon.thrift.TachyonService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getAllKeys<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getAllKeys_args> {
      ...
      public getAllKeys_result getResult(I iface, getAllKeys_args args) throws org.apache.thrift.TException {
        getAllKeys_result result = new getAllKeys_result();
        try {
          result.success = iface.getAllKeys(args.blockId);
        } catch (tachyon.thrift.TachyonTException e) {
          result.e = e;
        } catch (tachyon.thrift.ThriftIOException ioe) {
          result.ioe = ioe;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends tachyon.thrift.TachyonService.AsyncProcessor<I> {
    ...
    public static class getAllKeys<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAllKeys_args, List<ByteBuffer>> {
      public getAllKeys() {
        super("getAllKeys");
      }
      ...
      public void start(I iface, getAllKeys_args args, org.apache.thrift.async.AsyncMethodCallback<List<ByteBuffer>> resultHandler) throws TException {
        iface.getAllKeys(args.blockId,resultHandler);
      }
    }
  ...
  public static class getAllKeys_args implements org.apache.thrift.TBase<getAllKeys_args, getAllKeys_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAllKeys_args>   {
     ...
     * the id of the partition
     */
    public getAllKeys_args setBlockId(long blockId) {
      this.blockId = blockId;
      setBlockIdIsSet(true);
      return this;
    }
  ...
  public static class getAllKeys_result implements org.apache.thrift.TBase<getAllKeys_result, getAllKeys_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAllKeys_result>   {
    ...
    public getAllKeys_result setSuccess(List<ByteBuffer> success) {
      this.success = success;
      return this;
    }
    ...
    public getAllKeys_result setE(tachyon.thrift.TachyonTException e) {
      this.e = e;
      return this;
    }
    ...
    public getAllKeys_result setIoe(tachyon.thrift.ThriftIOException ioe) {
      this.ioe = ioe;
      return this;
    }
