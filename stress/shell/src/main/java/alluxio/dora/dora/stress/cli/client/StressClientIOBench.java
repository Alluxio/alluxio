...
package alluxio.dora.dora.stress.cli.client;
...
import alluxio.dora.dora.stress.client.ClientIOOperation;
import alluxio.dora.dora.stress.client.ClientIOParameters;
import alluxio.dora.dora.stress.client.ClientIOTaskResult;
...
public class StressClientIOBench extends AbstractStressBench
  ...
  private alluxio.dora.dora.client.file.FileSystem[] mCachedNativeFs;
  ...
  public void prepare() throws Exception {
    ...
    if (mParameters.mClientType == FileSystemClientType.ALLUXIO_HDFS) {
      ...
      AlluxioProperties alluxioProperties = alluxio.dora.dora.conf.Configuration
          .copyProperties();
