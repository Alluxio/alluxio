...
package alluxio.dora.dora.stress.cli.worker;
...
import alluxio.dora.dora.stress.common.FileSystemParameters;
import alluxio.dora.dora.stress.worker.WorkerBenchParameters;
import alluxio.dora.dora.stress.worker.WorkerBenchTaskResult;
...
import alluxio.dora.dora.stress.cli.AbstractStressBench;
import alluxio.dora.dora.stress.cli.client.ClientIOWritePolicy;
      ...
      if (!mParameters.mSkipCreation) {
        ...
        for (int i = 0; i < mParameters.mNumFiles; i++) {
          ...
          if (mParameters.mFree && Constants.SCHEME.equals(filePath.toUri().getScheme())) {
            ...
            alluxio.dora.dora.client.file.FileSystem.Factory.get().free(new AlluxioURI(filePath.toString()));
