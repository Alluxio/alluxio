...
public class RpcBenchPreparationUtils {
  ...
  public static final Map<String, Long> CAPACITY_MEM = ImmutableMap.of(TierAlias.MEM.toString(), CAPACITY);
  ...
  public static final BlockStoreLocation BLOCK_LOCATION_MEM =
      new BlockStoreLocation(TierAlias.MEM.toString(), 0, TierAlias.MEM.toString());
  public static final Map<String, List<String>> LOST_STORAGE =
      ImmutableMap.of(TierAlias.MEM.toString(), ImmutableList.of());
  ...
  static void registerWorkers(BlockMasterClient client, Deque<Long> workerIds) throws IOException {
    for (long w : workerIds) {
      ...
      client.register(w,
          ImmutableList.of(TierAlias.MEM.toString()),
          CAPACITY_MEM,
          USED_MEM_EMPTY,
