...
package alluxio.dora.dora.stress.master;

import alluxio.dora.dora.annotation.SuppressFBWarnings;
import alluxio.dora.dora.collections.Pair;
import alluxio.dora.dora.stress.Parameters;
import alluxio.dora.dora.stress.Summary;
import alluxio.dora.dora.stress.common.GeneralBenchSummary;
import alluxio.dora.dora.stress.common.SummaryStatistics;
import alluxio.dora.dora.stress.graph.BarGraph;
import alluxio.dora.dora.stress.graph.Graph;
import alluxio.dora.dora.stress.graph.LineGraph;
...
public final class MasterBenchSummary extends GeneralBenchSummary<MasterBenchTaskResult> {
  ...
  @Override
  public alluxio.dora.dora.stress.GraphGenerator graphGenerator() {
   ...
   */
  public static final class GraphGenerator extends alluxio.dora.dora.stress.GraphGenerator {
    @Override
