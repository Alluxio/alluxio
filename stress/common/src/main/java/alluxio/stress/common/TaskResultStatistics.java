...
public class TaskResultStatistics {
    ...
    @SuppressFBWarnings(value = "EI_EXPOSE_REP2") public byte[] mResponseTimeNsRaw;
    @SuppressFBWarnings(value = "EI_EXPOSE_REP2") public long[] mMaxResponseTimeNs;
    ...
    public void merge(TaskResultStatistics statistics) throws Exception {
        ...
        Histogram responseTime = new Histogram(StressConstants.TIME_HISTOGRAM_MAX,
