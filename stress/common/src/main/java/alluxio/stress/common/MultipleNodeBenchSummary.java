...
/**
 * abstract class for summary which contains multiple node results.
 *
 * @param <T> the type of task result
 */
public abstract class MultipleNodeBenchSummary<T extends TaskResult> implements Summary {
  protected Map<String, T> mNodeResults;
