...
public final class FuseIOParameters extends Parameters {
  ...
  public List<Integer> mThreads = Collections.singletonList(2);

  @Parameter(names = {"--fusePath"},
      description = "The fuse directory in Alluxio to perform operations in")
  public String mFusePath = "/stress-fuse/data-";

  @Parameter(names = {"--localPath"},
       description = "The local filesystem directory to perform operations in")
  public String mLocalPath = "/mnt/alluxio-fuse/stress-fuse-";

  @Parameter(names = {"--duration"},
       description = "The length of time to run the benchmark. (1m, 10m, 60s, 10000ms, etc.)")
  public String mDuration = "10s";
