...
```groovy
compile 'org.alluxio:alluxio-core-client-fs:1.8.2'
```

#### Apache Ant
```xml
<dependency org="org.alluxio" name="alluxio" rev="1.8.2">
...
#### SBT
```
libraryDependencies += "org.alluxio" % "alluxio-core-client-fs" % "1.8.2"
```
