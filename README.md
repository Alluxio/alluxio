...
```groovy
compile 'org.tachyonproject:tachyon-client:0.8.1'
```

#### Apache Ant
```xml
<dependency org="org.tachyonproject" name="tachyon" rev="0.8.1">
...
#### SBT
```
libraryDependencies += "org.tachyonproject" % "tachyon-client" % "0.8.1"
```
