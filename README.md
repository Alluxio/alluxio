...
```groovy
compile 'org.tachyonproject:tachyon-client:0.6.2'
```

#### Apache Ant
```xml
<dependency org="org.tachyonproject" name="tachyon" rev="0.6.2">
...
#### SBT
```
libraryDependencies += "org.tachyonproject" % "tachyon-client" % "0.6.2"
```
