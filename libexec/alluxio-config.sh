...
ALLUXIO_VALIDATION_TOOL_JAR="${ALLUXIO_HOME}/lib/alluxio-integration-tools-validation-${VERSION}.jar"
...
ALLUXIO_VALIDATION_TOOL_CLASSPATH="${ALLUXIO_CLIENT_CLASSPATH}:${ALLUXIO_VALIDATION_TOOL_JAR}"
