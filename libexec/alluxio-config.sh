...
# CSI specific parameters based on ALLUXIO_JAVA_OPTS.
ALLUXIO_CSI_JAVA_OPTS_DEFAULT=" -server -Xms1G -Xmx1G -XX:MaxDirectMemorySize=4g"
ALLUXIO_CSI_JAVA_OPTS_DEFAULT+=" -Dalluxio.logger.type=CSI_LOGGER"
ALLUXIO_CSI_JAVA_OPTS="${ALLUXIO_CSI_JAVA_OPTS_DEFAULT} ${ALLUXIO_JAVA_OPTS} ${ALLUXIO_CSI_JAVA_OPTS}"
