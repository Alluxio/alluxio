...
public class TFsShell {
  ...
  public int ls(String argv[])
    ...
    TachyonFS tachyonClient = TachyonFS.getClient(Utils.getTachyonMasterAddress(path));
  ...
  public int rename(String argv[]) 
    ...
    TachyonFS tachyonClient = TachyonFS.getClient(srcMasterAddr);
  ...
  public int copyToLocal(String argv[])
    ...
    TachyonFS tachyonClient = TachyonFS.getClient(Utils.getTachyonMasterAddress(srcPath));
  ...
  public int copyFromLocal(String argv[]) 
    ...
    TachyonFS tachyonClient = TachyonFS.getClient(Utils.getTachyonMasterAddress(dstPath));
