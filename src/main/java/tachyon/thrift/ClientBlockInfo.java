...
public class ClientBlockInfo implements org.apache.thrift.TBase<ClientBlockInfo, ClientBlockInfo._Fields>, java.io.Serializable, Cloneable {
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.locations = new ArrayList<NetAddress>(_list0.size);
              for (int _i1 = 0; _i1 < _list0.size; ++_i1)
              {
                NetAddress _elem2; // required
                _elem2 = new NetAddress();
                _elem2.read(iprot);
                this.locations.add(_elem2);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.locations != null) {
      ...
      {
        oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, this.locations.size()));
        for (NetAddress _iter3 : this.locations)
        {
          _iter3.write(oprot);
        }
        oprot.writeListEnd();
