          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.parents = new ArrayList<Integer>(_list8.size);
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.children = new ArrayList<Integer>(_list11.size);
              for (int _i12 = 0; _i12 < _list11.size; ++_i12)
              {
                int _elem13; // required
                _elem13 = iprot.readI32();
                this.children.add(_elem13);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.data = new ArrayList<ByteBuffer>(_list14.size);
              for (int _i15 = 0; _i15 < _list14.size; ++_i15)
              {
                ByteBuffer _elem16; // required
                _elem16 = iprot.readBinary();
                this.data.add(_elem16);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.data != null) {
      oprot.writeFieldBegin(DATA_FIELD_DESC);
      {
        ...
        for (ByteBuffer _iter19 : this.data)
        {
