...
public class MasterService {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class worker_addPartition<I extends Iface> extends org.apache.thrift.ProcessFunction<I, worker_addPartition_args> {
      public worker_addPartition() {
        super("worker_addPartition");
      }

      protected worker_addPartition_args getEmptyArgsInstance() {
        return new worker_addPartition_args();
      }

      protected worker_addPartition_result getResult(I iface, worker_addPartition_args args) throws org.apache.thrift.TException {
        worker_addPartition_result result = new worker_addPartition_result();
        try {
    ...
    private static class worker_getPinList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, worker_getPinList_args> {
      public worker_getPinList() {
        super("worker_getPinList");
      }

      protected worker_getPinList_args getEmptyArgsInstance() {
        return new worker_getPinList_args();
      }

      protected worker_getPinList_result getResult(I iface, worker_getPinList_args args) throws org.apache.thrift.TException {
        worker_getPinList_result result = new worker_getPinList_result();
    ...
    private static class user_createDataset<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_createDataset_args> {
      public user_createDataset() {
        super("user_createDataset");
      }

      protected user_createDataset_args getEmptyArgsInstance() {
        return new user_createDataset_args();
      }

      protected user_createDataset_result getResult(I iface, user_createDataset_args args) throws org.apache.thrift.TException {
        user_createDataset_result result = new user_createDataset_result();
        try {
    ...
    private static class user_getDatasetId<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_getDatasetId_args> {
      public user_getDatasetId() {
        super("user_getDatasetId");
      }

      protected user_getDatasetId_args getEmptyArgsInstance() {
        return new user_getDatasetId_args();
      }

      protected user_getDatasetId_result getResult(I iface, user_getDatasetId_args args) throws org.apache.thrift.TException {
        user_getDatasetId_result result = new user_getDatasetId_result();
    ...
    private static class user_getLocalWorker<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_getLocalWorker_args> {
      public user_getLocalWorker() {
        super("user_getLocalWorker");
      }

      protected user_getLocalWorker_args getEmptyArgsInstance() {
        return new user_getLocalWorker_args();
      }

      protected user_getLocalWorker_result getResult(I iface, user_getLocalWorker_args args) throws org.apache.thrift.TException {
        user_getLocalWorker_result result = new user_getLocalWorker_result();
        try {
    ...
    private static class user_getPartitionInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_getPartitionInfo_args> {
      public user_getPartitionInfo() {
        super("user_getPartitionInfo");
      }

      protected user_getPartitionInfo_args getEmptyArgsInstance() {
        return new user_getPartitionInfo_args();
      }

      protected user_getPartitionInfo_result getResult(I iface, user_getPartitionInfo_args args) throws org.apache.thrift.TException {
        user_getPartitionInfo_result result = new user_getPartitionInfo_result();
        try {
    ...
    private static class user_getDatasetById<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_getDatasetById_args> {
      public user_getDatasetById() {
        super("user_getDatasetById");
      }

      protected user_getDatasetById_args getEmptyArgsInstance() {
        return new user_getDatasetById_args();
      }

      protected user_getDatasetById_result getResult(I iface, user_getDatasetById_args args) throws org.apache.thrift.TException {
        user_getDatasetById_result result = new user_getDatasetById_result();
        try {
    ...
    private static class user_getDatasetByPath<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_getDatasetByPath_args> {
      public user_getDatasetByPath() {
        super("user_getDatasetByPath");
      }

      protected user_getDatasetByPath_args getEmptyArgsInstance() {
        return new user_getDatasetByPath_args();
      }

      protected user_getDatasetByPath_result getResult(I iface, user_getDatasetByPath_args args) throws org.apache.thrift.TException {
        user_getDatasetByPath_result result = new user_getDatasetByPath_result();
        try {
    ...
    private static class user_deleteDataset<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_deleteDataset_args> {
      public user_deleteDataset() {
        super("user_deleteDataset");
      }

      protected user_deleteDataset_args getEmptyArgsInstance() {
        return new user_deleteDataset_args();
      }

      protected user_deleteDataset_result getResult(I iface, user_deleteDataset_args args) throws org.apache.thrift.TException {
        user_deleteDataset_result result = new user_deleteDataset_result();
        try {
    ...
    private static class user_freeDataset<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_freeDataset_args> {
      public user_freeDataset() {
        super("user_freeDataset");
      }

      protected user_freeDataset_args getEmptyArgsInstance() {
        return new user_freeDataset_args();
      }

      protected user_freeDataset_result getResult(I iface, user_freeDataset_args args) throws org.apache.thrift.TException {
        user_freeDataset_result result = new user_freeDataset_result();
        try {
    ...
    private static class user_renameDataset<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_renameDataset_args> {
      public user_renameDataset() {
        super("user_renameDataset");
      }

      protected user_renameDataset_args getEmptyArgsInstance() {
        return new user_renameDataset_args();
      }

      protected user_renameDataset_result getResult(I iface, user_renameDataset_args args) throws org.apache.thrift.TException {
        user_renameDataset_result result = new user_renameDataset_result();
        try {
    ...
    private static class user_outOfMemoryForPinDataset<I extends Iface> extends org.apache.thrift.ProcessFunction<I, user_outOfMemoryForPinDataset_args> {
      public user_outOfMemoryForPinDataset() {
        super("user_outOfMemoryForPinDataset");
      }

      protected user_outOfMemoryForPinDataset_args getEmptyArgsInstance() {
        return new user_outOfMemoryForPinDataset_args();
      }

      protected user_outOfMemoryForPinDataset_result getResult(I iface, user_outOfMemoryForPinDataset_args args) throws org.apache.thrift.TException {
        user_outOfMemoryForPinDataset_result result = new user_outOfMemoryForPinDataset_result();
    ...
    private static class cmd_ls<I extends Iface> extends org.apache.thrift.ProcessFunction<I, cmd_ls_args> {
      public cmd_ls() {
        super("cmd_ls");
      }

      protected cmd_ls_args getEmptyArgsInstance() {
        return new cmd_ls_args();
      }

      protected cmd_ls_result getResult(I iface, cmd_ls_args args) throws org.apache.thrift.TException {
        cmd_ls_result result = new cmd_ls_result();
  ...
  public static class worker_addPartition_args implements org.apache.thrift.TBase<worker_addPartition_args, worker_addPartition_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void unsetPartitionSizeBytes() {
      __isset_bit_vector.clear(__PARTITIONSIZEBYTES_ISSET_ID);
    }
    ...
    public boolean isSetPartitionSizeBytes() {
      return __isset_bit_vector.get(__PARTITIONSIZEBYTES_ISSET_ID);
    }

    public void setPartitionSizeBytesIsSet(boolean value) {
      __isset_bit_vector.set(__PARTITIONSIZEBYTES_ISSET_ID, value);
    }
...
;
  ...
  public static class user_createDataset_args implements org.apache.thrift.TBase<user_createDataset_args, user_createDataset_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void unsetPartitions() {
      __isset_bit_vector.clear(__PARTITIONS_ISSET_ID);
    }

    /** Returns true if field partitions is set (has been assigned a value) and false otherwise */
    public boolean isSetPartitions() {
      return __isset_bit_vector.get(__PARTITIONS_ISSET_ID);
    }

    public void setPartitionsIsSet(boolean value) {
      __isset_bit_vector.set(__PARTITIONS_ISSET_ID, value);
    }
