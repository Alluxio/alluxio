...
public class DatasetInfo implements org.apache.thrift.TBase<DatasetInfo, DatasetInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetMVersion() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __MVERSION_ISSET_ID);
  }

  /** Returns true if field mVersion is set (has been assigned a value) and false otherwise */
  public boolean isSetMVersion() {
    return EncodingUtils.testBit(__isset_bitfield, __MVERSION_ISSET_ID);
  }

  public void setMVersionIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MVERSION_ISSET_ID, value);
  }
