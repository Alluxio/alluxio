...
func addAdditionalFiles(srcPath, dstPath string, hadoopVersion version, version string) {
	...
	pathsToCopy := []string{
		...
		"conf/workers",
		"integration/csi/alluxio/controllerserver.go",
		"integration/csi/alluxio/driver.go",
		"integration/csi/alluxio/nodeserver.go",
		"integration/csi/go.mod",
		"integration/csi/go.sum",
