...
func addAdditionalFiles(srcPath, dstPath string, hadoopVersion version, version string) {
	...
	pathsToCopy := []string{
		...
		"conf/workers",
		"dev/metrics/docker-compose-master.yaml",
		"dev/metrics/docker-compose-worker.yaml",
		"dev/metrics/otel-agent-config.yaml",
		"dev/metrics/otel-agent-config-worker.yaml",
		"dev/metrics/otel-collector-config.yaml",
		"dev/metrics/prometheus.yaml",
