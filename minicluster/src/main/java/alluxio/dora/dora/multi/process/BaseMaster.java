...
package alluxio.dora.dora.multi.process;
 ...
 */
@ThreadSafe
public abstract class BaseMaster implements Closeable {
  ...
  public synchronized void start() {
    ...
    LOG.info("Starting master type {} with port {}", getProcessClass(), getPort());
    mProcess = new ExternalProcess(mProperties, getProcessClass(),
