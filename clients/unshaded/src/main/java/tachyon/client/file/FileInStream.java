...
public final class FileInStream extends InputStream implements BoundedStream, Seekable {
  ...
  private long mPos;
  /** Current {@code BlockInStream} backing this stream */
  private BlockInStream mCurrentBlockInStream;
  /** Current {@code BlockOutStream} writing the data into Tachyon, this may be null */
  ...
  /**
   * @return the current block id based on {@link #mPos}, -1 if at the end of the file
   */
