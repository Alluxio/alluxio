 ...
 *
 * <p>
 * This class wraps the {@link tachyon.client.block.BufferedBlockInStream} for each of the blocks in
 * the file and abstracts the switching between streams. The backing streams can read from Tachyon
 * space in the local machine, remote machines, or the under storage system.
 */
@PublicApi
