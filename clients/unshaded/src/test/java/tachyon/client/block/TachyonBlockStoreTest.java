...
public final class TachyonBlockStoreTest {
  ...
  private static final WorkerNetAddress WORKER_NET_ADDRESS_LOCAL =
      new WorkerNetAddress(WORKER_HOSTNAME_LOCAL, WORKER_RPC_PORT, WORKER_DATA_PORT, WORKER_WEB_PORT);
  private static final WorkerNetAddress WORKER_NET_ADDRESS_REMOTE =
      new WorkerNetAddress(WORKER_HOSTNAME_REMOTE, WORKER_RPC_PORT, WORKER_DATA_PORT, WORKER_WEB_PORT);
